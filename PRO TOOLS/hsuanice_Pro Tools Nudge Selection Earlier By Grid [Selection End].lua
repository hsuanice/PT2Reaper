-- @description hsuanice_Pro Tools Nudge Selection Earlier By Grid (Selection End)
...
--   **Nudge Selection Earlier By Grid (Selection End)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Selection Earlier By Grid (Selection End)
--   - Module               : Selection
--   - Mac shortcut (PT)    : Command + Shift + Numpad Minus
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Nudge Selection Earlier By Grid (Selection End)", "PT2Reaper", 0)
