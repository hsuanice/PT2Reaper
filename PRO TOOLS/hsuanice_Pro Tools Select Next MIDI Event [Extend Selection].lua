-- @description hsuanice_Pro Tools Select Next MIDI Event (Extend Selection)
...
--   **Select Next MIDI Event (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Select Next MIDI Event (Extend Selection)
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Select Next MIDI Event (Extend Selection)", "PT2Reaper", 0)
