-- @description hsuanice_Pro Tools Next Smaller Track Size (All Tracks)
...
--   **Next Smaller Track Size (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Next Smaller Track Size (All Tracks)
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Next Smaller Track Size (All Tracks)", "PT2Reaper", 0)
