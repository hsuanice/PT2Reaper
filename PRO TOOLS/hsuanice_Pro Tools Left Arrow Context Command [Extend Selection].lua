-- @description hsuanice_Pro Tools Left Arrow Context Command (Extend Selection)
...
--   **Left Arrow Context Command (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Left Arrow Context Command (Extend Selection)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Left Arrow
...
reaper.ShowMessageBox("Not yet implemented: Left Arrow Context Command (Extend Selection)", "PT2Reaper", 0)
