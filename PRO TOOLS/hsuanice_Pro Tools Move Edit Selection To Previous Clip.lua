...
--   **Move Edit Selection To Previous Clip**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Selection To Previous Clip
--   - Module               : Selection
--   - Mac shortcut (PT)    : Option + Control + Tab
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Selection To Previous Clip", "PT2Reaper", 0)
