-- @description hsuanice_Pro Tools Copy Selection to Duplicate Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Copy Selection to Duplicate Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Copy Selection to Duplicate Playlist", "PT2Reaper", 0)
