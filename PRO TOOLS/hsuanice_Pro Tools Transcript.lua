-- @description hsuanice_Pro Tools Transcript
...
--
--   ## Details
--   - Pro Tools equivalent : Transcript
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Transcription, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Transcript", "PT2Reaper", 0)
