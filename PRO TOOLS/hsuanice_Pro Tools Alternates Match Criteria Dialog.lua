-- @description hsuanice_Pro Tools Alternates Match Criteria Dialog
...
--
--   ## Details
--   - Pro Tools equivalent : Alternates Match Criteria Dialog
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Alternates Match Criteria Dialog", "PT2Reaper", 0)
