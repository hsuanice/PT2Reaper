-- @description hsuanice_Pro Tools Pencil Tool: Parabolic
...
--   **Pencil Tool: Parabolic**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: Parabolic
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: Parabolic", "PT2Reaper", 0)
