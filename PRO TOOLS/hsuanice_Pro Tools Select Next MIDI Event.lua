-- @description hsuanice_Pro Tools Select Next MIDI Event
...
--   **Select Next MIDI Event**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Select Next MIDI Event
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Select Next MIDI Event", "PT2Reaper", 0)
