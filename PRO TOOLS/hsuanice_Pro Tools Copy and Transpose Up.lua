-- @description hsuanice_Pro Tools Copy and Transpose Up
...
--   **Copy and Transpose Up**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Transpose Up
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Up Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy and Transpose Up", "PT2Reaper", 0)
