-- @description hsuanice_Pro Tools Selected Tracks: Show/Hide
...
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Show/Hide
--   - Module               : Tracks
--   - Mac shortcut (PT)    : —
--   - Tags                 : Track/Playlist
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Show/Hide", "PT2Reaper", 0)
