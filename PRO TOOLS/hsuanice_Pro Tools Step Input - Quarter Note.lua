-- @description hsuanice_Pro Tools Step Input: Quarter Note
...
--   **Step Input: Quarter Note**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: Quarter Note
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 4
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: Quarter Note", "PT2Reaper", 0)
