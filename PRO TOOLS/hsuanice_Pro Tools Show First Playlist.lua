-- @description hsuanice_Pro Tools Show First Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Show First Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Home
...
reaper.ShowMessageBox("Not yet implemented: Show First Playlist", "PT2Reaper", 0)
