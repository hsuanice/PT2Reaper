-- @description hsuanice_Pro Tools Playlists View: Copy Selection to New Playlist
...
--   **Playlists View: Copy Selection to New Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Playlists View: Copy Selection to New Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Playlists View: Copy Selection to New Playlist", "PT2Reaper", 0)
