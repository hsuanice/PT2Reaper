-- @description hsuanice_Pro Tools Shuttle At Speed 1
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 1
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 1
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 1", "PT2Reaper", 0)
