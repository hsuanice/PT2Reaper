-- @description hsuanice_Pro Tools Clip Rating 3
...
--
--   ## Details
--   - Pro Tools equivalent : Clip Rating 3
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad 3
...
reaper.ShowMessageBox("Not yet implemented: Clip Rating 3", "PT2Reaper", 0)
