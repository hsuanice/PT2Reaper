-- @description hsuanice_Pro Tools Move Edit Insertion To Song Start
...
--   **Move Edit Insertion To Song Start**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Insertion To Song Start
--   - Module               : Selection
--   - Mac shortcut (PT)    : Control + Shift + Return
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Insertion To Song Start", "PT2Reaper", 0)
