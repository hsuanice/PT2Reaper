-- @description hsuanice_Pro Tools Double-Click Selects Automation Breakpoints
...
--   **Double-Click Selects Automation Breakpoints**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Double-Click Selects Automation Breakpoints
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Double-Click Selects Automation Breakpoints", "PT2Reaper", 0)
