-- @description hsuanice_Pro Tools Recall Zoom Memory 4
...
--   **Recall Zoom Memory 4**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Zoom Memory 4
--   - Module               : Navigation
--   - Mac shortcut (PT)    : Command + Control + 4
...
reaper.ShowMessageBox("Not yet implemented: Recall Zoom Memory 4", "PT2Reaper", 0)
