-- @description hsuanice_Pro Tools Waveforms: Outlines
...
--
--   ## Details
--   - Pro Tools equivalent : Waveforms: Outlines
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Waveforms: Outlines", "PT2Reaper", 0)
