-- @description hsuanice_Pro Tools Clips List: Sort by Clip Type
...
--   **Clips List: Sort by Clip Type**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Clip Type
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Clip Type", "PT2Reaper", 0)
