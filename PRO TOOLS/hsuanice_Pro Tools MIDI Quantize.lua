-- @description hsuanice_Pro Tools MIDI Quantize
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Quantize
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Numpad 0
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: MIDI Quantize", "PT2Reaper", 0)
