-- @description hsuanice_Pro Tools Copy To Send
...
--
--   ## Details
--   - Pro Tools equivalent : Copy To Send
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Option + H
--   - Tags                 : Automation, Edit menu, Editing, Inserts/Sends
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy To Send", "PT2Reaper", 0)
