-- @description hsuanice_Pro Tools MIDI Change Duration
...
--   **MIDI Change Duration**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Change Duration
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing, MIDI
--
...
reaper.ShowMessageBox("Not yet implemented: MIDI Change Duration", "PT2Reaper", 0)
