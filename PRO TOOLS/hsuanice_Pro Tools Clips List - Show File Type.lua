-- @description hsuanice_Pro Tools Clips List: Show File Type
...
--   **Clips List: Show File Type**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show File Type
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show File Type", "PT2Reaper", 0)
