-- @description hsuanice_Pro Tools Write Automation to Selection End
...
--
--   ## Details
--   - Pro Tools equivalent : Write Automation to Selection End
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Write Automation to Selection End", "PT2Reaper", 0)
