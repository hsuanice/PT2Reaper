-- @description hsuanice_Pro Tools Zoom To Show All
...
--
--   ## Details
--   - Pro Tools equivalent : Zoom To Show All
--   - Module               : Zoom
--   - Mac shortcut (PT)    : Option + A
--   - Tags                 : Zoom
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Zoom To Show All", "PT2Reaper", 0)
