-- @description hsuanice_Pro Tools Enter Timeline Start Time Field
...
--   **Enter Timeline Start Time Field**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Enter Timeline Start Time Field
--   - Module               : Editing
--   - Mac shortcut (PT)    : Numpad /
--   - Tags                 : Editing, Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Enter Timeline Start Time Field", "PT2Reaper", 0)
