-- @description hsuanice_Pro Tools Coalesce Pan Guide Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Coalesce Pan Guide Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Coalesce Pan Guide Automation", "PT2Reaper", 0)
