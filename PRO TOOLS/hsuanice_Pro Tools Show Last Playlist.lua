-- @description hsuanice_Pro Tools Show Last Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Show Last Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + End
...
reaper.ShowMessageBox("Not yet implemented: Show Last Playlist", "PT2Reaper", 0)
