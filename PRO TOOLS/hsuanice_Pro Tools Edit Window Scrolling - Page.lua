-- @description hsuanice_Pro Tools Edit Window Scrolling: Page
...
--   **Edit Window Scrolling: Page**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window Scrolling: Page
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window Scrolling: Page", "PT2Reaper", 0)
