-- @description hsuanice_Pro Tools Trim Note Start Later By Double Grid Value
...
--   **Trim Note Start Later By Double Grid Value**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Trim Note Start Later By Double Grid Value
--   - Module               : Editing
--   - Mac shortcut (PT)    : Control + Shift + Right Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Trim Note Start Later By Double Grid Value", "PT2Reaper", 0)
