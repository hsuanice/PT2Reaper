-- @description hsuanice_Pro Tools Clear All Clipping Indicators
...
--
--   ## Details
--   - Pro Tools equivalent : Clear All Clipping Indicators
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Option + C
...
reaper.ShowMessageBox("Not yet implemented: Clear All Clipping Indicators", "PT2Reaper", 0)
