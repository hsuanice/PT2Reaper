-- @description hsuanice_Pro Tools Correct 7.1.2 Channel Order On Timeline...
...
--   **Correct 7.1.2 Channel Order On Timeline...**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Correct 7.1.2 Channel Order On Timeline...
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing, I/O
--
...
reaper.ShowMessageBox("Not yet implemented: Correct 7.1.2 Channel Order On Timeline...", "PT2Reaper", 0)
