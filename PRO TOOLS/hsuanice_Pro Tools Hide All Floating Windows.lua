-- @description hsuanice_Pro Tools Hide All Floating Windows
...
--
--   ## Details
--   - Pro Tools equivalent : Hide All Floating Windows
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Option + Control + W
--   - Tags                 : Show/Hide, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Hide All Floating Windows", "PT2Reaper", 0)
