-- @description hsuanice_Pro Tools Clip: Overwrite Indicator
...
--
--   ## Details
--   - Pro Tools equivalent : Clip: Overwrite Indicator
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clip: Overwrite Indicator", "PT2Reaper", 0)
