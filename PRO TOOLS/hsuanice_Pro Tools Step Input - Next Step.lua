-- @description hsuanice_Pro Tools Step Input: Next Step
...
--
--   ## Details
--   - Pro Tools equivalent : Step Input: Next Step
--   - Module               : MIDI
...
reaper.ShowMessageBox("Not yet implemented: Step Input: Next Step", "PT2Reaper", 0)
