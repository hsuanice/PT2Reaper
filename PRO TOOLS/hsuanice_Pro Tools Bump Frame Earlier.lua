-- @description hsuanice_Pro Tools Bump Frame Earlier
...
--
--   ## Details
--   - Pro Tools equivalent : Bump Frame Earlier
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Option + Comma
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Bump Frame Earlier", "PT2Reaper", 0)
