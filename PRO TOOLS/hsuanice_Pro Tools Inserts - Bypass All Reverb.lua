-- @description hsuanice_Pro Tools Inserts: Bypass All Reverb
...
--   **Inserts: Bypass All Reverb**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Inserts: Bypass All Reverb
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + V
...
reaper.ShowMessageBox("Not yet implemented: Inserts: Bypass All Reverb", "PT2Reaper", 0)
