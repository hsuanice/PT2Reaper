-- @description hsuanice_Pro Tools Clear SpectraLayers Track(s)
...
--   **Clear SpectraLayers Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear SpectraLayers Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear SpectraLayers Track(s)", "PT2Reaper", 0)
