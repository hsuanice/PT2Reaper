-- @description hsuanice_Pro Tools Play To Edit End
...
--
--   ## Details
--   - Pro Tools equivalent : Play To Edit End
--   - Module               : Transport
--   - Mac shortcut (PT)    : Commands Focus + 8
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play To Edit End", "PT2Reaper", 0)
