-- @description hsuanice_Pro Tools Bypass RX Spectral Editor Track(s)
...
--   **Bypass RX Spectral Editor Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass RX Spectral Editor Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass RX Spectral Editor Track(s)", "PT2Reaper", 0)
