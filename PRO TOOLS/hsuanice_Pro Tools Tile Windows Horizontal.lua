-- @description hsuanice_Pro Tools Tile Windows Horizontal
...
--
--   ## Details
--   - Pro Tools equivalent : Tile Windows Horizontal
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tile Windows Horizontal", "PT2Reaper", 0)
