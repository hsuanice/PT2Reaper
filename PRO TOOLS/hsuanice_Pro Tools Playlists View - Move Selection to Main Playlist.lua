-- @description hsuanice_Pro Tools Playlists View: Move Selection to Main Playlist
...
--   **Playlists View: Move Selection to Main Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Playlists View: Move Selection to Main Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Playlists View: Move Selection to Main Playlist", "PT2Reaper", 0)
