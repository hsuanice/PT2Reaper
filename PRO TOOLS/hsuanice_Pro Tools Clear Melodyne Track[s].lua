-- @description hsuanice_Pro Tools Clear Melodyne Track(s)
...
--   **Clear Melodyne Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Melodyne Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Melodyne Track(s)", "PT2Reaper", 0)
