-- @description hsuanice_Pro Tools MIDI Operations: Transpose
...
--   **MIDI Operations: Transpose**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Transpose
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + T
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Transpose", "PT2Reaper", 0)
