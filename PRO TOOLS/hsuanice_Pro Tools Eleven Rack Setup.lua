-- @description hsuanice_Pro Tools Eleven Rack Setup
...
--
--   ## Details
--   - Pro Tools equivalent : Eleven Rack Setup
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : I/O, Miscellaneous
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Eleven Rack Setup", "PT2Reaper", 0)
