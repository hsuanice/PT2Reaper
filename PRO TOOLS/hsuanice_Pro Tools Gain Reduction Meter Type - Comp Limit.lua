-- @description hsuanice_Pro Tools Gain Reduction Meter Type: Comp Limit
...
--   **Gain Reduction Meter Type: Comp Limit**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Gain Reduction Meter Type: Comp Limit
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Gain Reduction Meter Type: Comp Limit", "PT2Reaper", 0)
