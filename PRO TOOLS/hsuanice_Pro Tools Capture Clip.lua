-- @description hsuanice_Pro Tools Capture Clip
...
--
--   ## Details
--   - Pro Tools equivalent : Capture Clip
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + R
...
reaper.ShowMessageBox("Not yet implemented: Capture Clip", "PT2Reaper", 0)
