-- @description hsuanice_Pro Tools Delete Clip Gain Breakpoints
...
--   **Delete Clip Gain Breakpoints**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Delete Clip Gain Breakpoints
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + Delete
...
reaper.ShowMessageBox("Not yet implemented: Delete Clip Gain Breakpoints", "PT2Reaper", 0)
