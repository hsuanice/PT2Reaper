-- @description hsuanice_Pro Tools Compare Plugin Settings
...
--
--   ## Details
--   - Pro Tools equivalent : Compare Plugin Settings
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Compare Plugin Settings", "PT2Reaper", 0)
