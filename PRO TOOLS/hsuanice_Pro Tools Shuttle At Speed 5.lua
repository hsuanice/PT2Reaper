-- @description hsuanice_Pro Tools Shuttle At Speed 5
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 5
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 5
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 5", "PT2Reaper", 0)
