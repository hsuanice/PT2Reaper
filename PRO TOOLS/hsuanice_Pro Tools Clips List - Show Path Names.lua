-- @description hsuanice_Pro Tools Clips List: Show Path Names
...
--   **Clips List: Show Path Names**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Path Names
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
--   - Tags                 : Clips, Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Path Names", "PT2Reaper", 0)
