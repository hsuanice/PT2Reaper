-- @description hsuanice_Pro Tools Show All Pan Automation Lanes
...
--   **Show All Pan Automation Lanes**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show All Pan Automation Lanes
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show All Pan Automation Lanes", "PT2Reaper", 0)
