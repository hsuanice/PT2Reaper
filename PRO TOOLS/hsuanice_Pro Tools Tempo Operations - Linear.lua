-- @description hsuanice_Pro Tools Tempo Operations: Linear
...
--   **Tempo Operations: Linear**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations: Linear
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations: Linear", "PT2Reaper", 0)
