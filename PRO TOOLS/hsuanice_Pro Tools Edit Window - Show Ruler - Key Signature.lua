-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Key Signature
...
--   **Edit Window: Show Ruler: Key Signature**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Key Signature
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Key Signature", "PT2Reaper", 0)
