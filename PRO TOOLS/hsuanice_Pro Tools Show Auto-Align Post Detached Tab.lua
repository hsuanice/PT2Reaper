-- @description hsuanice_Pro Tools Show Auto-Align Post Detached Tab
...
--   **Show Auto-Align Post Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Auto-Align Post Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show Auto-Align Post Detached Tab", "PT2Reaper", 0)
