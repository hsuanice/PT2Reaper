-- @description hsuanice_Pro Tools Scrubber Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Scrubber Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : F9
--   - Tags                 : Edit Tools, Editing, Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Scrubber Tool", "PT2Reaper", 0)
