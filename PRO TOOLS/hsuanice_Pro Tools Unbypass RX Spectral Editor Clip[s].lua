-- @description hsuanice_Pro Tools Unbypass RX Spectral Editor Clip(s)
...
--   **Unbypass RX Spectral Editor Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass RX Spectral Editor Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass RX Spectral Editor Clip(s)", "PT2Reaper", 0)
