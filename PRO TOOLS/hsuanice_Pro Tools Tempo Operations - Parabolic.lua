-- @description hsuanice_Pro Tools Tempo Operations: Parabolic
...
--   **Tempo Operations: Parabolic**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations: Parabolic
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations: Parabolic", "PT2Reaper", 0)
