-- @description hsuanice_Pro Tools Use Delay Compensation
...
--
--   ## Details
--   - Pro Tools equivalent : Use Delay Compensation
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Use Delay Compensation", "PT2Reaper", 0)
