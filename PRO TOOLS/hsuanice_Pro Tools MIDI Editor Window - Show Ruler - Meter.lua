-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Meter
...
--   **MIDI Editor Window: Show Ruler: Meter**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Meter
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Meter", "PT2Reaper", 0)
