-- @description hsuanice_Pro Tools Split Selected Tracks To Mono
...
--   **Split Selected Tracks To Mono**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Split Selected Tracks To Mono
--   - Module               : Tracks
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Split Selected Tracks To Mono", "PT2Reaper", 0)
