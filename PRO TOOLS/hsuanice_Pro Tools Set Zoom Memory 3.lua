-- @description hsuanice_Pro Tools Set Zoom Memory 3
...
--
--   ## Details
--   - Pro Tools equivalent : Set Zoom Memory 3
--   - Module               : Zoom
--   - Mac shortcut (PT)    : —
--   - Tags                 : Zoom
--
...
reaper.ShowMessageBox("Not yet implemented: Set Zoom Memory 3", "PT2Reaper", 0)
