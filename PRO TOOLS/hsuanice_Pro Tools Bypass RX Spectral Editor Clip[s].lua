-- @description hsuanice_Pro Tools Bypass RX Spectral Editor Clip(s)
...
--   **Bypass RX Spectral Editor Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass RX Spectral Editor Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass RX Spectral Editor Clip(s)", "PT2Reaper", 0)
