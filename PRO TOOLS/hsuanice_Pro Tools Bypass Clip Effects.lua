-- @description hsuanice_Pro Tools Bypass Clip Effects
...
--
--   ## Details
--   - Pro Tools equivalent : Bypass Clip Effects
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
--   - Tags                 : Clip Gain/Effects, Clip menu, Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Bypass Clip Effects", "PT2Reaper", 0)
