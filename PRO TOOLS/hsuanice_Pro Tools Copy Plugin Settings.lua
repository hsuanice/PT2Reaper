-- @description hsuanice_Pro Tools Copy Plugin Settings
...
--
--   ## Details
--   - Pro Tools equivalent : Copy Plugin Settings
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + C
...
reaper.ShowMessageBox("Not yet implemented: Copy Plugin Settings", "PT2Reaper", 0)
