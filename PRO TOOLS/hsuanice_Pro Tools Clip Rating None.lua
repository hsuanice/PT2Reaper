-- @description hsuanice_Pro Tools Clip Rating None
...
--
--   ## Details
--   - Pro Tools equivalent : Clip Rating None
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad 0
...
reaper.ShowMessageBox("Not yet implemented: Clip Rating None", "PT2Reaper", 0)
