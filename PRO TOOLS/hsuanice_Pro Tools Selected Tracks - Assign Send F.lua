-- @description hsuanice_Pro Tools Selected Tracks: Assign Send F
...
--   **Selected Tracks: Assign Send F**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send F
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send F", "PT2Reaper", 0)
