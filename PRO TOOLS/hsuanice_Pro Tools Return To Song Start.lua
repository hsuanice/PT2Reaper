-- @description hsuanice_Pro Tools Return To Song Start
...
--   **Return To Song Start**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Return To Song Start
--   - Module               : Transport
--   - Mac shortcut (PT)    : Control + Return
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Return To Song Start", "PT2Reaper", 0)
