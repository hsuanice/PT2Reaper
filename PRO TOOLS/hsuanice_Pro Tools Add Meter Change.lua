-- @description hsuanice_Pro Tools Add Meter Change
...
--
--   ## Details
--   - Pro Tools equivalent : Add Meter Change
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : Tempo/Meter
--
...
reaper.ShowMessageBox("Not yet implemented: Add Meter Change", "PT2Reaper", 0)
