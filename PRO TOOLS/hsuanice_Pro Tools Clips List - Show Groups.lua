-- @description hsuanice_Pro Tools Clips List: Show Groups
...
--   **Clips List: Show Groups**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Groups
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + 4
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Groups", "PT2Reaper", 0)
