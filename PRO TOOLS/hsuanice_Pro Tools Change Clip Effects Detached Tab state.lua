-- @description hsuanice_Pro Tools Change Clip Effects Detached Tab state
...
--   **Change Clip Effects Detached Tab state**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Clip Effects Detached Tab state
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Clip Effects Detached Tab state", "PT2Reaper", 0)
