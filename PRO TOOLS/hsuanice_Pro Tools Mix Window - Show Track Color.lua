-- @description hsuanice_Pro Tools Mix Window: Show Track Color
...
--   **Mix Window: Show Track Color**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Track Color
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Track Color", "PT2Reaper", 0)
