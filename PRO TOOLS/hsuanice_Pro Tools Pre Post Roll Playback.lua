-- @description hsuanice_Pro Tools Pre Post Roll Playback
...
--
--   ## Details
--   - Pro Tools equivalent : Pre Post Roll Playback
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + K
...
reaper.ShowMessageBox("Not yet implemented: Pre Post Roll Playback", "PT2Reaper", 0)
