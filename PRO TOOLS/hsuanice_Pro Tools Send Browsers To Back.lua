-- @description hsuanice_Pro Tools Send Browsers To Back
...
--   **Send Browsers To Back**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Send Browsers To Back
--   - Module               : View
--   - Mac shortcut (PT)    : Option + Shift + J
...
reaper.ShowMessageBox("Not yet implemented: Send Browsers To Back", "PT2Reaper", 0)
