-- @description hsuanice_Pro Tools Write Automation to Selection
...
--
--   ## Details
--   - Pro Tools equivalent : Write Automation to Selection
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Write Automation to Selection", "PT2Reaper", 0)
