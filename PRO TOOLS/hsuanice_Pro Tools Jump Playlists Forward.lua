-- @description hsuanice_Pro Tools Jump Playlists Forward
...
--   **Jump Playlists Forward**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Jump Playlists Forward
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Page Down
...
reaper.ShowMessageBox("Not yet implemented: Jump Playlists Forward", "PT2Reaper", 0)
