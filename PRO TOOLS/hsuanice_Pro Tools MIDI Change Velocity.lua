-- @description hsuanice_Pro Tools MIDI Change Velocity
...
--   **MIDI Change Velocity**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Change Velocity
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing, MIDI
--
...
reaper.ShowMessageBox("Not yet implemented: MIDI Change Velocity", "PT2Reaper", 0)
