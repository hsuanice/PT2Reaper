-- @description hsuanice_Pro Tools Edit Window: Show MIDI Controls
...
--   **Edit Window: Show MIDI Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show MIDI Controls
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : MIDI, Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show MIDI Controls", "PT2Reaper", 0)
