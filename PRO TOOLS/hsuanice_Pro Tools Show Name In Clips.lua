-- @description hsuanice_Pro Tools Show Name In Clips
...
--
--   ## Details
--   - Pro Tools equivalent : Show Name In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Name In Clips", "PT2Reaper", 0)
