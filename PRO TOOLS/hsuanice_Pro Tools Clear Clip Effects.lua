-- @description hsuanice_Pro Tools Clear Clip Effects
...
--
--   ## Details
--   - Pro Tools equivalent : Clear Clip Effects
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + B
...
reaper.ShowMessageBox("Not yet implemented: Clear Clip Effects", "PT2Reaper", 0)
