-- @description hsuanice_Pro Tools Edit Window: Show Real-Time Properties View
...
--   **Edit Window: Show Real-Time Properties View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Real-Time Properties View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Real-Time Properties View", "PT2Reaper", 0)
