-- @description hsuanice_Pro Tools Show Docked RePitch
...
--
--   ## Details
--   - Pro Tools equivalent : Show Docked RePitch
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked RePitch", "PT2Reaper", 0)
