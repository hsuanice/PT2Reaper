-- @description hsuanice_Pro Tools Move Marker Target To Previous Track
...
--   **Move Marker Target To Previous Track**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Marker Target To Previous Track
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Move Marker Target To Previous Track", "PT2Reaper", 0)
