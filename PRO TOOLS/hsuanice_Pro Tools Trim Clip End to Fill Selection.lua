...
--   **Trim Clip End to Fill Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Trim Clip End to Fill Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Trim Clip End to Fill Selection", "PT2Reaper", 0)
