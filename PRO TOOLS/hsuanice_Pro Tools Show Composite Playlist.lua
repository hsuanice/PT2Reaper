-- @description hsuanice_Pro Tools Show Composite Playlist
...
--   **Show Composite Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Composite Playlist
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation, Show/Hide, View menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Composite Playlist", "PT2Reaper", 0)
