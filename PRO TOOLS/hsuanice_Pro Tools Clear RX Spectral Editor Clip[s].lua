-- @description hsuanice_Pro Tools Clear RX Spectral Editor Clip(s)
...
--   **Clear RX Spectral Editor Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear RX Spectral Editor Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear RX Spectral Editor Clip(s)", "PT2Reaper", 0)
