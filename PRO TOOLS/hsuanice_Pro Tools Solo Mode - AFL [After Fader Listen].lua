-- @description hsuanice_Pro Tools Solo Mode: AFL (After Fader Listen)
...
--   **Solo Mode: AFL (After Fader Listen)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Solo Mode: AFL (After Fader Listen)
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Solo Mode: AFL (After Fader Listen)", "PT2Reaper", 0)
