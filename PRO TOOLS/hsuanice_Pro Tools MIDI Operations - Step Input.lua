-- @description hsuanice_Pro Tools MIDI Operations: Step Input
...
--   **MIDI Operations: Step Input**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Step Input
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Step Input", "PT2Reaper", 0)
