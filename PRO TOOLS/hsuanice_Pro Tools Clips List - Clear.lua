-- @description hsuanice_Pro Tools Clips List: Clear
...
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Clear
--   - Module               : Clips
--   - Mac shortcut (PT)    : Clear
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Clear", "PT2Reaper", 0)
