-- @description hsuanice_Pro Tools Link/Unlink Video Satellite
...
--   **Link/Unlink Video Satellite**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Link/Unlink Video Satellite
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Shift + L
--   - Tags                 : Transport, Video
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Link/Unlink Video Satellite", "PT2Reaper", 0)
