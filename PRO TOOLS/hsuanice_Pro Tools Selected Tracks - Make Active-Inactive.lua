-- @description hsuanice_Pro Tools Selected Tracks: Make Active/Inactive
...
--   **Selected Tracks: Make Active/Inactive**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Make Active/Inactive
--   - Module               : Tracks
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Make Active/Inactive", "PT2Reaper", 0)
