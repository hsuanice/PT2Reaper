-- @description hsuanice_Pro Tools Edit Track(s) with Melodyne
...
--   **Edit Track(s) with Melodyne**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with Melodyne
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with Melodyne", "PT2Reaper", 0)
