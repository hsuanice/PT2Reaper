-- @description hsuanice_Pro Tools Cut All Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Cut All Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : Option + Shift + X
...
reaper.ShowMessageBox("Not yet implemented: Cut All Automation", "PT2Reaper", 0)
