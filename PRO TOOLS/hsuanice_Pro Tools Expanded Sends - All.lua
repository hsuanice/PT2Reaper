-- @description hsuanice_Pro Tools Expanded Sends: All
...
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: All
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: All", "PT2Reaper", 0)
