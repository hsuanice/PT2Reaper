-- @description hsuanice_Pro Tools Unbypass RX Spectral Editor Track(s)
...
--   **Unbypass RX Spectral Editor Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass RX Spectral Editor Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass RX Spectral Editor Track(s)", "PT2Reaper", 0)
