-- @description hsuanice_Pro Tools New Soundbase Window
...
--   **New Soundbase Window**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : New Soundbase Window
--   - Module               : View
...
reaper.ShowMessageBox("Not yet implemented: New Soundbase Window", "PT2Reaper", 0)
