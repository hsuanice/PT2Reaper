-- @description hsuanice_Pro Tools Clear with All Automation Playlists
...
--   **Clear with All Automation Playlists**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear with All Automation Playlists
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Control + B
...
reaper.ShowMessageBox("Not yet implemented: Clear with All Automation Playlists", "PT2Reaper", 0)
