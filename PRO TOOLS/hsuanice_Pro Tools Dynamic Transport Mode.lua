-- @description hsuanice_Pro Tools Dynamic Transport Mode
...
--
--   ## Details
--   - Pro Tools equivalent : Dynamic Transport Mode
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Control + P
...
reaper.ShowMessageBox("Not yet implemented: Dynamic Transport Mode", "PT2Reaper", 0)
