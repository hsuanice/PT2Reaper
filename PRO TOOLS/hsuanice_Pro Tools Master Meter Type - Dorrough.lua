-- @description hsuanice_Pro Tools Master Meter Type: Dorrough
...
--   **Master Meter Type: Dorrough**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: Dorrough
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: Dorrough", "PT2Reaper", 0)
