-- @description hsuanice_Pro Tools Single Zoom Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Single Zoom Tool
--   - Module               : Zoom
--   - Mac shortcut (PT)    : —
--   - Tags                 : Zoom
--
...
reaper.ShowMessageBox("Not yet implemented: Single Zoom Tool", "PT2Reaper", 0)
