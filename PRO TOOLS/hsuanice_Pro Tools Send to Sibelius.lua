-- @description hsuanice_Pro Tools Send to Sibelius
...
--
--   ## Details
--   - Pro Tools equivalent : Send to Sibelius
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Send to Sibelius", "PT2Reaper", 0)
