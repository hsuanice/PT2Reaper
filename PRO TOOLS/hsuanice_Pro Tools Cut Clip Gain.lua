-- @description hsuanice_Pro Tools Cut Clip Gain
...
--
--   ## Details
--   - Pro Tools equivalent : Cut Clip Gain
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + X
...
reaper.ShowMessageBox("Not yet implemented: Cut Clip Gain", "PT2Reaper", 0)
