-- @description hsuanice_Pro Tools Write Automation to Selection Start
...
--
--   ## Details
--   - Pro Tools equivalent : Write Automation to Selection Start
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Write Automation to Selection Start", "PT2Reaper", 0)
