-- @description hsuanice_Pro Tools Auto Spot Clips
...
--
--   ## Details
--   - Pro Tools equivalent : Auto Spot Clips
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Auto Spot Clips", "PT2Reaper", 0)
