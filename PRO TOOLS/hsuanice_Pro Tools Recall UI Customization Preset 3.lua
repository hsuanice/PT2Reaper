-- @description hsuanice_Pro Tools Recall UI Customization Preset 3
...
--   **Recall UI Customization Preset 3**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall UI Customization Preset 3
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Miscellaneous
--
...
reaper.ShowMessageBox("Not yet implemented: Recall UI Customization Preset 3", "PT2Reaper", 0)
