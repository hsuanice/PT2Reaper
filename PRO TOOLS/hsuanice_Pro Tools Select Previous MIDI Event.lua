-- @description hsuanice_Pro Tools Select Previous MIDI Event
...
--   **Select Previous MIDI Event**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Select Previous MIDI Event
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing, MIDI
--
...
reaper.ShowMessageBox("Not yet implemented: Select Previous MIDI Event", "PT2Reaper", 0)
