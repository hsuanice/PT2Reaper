-- @description hsuanice_Pro Tools Cascade Windows
...
--
--   ## Details
--   - Pro Tools equivalent : Cascade Windows
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Cascade Windows", "PT2Reaper", 0)
