-- @description hsuanice_Pro Tools Right Arrow Context Command (Extend Selection)
...
--   **Right Arrow Context Command (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Right Arrow Context Command (Extend Selection)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Right Arrow
--   - Tags                 : Editing, Navigation, Zoom
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Right Arrow Context Command (Extend Selection)", "PT2Reaper", 0)
