-- @description hsuanice_Pro Tools Shuttle At Speed 3 (Extend Selection)
...
--   **Shuttle At Speed 3 (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 3 (Extend Selection)
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Shift + Numpad 3
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 3 (Extend Selection)", "PT2Reaper", 0)
