-- @description hsuanice_Pro Tools Synchronizer Shuttle Backward
...
--   **Synchronizer Shuttle Backward**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Synchronizer Shuttle Backward
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Comma
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Synchronizer Shuttle Backward", "PT2Reaper", 0)
