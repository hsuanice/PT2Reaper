-- @description hsuanice_Pro Tools Copy and Transpose Up (In Key)
...
--
--   ## Details
--   - Pro Tools equivalent : Copy and Transpose Up (In Key)
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Copy and Transpose Up (In Key)", "PT2Reaper", 0)
