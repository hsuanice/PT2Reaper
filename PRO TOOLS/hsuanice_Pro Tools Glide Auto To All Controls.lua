-- @description hsuanice_Pro Tools Glide Auto To All Controls
...
--   **Glide Auto To All Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Glide Auto To All Controls
--   - Module               : Automation
...
reaper.ShowMessageBox("Not yet implemented: Glide Auto To All Controls", "PT2Reaper", 0)
