-- @description hsuanice_Pro Tools Edit Window Scrolling: No Scrolling
...
--   **Edit Window Scrolling: No Scrolling**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window Scrolling: No Scrolling
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window Scrolling: No Scrolling", "PT2Reaper", 0)
