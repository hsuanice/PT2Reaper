-- @description hsuanice_Pro Tools MIDI Operations: Flatten
...
--   **MIDI Operations: Flatten**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Flatten
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Flatten", "PT2Reaper", 0)
