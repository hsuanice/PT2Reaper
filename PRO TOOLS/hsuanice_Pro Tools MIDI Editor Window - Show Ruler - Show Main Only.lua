-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Show Main Only
...
--   **MIDI Editor Window: Show Ruler: Show Main Only**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Show Main Only
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Show Main Only", "PT2Reaper", 0)
