-- @description hsuanice_Pro Tools Automation: Auto Match
...
--
--   ## Details
--   - Pro Tools equivalent : Automation: Auto Match
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Automation: Auto Match", "PT2Reaper", 0)
