-- @description hsuanice_Pro Tools MIDI Operations: Change Velocity
...
--   **MIDI Operations: Change Velocity**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Change Velocity
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Change Velocity", "PT2Reaper", 0)
