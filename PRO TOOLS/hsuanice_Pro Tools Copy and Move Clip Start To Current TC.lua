...
--   **Copy and Move Clip Start To Current TC**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Move Clip Start To Current TC
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + Control + Y
--   - Tags                 : Clips, Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy and Move Clip Start To Current TC", "PT2Reaper", 0)
