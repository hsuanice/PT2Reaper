-- @description hsuanice_Pro Tools Clips List: Find
...
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Find
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + F
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Find", "PT2Reaper", 0)
