...
--   **Copy and Move Clip End To Play Position**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Move Clip End To Play Position
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + Control + K
--   - Tags                 : Clips, Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy and Move Clip End To Play Position", "PT2Reaper", 0)
