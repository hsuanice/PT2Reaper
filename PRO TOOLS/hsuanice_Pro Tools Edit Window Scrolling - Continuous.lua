-- @description hsuanice_Pro Tools Edit Window Scrolling: Continuous
...
--   **Edit Window Scrolling: Continuous**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window Scrolling: Continuous
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window Scrolling: Continuous", "PT2Reaper", 0)
