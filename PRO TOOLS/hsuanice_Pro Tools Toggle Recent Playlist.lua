-- @description hsuanice_Pro Tools Toggle Recent Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Toggle Recent Playlist
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Toggle Recent Playlist", "PT2Reaper", 0)
