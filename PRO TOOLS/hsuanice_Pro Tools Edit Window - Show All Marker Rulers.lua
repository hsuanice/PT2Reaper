-- @description hsuanice_Pro Tools Edit Window: Show All Marker Rulers
...
--   **Edit Window: Show All Marker Rulers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show All Marker Rulers
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show All Marker Rulers", "PT2Reaper", 0)
