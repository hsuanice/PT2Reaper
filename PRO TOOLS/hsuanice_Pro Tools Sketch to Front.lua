-- @description hsuanice_Pro Tools Sketch to Front
...
--
--   ## Details
--   - Pro Tools equivalent : Sketch to Front
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Option + Control + Equals
...
reaper.ShowMessageBox("Not yet implemented: Sketch to Front", "PT2Reaper", 0)
