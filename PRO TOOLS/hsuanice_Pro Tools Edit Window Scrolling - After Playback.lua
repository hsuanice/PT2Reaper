-- @description hsuanice_Pro Tools Edit Window Scrolling: After Playback
...
--   **Edit Window Scrolling: After Playback**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window Scrolling: After Playback
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation, Options menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window Scrolling: After Playback", "PT2Reaper", 0)
