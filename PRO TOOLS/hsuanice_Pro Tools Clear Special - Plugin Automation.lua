-- @description hsuanice_Pro Tools Clear Special: Plugin Automation
...
--   **Clear Special: Plugin Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Special: Plugin Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Special: Plugin Automation", "PT2Reaper", 0)
