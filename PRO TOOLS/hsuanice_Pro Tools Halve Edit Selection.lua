...
--   **Halve Edit Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Halve Edit Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + Shift + L
...
reaper.ShowMessageBox("Not yet implemented: Halve Edit Selection", "PT2Reaper", 0)
