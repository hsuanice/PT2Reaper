-- @description hsuanice_Pro Tools Transpose Up (In Key)
...
--
--   ## Details
--   - Pro Tools equivalent : Transpose Up (In Key)
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Transpose Up (In Key)", "PT2Reaper", 0)
