-- @description hsuanice_Pro Tools Inserts: Bypass All EQ
...
--   **Inserts: Bypass All EQ**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Inserts: Bypass All EQ
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + E
...
reaper.ShowMessageBox("Not yet implemented: Inserts: Bypass All EQ", "PT2Reaper", 0)
