-- @description hsuanice_Pro Tools Gain Reduction Meter Type: All Priority Expander
...
--   **Gain Reduction Meter Type: All Priority Expander**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Gain Reduction Meter Type: All Priority Expander
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Gain Reduction Meter Type: All Priority Expander", "PT2Reaper", 0)
