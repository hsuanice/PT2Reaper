-- @description hsuanice_Pro Tools Soundbase
...
--
--   ## Details
--   - Pro Tools equivalent : Soundbase
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide, Workspace
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Soundbase", "PT2Reaper", 0)
