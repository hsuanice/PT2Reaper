-- @description hsuanice_Pro Tools TrackPunch
...
--
--   ## Details
--   - Pro Tools equivalent : TrackPunch
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + T
...
reaper.ShowMessageBox("Not yet implemented: TrackPunch", "PT2Reaper", 0)
