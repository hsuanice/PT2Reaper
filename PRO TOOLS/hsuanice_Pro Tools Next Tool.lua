-- @description hsuanice_Pro Tools Next Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Next Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : Escape
...
reaper.ShowMessageBox("Not yet implemented: Next Tool", "PT2Reaper", 0)
