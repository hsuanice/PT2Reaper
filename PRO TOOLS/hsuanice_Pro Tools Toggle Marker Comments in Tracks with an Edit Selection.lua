-- @description hsuanice_Pro Tools Toggle Marker Comments in Tracks with an Edit Selection
...
--   **Toggle Marker Comments in Tracks with an Edit Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Toggle Marker Comments in Tracks with an Edit Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + N
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Toggle Marker Comments in Tracks with an Edit Selection", "PT2Reaper", 0)
