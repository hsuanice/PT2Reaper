-- @description hsuanice_Pro Tools Expanded Sends: Send D
...
--   **Expanded Sends: Send D**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send D
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send D", "PT2Reaper", 0)
