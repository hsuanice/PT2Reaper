-- @description hsuanice_Pro Tools Recall Window Configuration (Extend Selection)
...
--   **Recall Window Configuration (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Window Configuration (Extend Selection)
--   - Module               : View
--   - Mac shortcut (PT)    : Shift + Numpad *
--   - Tags                 : Window
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Recall Window Configuration (Extend Selection)", "PT2Reaper", 0)
