-- @description hsuanice_Pro Tools Main Counter: Feet+Frames
...
--   **Main Counter: Feet+Frames**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Main Counter: Feet+Frames
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Main Counter: Feet+Frames", "PT2Reaper", 0)
