-- @description hsuanice_Pro Tools Print Score
...
--
--   ## Details
--   - Pro Tools equivalent : Print Score
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + P
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Print Score", "PT2Reaper", 0)
