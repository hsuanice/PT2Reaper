-- @description hsuanice_Pro Tools New Sketch
...
--
--   ## Details
--   - Pro Tools equivalent : New Sketch
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + Control + N
--   - Tags                 : —
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: New Sketch", "PT2Reaper", 0)
