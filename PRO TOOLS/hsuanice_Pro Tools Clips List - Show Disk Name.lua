-- @description hsuanice_Pro Tools Clips List: Show Disk Name
...
--   **Clips List: Show Disk Name**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Disk Name
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Disk Name", "PT2Reaper", 0)
