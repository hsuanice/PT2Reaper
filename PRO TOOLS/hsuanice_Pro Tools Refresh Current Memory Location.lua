-- @description hsuanice_Pro Tools Refresh Current Memory Location
...
--   **Refresh Current Memory Location**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Refresh Current Memory Location
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation
--
...
reaper.ShowMessageBox("Not yet implemented: Refresh Current Memory Location", "PT2Reaper", 0)
