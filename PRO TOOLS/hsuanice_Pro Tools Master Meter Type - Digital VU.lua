-- @description hsuanice_Pro Tools Master Meter Type: Digital VU
...
--   **Master Meter Type: Digital VU**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: Digital VU
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: Digital VU", "PT2Reaper", 0)
