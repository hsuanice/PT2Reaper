-- @description hsuanice_Pro Tools Zoom Out Audio Vertical
...
--   **Zoom Out Audio Vertical**
--
--   ## Mapping
--   - Pro Tools equivalent : Zoom Out Audio Vertical
--   - Reaper action        : View: Zoom out vertical
--   - Command ID           : 40112
--   - Module               : Zoom
...
--   0.1.0 [260413.1324]
--     - Initial release
--     - Maps Pro Tools "Zoom Out Audio Vertical" to Reaper command ID 40112
