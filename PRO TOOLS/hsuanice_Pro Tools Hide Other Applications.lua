-- @description hsuanice_Pro Tools Hide Other Applications
...
--
--   ## Details
--   - Pro Tools equivalent : Hide Other Applications
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Hide Other Applications", "PT2Reaper", 0)
