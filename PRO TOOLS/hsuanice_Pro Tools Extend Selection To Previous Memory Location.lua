-- @description hsuanice_Pro Tools Extend Selection To Previous Memory Location
...
--   **Extend Selection To Previous Memory Location**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Extend Selection To Previous Memory Location
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation
--
...
reaper.ShowMessageBox("Not yet implemented: Extend Selection To Previous Memory Location", "PT2Reaper", 0)
