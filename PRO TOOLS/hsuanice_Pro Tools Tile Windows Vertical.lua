-- @description hsuanice_Pro Tools Tile Windows Vertical
...
--
--   ## Details
--   - Pro Tools equivalent : Tile Windows Vertical
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tile Windows Vertical", "PT2Reaper", 0)
