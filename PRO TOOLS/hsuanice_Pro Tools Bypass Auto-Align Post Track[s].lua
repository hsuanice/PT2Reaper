-- @description hsuanice_Pro Tools Bypass Auto-Align Post Track(s)
...
--   **Bypass Auto-Align Post Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass Auto-Align Post Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass Auto-Align Post Track(s)", "PT2Reaper", 0)
