-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert I
...
--   **Selected Tracks: Assign Insert I**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert I
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert I", "PT2Reaper", 0)
