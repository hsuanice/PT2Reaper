-- @description hsuanice_Pro Tools Clips List: Clear Find
...
--   **Clips List: Clear Find**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Clear Find
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + D
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Clear Find", "PT2Reaper", 0)
