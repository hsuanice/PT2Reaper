-- @description hsuanice_Pro Tools Playlists View: Move Selection to Duplicate Playlist
...
--   **Playlists View: Move Selection to Duplicate Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Playlists View: Move Selection to Duplicate Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Playlists View: Move Selection to Duplicate Playlist", "PT2Reaper", 0)
