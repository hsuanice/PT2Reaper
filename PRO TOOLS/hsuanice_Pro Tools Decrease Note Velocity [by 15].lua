-- @description hsuanice_Pro Tools Decrease Note Velocity (by 15)
...
--   **Decrease Note Velocity (by 15)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Decrease Note Velocity (by 15)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + Down Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Decrease Note Velocity (by 15)", "PT2Reaper", 0)
