-- @description hsuanice_Pro Tools MIDI Input Filter
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Input Filter
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Input Filter", "PT2Reaper", 0)
