-- @description hsuanice_Pro Tools Clips List: Show File Name
...
--   **Clips List: Show File Name**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show File Name
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show File Name", "PT2Reaper", 0)
