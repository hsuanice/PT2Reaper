-- @description hsuanice_Pro Tools Recall Window Configuration
...
--
--   ## Details
--   - Pro Tools equivalent : Recall Window Configuration
--   - Module               : View
...
reaper.ShowMessageBox("Not yet implemented: Recall Window Configuration", "PT2Reaper", 0)
