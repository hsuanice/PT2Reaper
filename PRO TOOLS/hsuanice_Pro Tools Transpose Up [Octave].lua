-- @description hsuanice_Pro Tools Transpose Up (Octave)
...
--
--   ## Details
--   - Pro Tools equivalent : Transpose Up (Octave)
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Transpose Up (Octave)", "PT2Reaper", 0)
