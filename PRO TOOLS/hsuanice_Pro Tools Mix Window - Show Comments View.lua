-- @description hsuanice_Pro Tools Mix Window: Show Comments View
...
--   **Mix Window: Show Comments View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Comments View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Comments View", "PT2Reaper", 0)
