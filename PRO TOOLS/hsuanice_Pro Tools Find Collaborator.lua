-- @description hsuanice_Pro Tools Find Collaborator
...
--
--   ## Details
--   - Pro Tools equivalent : Find Collaborator
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Find Collaborator", "PT2Reaper", 0)
