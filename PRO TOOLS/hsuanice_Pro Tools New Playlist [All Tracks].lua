-- @description hsuanice_Pro Tools New Playlist (All Tracks)
...
--   **New Playlist (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : New Playlist (All Tracks)
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Option + Control + \
--   - Tags                 : Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: New Playlist (All Tracks)", "PT2Reaper", 0)
