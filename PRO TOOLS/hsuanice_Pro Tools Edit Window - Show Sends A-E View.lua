-- @description hsuanice_Pro Tools Edit Window: Show Sends A-E View
...
--   **Edit Window: Show Sends A-E View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Sends A-E View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Sends A-E View", "PT2Reaper", 0)
