-- @description hsuanice_Pro Tools Click/Countoff Options
...
--
--   ## Details
--   - Pro Tools equivalent : Click/Countoff Options
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Click/Countoff Options", "PT2Reaper", 0)
