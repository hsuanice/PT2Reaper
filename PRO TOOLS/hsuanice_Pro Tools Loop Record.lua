-- @description hsuanice_Pro Tools Loop Record
...
--
--   ## Details
--   - Pro Tools equivalent : Loop Record
--   - Module               : Misc
--   - Mac shortcut (PT)    : Numpad 5
...
reaper.ShowMessageBox("Not yet implemented: Loop Record", "PT2Reaper", 0)
