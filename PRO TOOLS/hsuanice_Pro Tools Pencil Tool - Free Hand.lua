-- @description hsuanice_Pro Tools Pencil Tool: Free Hand
...
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: Free Hand
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: Free Hand", "PT2Reaper", 0)
