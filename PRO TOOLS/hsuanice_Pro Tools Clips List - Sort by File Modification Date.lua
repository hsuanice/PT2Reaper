-- @description hsuanice_Pro Tools Clips List: Sort by File Modification Date
...
--   **Clips List: Sort by File Modification Date**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by File Modification Date
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by File Modification Date", "PT2Reaper", 0)
