-- @description hsuanice_Pro Tools Show Clip Gain Line In Clips
...
--   **Show Clip Gain Line In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Gain Line In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + Minus
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Gain Line In Clips", "PT2Reaper", 0)
