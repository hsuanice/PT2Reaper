-- @description hsuanice_Pro Tools Step Input: Whole Note
...
--   **Step Input: Whole Note**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: Whole Note
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 1
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: Whole Note", "PT2Reaper", 0)
