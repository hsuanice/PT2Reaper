-- @description hsuanice_Pro Tools Marker Displays: Track Marker Lane
...
--   **Marker Displays: Track Marker Lane**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Marker Displays: Track Marker Lane
--   - Module               : View
--   - Mac shortcut (PT)    : Shift + U
...
reaper.ShowMessageBox("Not yet implemented: Marker Displays: Track Marker Lane", "PT2Reaper", 0)
