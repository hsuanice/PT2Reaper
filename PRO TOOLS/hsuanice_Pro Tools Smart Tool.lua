-- @description hsuanice_Pro Tools Smart Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Smart Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + 7
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Smart Tool", "PT2Reaper", 0)
