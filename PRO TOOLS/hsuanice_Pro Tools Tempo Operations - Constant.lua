-- @description hsuanice_Pro Tools Tempo Operations: Constant
...
--   **Tempo Operations: Constant**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations: Constant
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations: Constant", "PT2Reaper", 0)
