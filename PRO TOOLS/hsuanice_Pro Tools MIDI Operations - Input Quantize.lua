-- @description hsuanice_Pro Tools MIDI Operations: Input Quantize
...
--   **MIDI Operations: Input Quantize**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Input Quantize
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Input Quantize", "PT2Reaper", 0)
