-- @description hsuanice_Pro Tools Show Clip Rating
...
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Rating
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Rating", "PT2Reaper", 0)
