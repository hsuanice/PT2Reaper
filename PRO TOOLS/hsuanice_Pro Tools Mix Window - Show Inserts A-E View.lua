-- @description hsuanice_Pro Tools Mix Window: Show Inserts A-E View
...
--   **Mix Window: Show Inserts A-E View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Inserts A-E View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Inserts A-E View", "PT2Reaper", 0)
