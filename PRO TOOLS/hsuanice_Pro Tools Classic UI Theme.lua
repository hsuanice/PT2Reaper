-- @description hsuanice_Pro Tools Classic UI Theme
...
--
--   ## Details
--   - Pro Tools equivalent : Classic UI Theme
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Classic UI Theme", "PT2Reaper", 0)
