-- @description hsuanice_Pro Tools Edit Window: Show Transport View
...
--   **Edit Window: Show Transport View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Transport View
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Transport View", "PT2Reaper", 0)
