-- @description hsuanice_Pro Tools Video Universe
...
--
--   ## Details
--   - Pro Tools equivalent : Video Universe
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Numpad 7
--   - Tags                 : Video, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Video Universe", "PT2Reaper", 0)
