-- @description hsuanice_Pro Tools Open Dashboard
...
--
--   ## Details
--   - Pro Tools equivalent : Open Dashboard
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + O
--   - Tags                 : File, File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Open Dashboard", "PT2Reaper", 0)
