-- @description hsuanice_Pro Tools Bypass Inserts A-E
...
--
--   ## Details
--   - Pro Tools equivalent : Bypass Inserts A-E
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + 2
...
reaper.ShowMessageBox("Not yet implemented: Bypass Inserts A-E", "PT2Reaper", 0)
