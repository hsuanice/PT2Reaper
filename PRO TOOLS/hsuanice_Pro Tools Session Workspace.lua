-- @description hsuanice_Pro Tools Session Workspace
...
--
--   ## Details
--   - Pro Tools equivalent : Session Workspace
--   - Module               : View
--   - Mac shortcut (PT)    : Option + O
...
reaper.ShowMessageBox("Not yet implemented: Session Workspace", "PT2Reaper", 0)
