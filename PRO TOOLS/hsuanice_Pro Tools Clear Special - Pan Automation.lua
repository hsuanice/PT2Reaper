-- @description hsuanice_Pro Tools Clear Special: Pan Automation
...
--   **Clear Special: Pan Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Special: Pan Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Special: Pan Automation", "PT2Reaper", 0)
