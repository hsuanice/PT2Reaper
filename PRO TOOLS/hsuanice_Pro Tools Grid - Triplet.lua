-- @description hsuanice_Pro Tools Grid: Triplet
...
--
--   ## Details
--   - Pro Tools equivalent : Grid: Triplet
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad Minus
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Grid: Triplet", "PT2Reaper", 0)
