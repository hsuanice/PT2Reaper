-- @description hsuanice_Pro Tools Clip Rating 4
...
--
--   ## Details
--   - Pro Tools equivalent : Clip Rating 4
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad 4
...
reaper.ShowMessageBox("Not yet implemented: Clip Rating 4", "PT2Reaper", 0)
