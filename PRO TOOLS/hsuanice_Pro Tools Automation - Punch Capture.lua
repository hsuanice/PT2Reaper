-- @description hsuanice_Pro Tools Automation: Punch Capture
...
--   **Automation: Punch Capture**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Automation: Punch Capture
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Automation: Punch Capture", "PT2Reaper", 0)
