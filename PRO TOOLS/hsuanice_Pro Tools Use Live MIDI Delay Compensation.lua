-- @description hsuanice_Pro Tools Use Live MIDI Delay Compensation
...
--   **Use Live MIDI Delay Compensation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Use Live MIDI Delay Compensation
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu, Plugins
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Use Live MIDI Delay Compensation", "PT2Reaper", 0)
