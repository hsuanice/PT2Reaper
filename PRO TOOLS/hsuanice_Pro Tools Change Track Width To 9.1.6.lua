-- @description hsuanice_Pro Tools Change Track Width To 9.1.6
...
--   **Change Track Width To 9.1.6**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To 9.1.6
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To 9.1.6", "PT2Reaper", 0)
