-- @description hsuanice_Pro Tools Toggle Focus View
...
--
--   ## Details
--   - Pro Tools equivalent : Toggle Focus View
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : MIDI, Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Toggle Focus View", "PT2Reaper", 0)
