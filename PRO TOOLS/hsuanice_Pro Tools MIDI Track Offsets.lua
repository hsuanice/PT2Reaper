-- @description hsuanice_Pro Tools MIDI Track Offsets
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Track Offsets
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Track Offsets", "PT2Reaper", 0)
