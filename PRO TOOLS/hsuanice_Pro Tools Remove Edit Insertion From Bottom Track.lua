-- @description hsuanice_Pro Tools Remove Edit Insertion From Bottom Track
...
--   **Remove Edit Insertion From Bottom Track**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Remove Edit Insertion From Bottom Track
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Control + Semicolon
...
reaper.ShowMessageBox("Not yet implemented: Remove Edit Insertion From Bottom Track", "PT2Reaper", 0)
