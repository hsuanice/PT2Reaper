-- @description hsuanice_Pro Tools Coalesce Trim Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Coalesce Trim Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Coalesce Trim Automation", "PT2Reaper", 0)
