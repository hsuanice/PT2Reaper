-- @description hsuanice_Pro Tools Shuttle At Speed 3
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 3
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 3
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 3", "PT2Reaper", 0)
