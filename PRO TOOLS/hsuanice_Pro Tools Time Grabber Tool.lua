-- @description hsuanice_Pro Tools Time Grabber Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Time Grabber Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Time Grabber Tool", "PT2Reaper", 0)
