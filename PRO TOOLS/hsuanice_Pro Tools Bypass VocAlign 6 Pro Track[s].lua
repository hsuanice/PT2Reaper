-- @description hsuanice_Pro Tools Bypass VocAlign 6 Pro Track(s)
...
--   **Bypass VocAlign 6 Pro Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass VocAlign 6 Pro Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass VocAlign 6 Pro Track(s)", "PT2Reaper", 0)
