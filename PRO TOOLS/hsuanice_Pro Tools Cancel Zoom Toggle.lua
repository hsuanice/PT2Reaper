-- @description hsuanice_Pro Tools Cancel Zoom Toggle
...
--
--   ## Details
--   - Pro Tools equivalent : Cancel Zoom Toggle
--   - Module               : Zoom
--   - Mac shortcut (PT)    : Option + Shift + E
--   - Tags                 : Zoom
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Cancel Zoom Toggle", "PT2Reaper", 0)
