-- @description hsuanice_Pro Tools Mix Window: Show Delay View
...
--   **Mix Window: Show Delay View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Delay View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Delay View", "PT2Reaper", 0)
