-- @description hsuanice_Pro Tools Score Editor
...
--
--   ## Details
--   - Pro Tools equivalent : Score Editor
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Option + Control + Numpad Equals
--   - Tags                 : MIDI, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Score Editor", "PT2Reaper", 0)
