-- @description hsuanice_Pro Tools Nudge Clip Gain Left
...
--   **Nudge Clip Gain Left**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Clip Gain Left
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + Numpad Minus
...
reaper.ShowMessageBox("Not yet implemented: Nudge Clip Gain Left", "PT2Reaper", 0)
