-- @description hsuanice_Pro Tools Change Track Width To Mono
...
--   **Change Track Width To Mono**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To Mono
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To Mono", "PT2Reaper", 0)
