-- @description hsuanice_Pro Tools Solo Tracks with an Edit Selection
...
--   **Solo Tracks with an Edit Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Solo Tracks with an Edit Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + S
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Solo Tracks with an Edit Selection", "PT2Reaper", 0)
