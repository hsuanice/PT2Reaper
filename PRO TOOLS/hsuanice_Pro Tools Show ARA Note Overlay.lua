-- @description hsuanice_Pro Tools Show ARA Note Overlay
...
--   **Show ARA Note Overlay**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show ARA Note Overlay
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show ARA Note Overlay", "PT2Reaper", 0)
