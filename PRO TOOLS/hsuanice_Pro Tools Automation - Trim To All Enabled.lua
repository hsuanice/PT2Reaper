-- @description hsuanice_Pro Tools Automation: Trim To All Enabled
...
--
--   ## Details
--   - Pro Tools equivalent : Automation: Trim To All Enabled
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Option + Shift + /
...
reaper.ShowMessageBox("Not yet implemented: Automation: Trim To All Enabled", "PT2Reaper", 0)
