-- @description hsuanice_Pro Tools Open Collaboration
...
--
--   ## Details
--   - Pro Tools equivalent : Open Collaboration
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Open Collaboration", "PT2Reaper", 0)
