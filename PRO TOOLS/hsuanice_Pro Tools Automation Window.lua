-- @description hsuanice_Pro Tools Automation Window
...
--
--   ## Details
--   - Pro Tools equivalent : Automation Window
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Numpad 4
--   - Tags                 : Automation, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Automation Window", "PT2Reaper", 0)
