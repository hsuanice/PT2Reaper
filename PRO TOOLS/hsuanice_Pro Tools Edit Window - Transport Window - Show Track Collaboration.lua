-- @description hsuanice_Pro Tools Edit Window: Transport Window: Show Track Collaboration
...
--   **Edit Window: Transport Window: Show Track Collaboration**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Transport Window: Show Track Collaboration
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab, Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Transport Window: Show Track Collaboration", "PT2Reaper", 0)
