-- @description hsuanice_Pro Tools Recall Clip Effects Preset 5
...
--   **Recall Clip Effects Preset 5**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Clip Effects Preset 5
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Recall Clip Effects Preset 5", "PT2Reaper", 0)
