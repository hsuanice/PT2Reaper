-- @description hsuanice_Pro Tools Mark Edit Selection Start
...
--   **Mark Edit Selection Start**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mark Edit Selection Start
--   - Module               : Selection
--   - Mac shortcut (PT)    : —
--   - Tags                 : Selection
--
...
reaper.ShowMessageBox("Not yet implemented: Mark Edit Selection Start", "PT2Reaper", 0)
