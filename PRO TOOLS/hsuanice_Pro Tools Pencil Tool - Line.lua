-- @description hsuanice_Pro Tools Pencil Tool: Line
...
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: Line
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: Line", "PT2Reaper", 0)
