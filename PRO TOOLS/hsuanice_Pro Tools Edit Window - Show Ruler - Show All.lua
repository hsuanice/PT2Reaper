-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Show All
...
--   **Edit Window: Show Ruler: Show All**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Show All
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Show All", "PT2Reaper", 0)
