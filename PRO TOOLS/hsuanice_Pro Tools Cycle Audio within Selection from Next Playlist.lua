-- @description hsuanice_Pro Tools Cycle Audio within Selection from Next Playlist
...
--   **Cycle Audio within Selection from Next Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Cycle Audio within Selection from Next Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Shift + Down Arrow
...
reaper.ShowMessageBox("Not yet implemented: Cycle Audio within Selection from Next Playlist", "PT2Reaper", 0)
