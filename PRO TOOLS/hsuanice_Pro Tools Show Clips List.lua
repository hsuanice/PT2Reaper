-- @description hsuanice_Pro Tools Show Clips List
...
--
--   ## Details
--   - Pro Tools equivalent : Show Clips List
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
--   - Tags                 : Clips, Clips List, Show/Hide, View menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Clips List", "PT2Reaper", 0)
