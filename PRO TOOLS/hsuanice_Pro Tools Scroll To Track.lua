-- @description hsuanice_Pro Tools Scroll To Track
...
--
--   ## Details
--   - Pro Tools equivalent : Scroll To Track
--   - Module               : Navigation
--   - Mac shortcut (PT)    : Command + Option + F
--   - Tags                 : Navigation, Track menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Scroll To Track", "PT2Reaper", 0)
