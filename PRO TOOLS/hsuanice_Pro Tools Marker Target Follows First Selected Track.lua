-- @description hsuanice_Pro Tools Marker Target Follows First Selected Track
...
--
--   ## Details
--   - Pro Tools equivalent : Marker Target Follows First Selected Track
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Marker Target Follows First Selected Track", "PT2Reaper", 0)
