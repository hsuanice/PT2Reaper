-- @description hsuanice_Pro Tools Start Collaboration
...
--
--   ## Details
--   - Pro Tools equivalent : Start Collaboration
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Start Collaboration", "PT2Reaper", 0)
