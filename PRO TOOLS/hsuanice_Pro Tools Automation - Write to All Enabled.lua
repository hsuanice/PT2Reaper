-- @description hsuanice_Pro Tools Automation: Write to All Enabled
...
--
--   ## Details
--   - Pro Tools equivalent : Automation: Write to All Enabled
--   - Module               : Automation
...
reaper.ShowMessageBox("Not yet implemented: Automation: Write to All Enabled", "PT2Reaper", 0)
