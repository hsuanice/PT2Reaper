-- @description hsuanice_Pro Tools Pencil Tool: Triangle
...
--   **Pencil Tool: Triangle**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: Triangle
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: Triangle", "PT2Reaper", 0)
