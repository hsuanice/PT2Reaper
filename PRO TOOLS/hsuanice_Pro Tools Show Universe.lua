-- @description hsuanice_Pro Tools Show Universe
...
--
--   ## Details
--   - Pro Tools equivalent : Show Universe
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + 7
--   - Tags                 : Editing, Show/Hide, View menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Universe", "PT2Reaper", 0)
