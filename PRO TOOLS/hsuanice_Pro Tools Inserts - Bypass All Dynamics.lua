-- @description hsuanice_Pro Tools Inserts: Bypass All Dynamics
...
--   **Inserts: Bypass All Dynamics**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Inserts: Bypass All Dynamics
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + C
...
reaper.ShowMessageBox("Not yet implemented: Inserts: Bypass All Dynamics", "PT2Reaper", 0)
