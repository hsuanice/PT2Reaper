-- @description hsuanice_Pro Tools Machine Track Arm Window
...
--   **Machine Track Arm Window**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Machine Track Arm Window
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
--   - Tags                 : Recording, Transport, Window
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Machine Track Arm Window", "PT2Reaper", 0)
