-- @description hsuanice_Pro Tools Audio MIDI Setup
...
--
--   ## Details
--   - Pro Tools equivalent : Audio MIDI Setup
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Setup menu
--
...
reaper.ShowMessageBox("Not yet implemented: Audio MIDI Setup", "PT2Reaper", 0)
