-- @description hsuanice_Pro Tools Gain Reduction Meter Type: Expand Gate
...
--   **Gain Reduction Meter Type: Expand Gate**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Gain Reduction Meter Type: Expand Gate
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Gain Reduction Meter Type: Expand Gate", "PT2Reaper", 0)
