-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Key Signature Staff
...
--   **Edit Window: Show Ruler: Key Signature Staff**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Key Signature Staff
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Key Signature Staff", "PT2Reaper", 0)
