-- @description hsuanice_Pro Tools Automation: Preview
...
--
--   ## Details
--   - Pro Tools equivalent : Automation: Preview
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Automation: Preview", "PT2Reaper", 0)
