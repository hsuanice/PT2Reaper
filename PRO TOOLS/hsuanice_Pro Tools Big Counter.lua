-- @description hsuanice_Pro Tools Big Counter
...
--
--   ## Details
--   - Pro Tools equivalent : Big Counter
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Numpad 3
...
reaper.ShowMessageBox("Not yet implemented: Big Counter", "PT2Reaper", 0)
