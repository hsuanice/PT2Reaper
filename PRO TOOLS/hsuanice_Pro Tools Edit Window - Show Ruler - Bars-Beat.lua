-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Bars|Beat
...
--   **Edit Window: Show Ruler: Bars|Beat**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Bars|Beat
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Bars|Beat", "PT2Reaper", 0)
