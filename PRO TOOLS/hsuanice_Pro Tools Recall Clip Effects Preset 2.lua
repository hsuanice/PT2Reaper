-- @description hsuanice_Pro Tools Recall Clip Effects Preset 2
...
--   **Recall Clip Effects Preset 2**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Clip Effects Preset 2
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Recall Clip Effects Preset 2", "PT2Reaper", 0)
