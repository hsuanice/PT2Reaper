-- @description hsuanice_Pro Tools Clip: Transparency
...
--
--   ## Details
--   - Pro Tools equivalent : Clip: Transparency
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clip: Transparency", "PT2Reaper", 0)
