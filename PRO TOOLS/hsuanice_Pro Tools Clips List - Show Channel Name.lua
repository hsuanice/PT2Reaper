-- @description hsuanice_Pro Tools Clips List: Show Channel Name
...
--   **Clips List: Show Channel Name**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Channel Name
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Channel Name", "PT2Reaper", 0)
