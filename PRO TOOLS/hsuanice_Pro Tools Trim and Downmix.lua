-- @description hsuanice_Pro Tools Trim and Downmix
...
--
--   ## Details
--   - Pro Tools equivalent : Trim and Downmix
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Trim and Downmix", "PT2Reaper", 0)
