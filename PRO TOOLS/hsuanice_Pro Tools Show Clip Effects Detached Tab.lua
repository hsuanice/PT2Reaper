-- @description hsuanice_Pro Tools Show Clip Effects Detached Tab
...
--   **Show Clip Effects Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Effects Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Effects Detached Tab", "PT2Reaper", 0)
