-- @description hsuanice_Pro Tools Expanded Sends: None
...
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: None
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: None", "PT2Reaper", 0)
