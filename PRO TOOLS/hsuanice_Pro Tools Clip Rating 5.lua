-- @description hsuanice_Pro Tools Clip Rating 5
...
--
--   ## Details
--   - Pro Tools equivalent : Clip Rating 5
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad 5
...
reaper.ShowMessageBox("Not yet implemented: Clip Rating 5", "PT2Reaper", 0)
