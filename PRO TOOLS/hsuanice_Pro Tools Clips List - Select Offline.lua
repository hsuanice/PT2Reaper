-- @description hsuanice_Pro Tools Clips List: Select Offline
...
--   **Clips List: Select Offline**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Select Offline
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Select Offline", "PT2Reaper", 0)
