-- @description hsuanice_Pro Tools Play From Edit Start
...
--
--   ## Details
--   - Pro Tools equivalent : Play From Edit Start
--   - Module               : Transport
--   - Mac shortcut (PT)    : Control + 7
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play From Edit Start", "PT2Reaper", 0)
