-- @description hsuanice_Pro Tools Bypass VocAlign 6 Pro Clip(s)
...
--   **Bypass VocAlign 6 Pro Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass VocAlign 6 Pro Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass VocAlign 6 Pro Clip(s)", "PT2Reaper", 0)
