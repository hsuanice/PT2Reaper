-- @description hsuanice_Pro Tools Unbypass RePitch Clip(s)
...
--   **Unbypass RePitch Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass RePitch Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass RePitch Clip(s)", "PT2Reaper", 0)
