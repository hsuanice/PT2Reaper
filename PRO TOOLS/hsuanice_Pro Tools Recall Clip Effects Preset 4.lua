-- @description hsuanice_Pro Tools Recall Clip Effects Preset 4
...
--   **Recall Clip Effects Preset 4**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Clip Effects Preset 4
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Recall Clip Effects Preset 4", "PT2Reaper", 0)
