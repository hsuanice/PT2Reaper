-- @description hsuanice_Pro Tools Thin All Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Thin All Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Thin All Automation", "PT2Reaper", 0)
