-- @description hsuanice_Pro Tools Tab Respects Breakpoints in Automation Lanes
...
--
--   ## Details
--   - Pro Tools equivalent : Tab Respects Breakpoints in Automation Lanes
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Tab Respects Breakpoints in Automation Lanes", "PT2Reaper", 0)
