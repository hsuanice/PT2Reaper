-- @description hsuanice_Pro Tools Marker Displays: Marker Ruler Lane Color
...
--   **Marker Displays: Marker Ruler Lane Color**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Marker Displays: Marker Ruler Lane Color
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Marker Displays: Marker Ruler Lane Color", "PT2Reaper", 0)
