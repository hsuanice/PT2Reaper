-- @description hsuanice_Pro Tools Unbypass VocAlign 6 Pro Track(s)
...
--   **Unbypass VocAlign 6 Pro Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass VocAlign 6 Pro Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass VocAlign 6 Pro Track(s)", "PT2Reaper", 0)
