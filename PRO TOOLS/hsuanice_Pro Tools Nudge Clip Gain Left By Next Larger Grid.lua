-- @description hsuanice_Pro Tools Nudge Clip Gain Left By Next Larger Grid
...
--   **Nudge Clip Gain Left By Next Larger Grid**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Clip Gain Left By Next Larger Grid
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + M
...
reaper.ShowMessageBox("Not yet implemented: Nudge Clip Gain Left By Next Larger Grid", "PT2Reaper", 0)
