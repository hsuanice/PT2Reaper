-- @description hsuanice_Pro Tools Save Track Preset
...
--
--   ## Details
--   - Pro Tools equivalent : Save Track Preset
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Option + Shift + P
...
reaper.ShowMessageBox("Not yet implemented: Save Track Preset", "PT2Reaper", 0)
