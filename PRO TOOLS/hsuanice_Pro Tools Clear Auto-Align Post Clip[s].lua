-- @description hsuanice_Pro Tools Clear Auto-Align Post Clip(s)
...
--   **Clear Auto-Align Post Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Auto-Align Post Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Auto-Align Post Clip(s)", "PT2Reaper", 0)
