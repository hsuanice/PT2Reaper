-- @description hsuanice_Pro Tools UI Customization
...
--
--   ## Details
--   - Pro Tools equivalent : UI Customization
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: UI Customization", "PT2Reaper", 0)
