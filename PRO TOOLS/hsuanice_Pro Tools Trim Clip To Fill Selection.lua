...
--   **Trim Clip To Fill Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Trim Clip To Fill Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Trim Clip To Fill Selection", "PT2Reaper", 0)
