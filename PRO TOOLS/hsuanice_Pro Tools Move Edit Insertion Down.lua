-- @description hsuanice_Pro Tools Move Edit Insertion Down
...
--   **Move Edit Insertion Down**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Insertion Down
--   - Module               : Selection
--   - Mac shortcut (PT)    : Commands Focus + Semicolon
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Insertion Down", "PT2Reaper", 0)
