-- @description hsuanice_Pro Tools Edit Clip(s) with VocAlign 6 Pro
...
--   **Edit Clip(s) with VocAlign 6 Pro**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Clip(s) with VocAlign 6 Pro
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Clip(s) with VocAlign 6 Pro", "PT2Reaper", 0)
