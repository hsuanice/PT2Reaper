-- @description hsuanice_Pro Tools Step Input: 8th Note
...
--
--   ## Details
--   - Pro Tools equivalent : Step Input: 8th Note
--   - Module               : MIDI
...
reaper.ShowMessageBox("Not yet implemented: Step Input: 8th Note", "PT2Reaper", 0)
