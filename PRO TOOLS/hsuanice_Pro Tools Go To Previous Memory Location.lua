-- @description hsuanice_Pro Tools Go To Previous Memory Location
...
--   **Go To Previous Memory Location**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Go To Previous Memory Location
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation
--
...
reaper.ShowMessageBox("Not yet implemented: Go To Previous Memory Location", "PT2Reaper", 0)
