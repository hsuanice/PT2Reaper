-- @description hsuanice_Pro Tools Clips List: Show Guitar Settings
...
--   **Clips List: Show Guitar Settings**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Guitar Settings
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Guitar Settings", "PT2Reaper", 0)
