-- @description hsuanice_Pro Tools Unbypass Melodyne Track(s)
...
--   **Unbypass Melodyne Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass Melodyne Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass Melodyne Track(s)", "PT2Reaper", 0)
