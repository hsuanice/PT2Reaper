...
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Selection To Previous Clip (Extend Selection)
--   - Module               : Selection
--   - Mac shortcut (PT)    : Option + Control + Shift + Tab
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Selection To Previous Clip (Extend Selection)", "PT2Reaper", 0)
