-- @description hsuanice_Pro Tools Move Edit Selection To Previous Clip [Extend Selection]
-- @version 0.2.0 [260509.1036]
-- @author hsuanice
-- @link https://forum.cockos.com/showthread.php?p=2910884#post2910884
-- @about
--   Replicates Pro Tools:
--   **Move Edit Selection To Previous Clip [Extend Selection]**
--   (Cmd+Ctrl+Shift+L / Opt+Ctrl+Shift+Tab)
--
--   ## Behaviour
...
--                          Insertion To Previous Edit [Extend Selection]
--                          v0.2.0.
...
if not Tran then
  r.ShowMessageBox("Could not load Library/hsuanice_PT_Transient.lua",
    "Move Edit Selection To Previous Clip [Extend Selection]", 0)
  return
end
