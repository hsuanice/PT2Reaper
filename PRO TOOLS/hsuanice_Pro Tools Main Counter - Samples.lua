-- @description hsuanice_Pro Tools Main Counter: Samples
...
--   **Main Counter: Samples**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Main Counter: Samples
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Main Counter: Samples", "PT2Reaper", 0)
