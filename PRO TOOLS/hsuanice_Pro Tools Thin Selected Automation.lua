-- @description hsuanice_Pro Tools Thin Selected Automation
...
--   **Thin Selected Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Thin Selected Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Option + T
...
reaper.ShowMessageBox("Not yet implemented: Thin Selected Automation", "PT2Reaper", 0)
