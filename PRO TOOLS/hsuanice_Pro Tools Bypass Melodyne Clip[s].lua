-- @description hsuanice_Pro Tools Bypass Melodyne Clip(s)
...
--   **Bypass Melodyne Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass Melodyne Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass Melodyne Clip(s)", "PT2Reaper", 0)
