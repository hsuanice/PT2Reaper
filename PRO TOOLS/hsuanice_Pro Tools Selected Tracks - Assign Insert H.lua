-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert H
...
--   **Selected Tracks: Assign Insert H**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert H
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert H", "PT2Reaper", 0)
