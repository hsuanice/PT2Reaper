-- @description hsuanice_Pro Tools Nudge Clip Gain Up
...
--
--   ## Details
--   - Pro Tools equivalent : Nudge Clip Gain Up
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + Up Arrow
...
reaper.ShowMessageBox("Not yet implemented: Nudge Clip Gain Up", "PT2Reaper", 0)
