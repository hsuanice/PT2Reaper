-- @description hsuanice_Pro Tools Next Track View (All Tracks)
...
--   **Next Track View (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Next Track View (All Tracks)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + Right Arrow
...
reaper.ShowMessageBox("Not yet implemented: Next Track View (All Tracks)", "PT2Reaper", 0)
