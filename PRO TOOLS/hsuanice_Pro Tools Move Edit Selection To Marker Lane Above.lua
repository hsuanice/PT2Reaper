-- @description hsuanice_Pro Tools Move Edit Selection To Marker Lane Above
...
--   **Move Edit Selection To Marker Lane Above**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Selection To Marker Lane Above
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + P
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Selection To Marker Lane Above", "PT2Reaper", 0)
