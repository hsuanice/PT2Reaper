-- @description hsuanice_Pro Tools Paste Plugin Settings
...
--
--   ## Details
--   - Pro Tools equivalent : Paste Plugin Settings
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + V
...
reaper.ShowMessageBox("Not yet implemented: Paste Plugin Settings", "PT2Reaper", 0)
