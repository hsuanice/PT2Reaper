-- @description hsuanice_Pro Tools Transpose Down (In Key)
...
--
--   ## Details
--   - Pro Tools equivalent : Transpose Down (In Key)
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Transpose Down (In Key)", "PT2Reaper", 0)
