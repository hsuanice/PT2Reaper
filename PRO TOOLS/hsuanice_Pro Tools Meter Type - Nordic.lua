-- @description hsuanice_Pro Tools Meter Type: Nordic
...
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Nordic
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Nordic", "PT2Reaper", 0)
