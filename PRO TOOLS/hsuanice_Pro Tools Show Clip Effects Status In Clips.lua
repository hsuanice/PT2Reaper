-- @description hsuanice_Pro Tools Show Clip Effects Status In Clips
...
--   **Show Clip Effects Status In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Effects Status In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Effects Status In Clips", "PT2Reaper", 0)
