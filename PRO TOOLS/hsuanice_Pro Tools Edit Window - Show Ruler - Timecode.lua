-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Timecode
...
--   **Edit Window: Show Ruler: Timecode**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Timecode
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Timecode", "PT2Reaper", 0)
