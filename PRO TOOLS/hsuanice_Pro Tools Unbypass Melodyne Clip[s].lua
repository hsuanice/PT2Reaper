-- @description hsuanice_Pro Tools Unbypass Melodyne Clip(s)
...
--   **Unbypass Melodyne Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass Melodyne Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass Melodyne Clip(s)", "PT2Reaper", 0)
