-- @description hsuanice_Pro Tools Next Mode
...
--
--   ## Details
--   - Pro Tools equivalent : Next Mode
--   - Module               : Editing
--   - Mac shortcut (PT)    : Backquote
...
reaper.ShowMessageBox("Not yet implemented: Next Mode", "PT2Reaper", 0)
