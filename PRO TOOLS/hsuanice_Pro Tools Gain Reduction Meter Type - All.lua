-- @description hsuanice_Pro Tools Gain Reduction Meter Type: All
...
--   **Gain Reduction Meter Type: All**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Gain Reduction Meter Type: All
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Gain Reduction Meter Type: All", "PT2Reaper", 0)
