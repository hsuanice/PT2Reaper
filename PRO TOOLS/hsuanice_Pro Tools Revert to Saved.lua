-- @description hsuanice_Pro Tools Revert to Saved
...
--
--   ## Details
--   - Pro Tools equivalent : Revert to Saved
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Revert to Saved", "PT2Reaper", 0)
