-- @description hsuanice_Pro Tools Hide All Automation Lanes
...
--
--   ## Details
--   - Pro Tools equivalent : Hide All Automation Lanes
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Hide All Automation Lanes", "PT2Reaper", 0)
