-- @description hsuanice_Pro Tools DigiOptions Easy Toggle
...
--   **DigiOptions Easy Toggle**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : DigiOptions Easy Toggle
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Miscellaneous
--
...
reaper.ShowMessageBox("Not yet implemented: DigiOptions Easy Toggle", "PT2Reaper", 0)
