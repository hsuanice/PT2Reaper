-- @description hsuanice_Pro Tools Bypass SpectraLayers Clip(s)
...
--   **Bypass SpectraLayers Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass SpectraLayers Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass SpectraLayers Clip(s)", "PT2Reaper", 0)
