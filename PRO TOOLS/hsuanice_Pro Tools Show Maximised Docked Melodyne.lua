-- @description hsuanice_Pro Tools Show Maximised Docked Melodyne
...
--   **Show Maximised Docked Melodyne**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Maximised Docked Melodyne
--   - Module               : View
--   - Mac shortcut (PT)    : Option + Control + 8
--   - Tags                 : Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Maximised Docked Melodyne", "PT2Reaper", 0)
