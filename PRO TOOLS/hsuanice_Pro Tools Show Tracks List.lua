-- @description hsuanice_Pro Tools Show Tracks List
...
--
--   ## Details
--   - Pro Tools equivalent : Show Tracks List
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide, Track/Playlist, View menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Tracks List", "PT2Reaper", 0)
