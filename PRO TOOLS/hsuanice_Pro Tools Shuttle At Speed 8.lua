-- @description hsuanice_Pro Tools Shuttle At Speed 8
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 8
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 8
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 8", "PT2Reaper", 0)
