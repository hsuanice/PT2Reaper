-- @description hsuanice_Pro Tools Shuffle Mode (Dual Mode)
...
--   **Shuffle Mode (Dual Mode)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Shuffle Mode (Dual Mode)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + F1
...
reaper.ShowMessageBox("Not yet implemented: Shuffle Mode (Dual Mode)", "PT2Reaper", 0)
