-- @description hsuanice_Pro Tools Extend Edit Selection Down Including Folder Siblings
...
--   **Extend Edit Selection Down Including Folder Siblings**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Extend Edit Selection Down Including Folder Siblings
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Control + Shift + Semicolon
...
reaper.ShowMessageBox("Not yet implemented: Extend Edit Selection Down Including Folder Siblings", "PT2Reaper", 0)
