-- @description hsuanice_Pro Tools Coalesce VCA Controller Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Coalesce VCA Controller Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation, Track menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Coalesce VCA Controller Automation", "PT2Reaper", 0)
