-- @description hsuanice_Pro Tools MIDI Event List
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Event List
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Option + Equals
...
reaper.ShowMessageBox("Not yet implemented: MIDI Event List", "PT2Reaper", 0)
