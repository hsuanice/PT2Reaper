-- @description hsuanice_Pro Tools Zoom Out MIDI Vertical
...
--   **Zoom Out MIDI Vertical**
--
--   ## Mapping
--   - Pro Tools equivalent : Zoom Out MIDI Vertical
...
--   0.1.0 [260413.1324]
--     - Initial release
--     - Maps Pro Tools "Zoom Out MIDI Vertical" to Reaper command ID 40112
