-- @description hsuanice_Pro Tools Main Counter: Timecode
...
--   **Main Counter: Timecode**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Main Counter: Timecode
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Main Counter: Timecode", "PT2Reaper", 0)
