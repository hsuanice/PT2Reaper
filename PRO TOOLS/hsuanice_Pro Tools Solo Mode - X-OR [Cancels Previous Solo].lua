-- @description hsuanice_Pro Tools Solo Mode: X-OR (Cancels Previous Solo)
...
--   **Solo Mode: X-OR (Cancels Previous Solo)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Solo Mode: X-OR (Cancels Previous Solo)
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Solo Mode: X-OR (Cancels Previous Solo)", "PT2Reaper", 0)
