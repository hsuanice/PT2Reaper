...
--   **Shrink Edit Selection To Previous Edit**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Shrink Edit Selection To Previous Edit
--   - Module               : Selection
...
reaper.ShowMessageBox("Not yet implemented: Shrink Edit Selection To Previous Edit", "PT2Reaper", 0)
