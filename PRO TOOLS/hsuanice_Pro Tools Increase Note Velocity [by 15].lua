-- @description hsuanice_Pro Tools Increase Note Velocity (by 15)
...
--   **Increase Note Velocity (by 15)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Increase Note Velocity (by 15)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + Up Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Increase Note Velocity (by 15)", "PT2Reaper", 0)
