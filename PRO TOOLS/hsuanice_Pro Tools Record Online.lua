-- @description hsuanice_Pro Tools Record Online
...
--
--   ## Details
--   - Pro Tools equivalent : Record Online
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Option + Space
...
reaper.ShowMessageBox("Not yet implemented: Record Online", "PT2Reaper", 0)
