-- @description hsuanice_Pro Tools Clips List: Sort by File Creation Date
...
--   **Clips List: Sort by File Creation Date**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by File Creation Date
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by File Creation Date", "PT2Reaper", 0)
