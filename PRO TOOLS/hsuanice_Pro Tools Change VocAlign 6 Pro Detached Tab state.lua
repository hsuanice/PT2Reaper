-- @description hsuanice_Pro Tools Change VocAlign 6 Pro Detached Tab state
...
--   **Change VocAlign 6 Pro Detached Tab state**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change VocAlign 6 Pro Detached Tab state
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change VocAlign 6 Pro Detached Tab state", "PT2Reaper", 0)
