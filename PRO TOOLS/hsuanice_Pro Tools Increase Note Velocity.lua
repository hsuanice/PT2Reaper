-- @description hsuanice_Pro Tools Increase Note Velocity
...
--
--   ## Details
--   - Pro Tools equivalent : Increase Note Velocity
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Up Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Increase Note Velocity", "PT2Reaper", 0)
