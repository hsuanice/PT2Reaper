-- @description hsuanice_Pro Tools Bring Editors To Front
...
--   **Bring Editors To Front**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bring Editors To Front
--   - Module               : View
--   - Mac shortcut (PT)    : Option + N
...
reaper.ShowMessageBox("Not yet implemented: Bring Editors To Front", "PT2Reaper", 0)
