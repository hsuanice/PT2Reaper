-- @description hsuanice_Pro Tools Enable Video Hardware
...
--   **Enable Video Hardware**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Enable Video Hardware
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Enable Video Hardware", "PT2Reaper", 0)
