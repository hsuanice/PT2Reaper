-- @description hsuanice_Pro Tools Edit Track(s) with RX Spectral Editor
...
--   **Edit Track(s) with RX Spectral Editor**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with RX Spectral Editor
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with RX Spectral Editor", "PT2Reaper", 0)
