-- @description hsuanice_Pro Tools Disable Video Hardware
...
--   **Disable Video Hardware**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Disable Video Hardware
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu, Video
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Disable Video Hardware", "PT2Reaper", 0)
