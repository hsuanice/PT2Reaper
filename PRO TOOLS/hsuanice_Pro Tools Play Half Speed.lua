-- @description hsuanice_Pro Tools Play Half Speed
...
--
--   ## Details
--   - Pro Tools equivalent : Play Half Speed
--   - Module               : Transport
--   - Mac shortcut (PT)    : Shift + Space
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play Half Speed", "PT2Reaper", 0)
