-- @description hsuanice_Pro Tools Clips List: Show Color
...
--   **Clips List: Show Color**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Color
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Color", "PT2Reaper", 0)
