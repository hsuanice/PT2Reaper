-- @description hsuanice_Pro Tools Meter Type: ProTools Peak
...
--   **Meter Type: ProTools Peak**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: ProTools Peak
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: ProTools Peak", "PT2Reaper", 0)
