-- @description hsuanice_Pro Tools Clips List: Sort Ascending
...
--   **Clips List: Sort Ascending**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort Ascending
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort Ascending", "PT2Reaper", 0)
