-- @description hsuanice_Pro Tools Coalesce Volume to Clip Gain
...
--   **Coalesce Volume to Clip Gain**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Coalesce Volume to Clip Gain
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Coalesce Volume to Clip Gain", "PT2Reaper", 0)
