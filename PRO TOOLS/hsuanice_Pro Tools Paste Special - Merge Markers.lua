-- @description hsuanice_Pro Tools Paste Special: Merge Markers
...
--   **Paste Special: Merge Markers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Paste Special: Merge Markers
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + V
...
reaper.ShowMessageBox("Not yet implemented: Paste Special: Merge Markers", "PT2Reaper", 0)
