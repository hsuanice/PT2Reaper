-- @description hsuanice_Pro Tools Mute Sends F-J
...
--
--   ## Details
--   - Pro Tools equivalent : Mute Sends F-J
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + 5
...
reaper.ShowMessageBox("Not yet implemented: Mute Sends F-J", "PT2Reaper", 0)
