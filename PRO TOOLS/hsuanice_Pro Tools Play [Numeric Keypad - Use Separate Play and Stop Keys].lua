-- @description hsuanice_Pro Tools Play (Numeric Keypad: Use Separate Play and Stop Keys)
...
--   **Play (Numeric Keypad: Use Separate Play and Stop Keys)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Play (Numeric Keypad: Use Separate Play and Stop Keys)
--   - Module               : Transport
--   - Mac shortcut (PT)    : Numpad Enter
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play (Numeric Keypad: Use Separate Play and Stop Keys)", "PT2Reaper", 0)
