-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Tempo Editor
...
--   **Edit Window: Show Ruler: Tempo Editor**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Tempo Editor
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Tempo Editor", "PT2Reaper", 0)
