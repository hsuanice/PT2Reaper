-- @description hsuanice_Pro Tools Meter Type: Dorrough Extended
...
--   **Meter Type: Dorrough Extended**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Dorrough Extended
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Dorrough Extended", "PT2Reaper", 0)
