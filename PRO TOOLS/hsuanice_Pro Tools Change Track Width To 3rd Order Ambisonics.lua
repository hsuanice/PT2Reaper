-- @description hsuanice_Pro Tools Change Track Width To 3rd Order Ambisonics
...
--   **Change Track Width To 3rd Order Ambisonics**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To 3rd Order Ambisonics
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To 3rd Order Ambisonics", "PT2Reaper", 0)
