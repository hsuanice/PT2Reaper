-- @description hsuanice_Pro Tools Show RX Spectral Editor Detached Tab
...
--   **Show RX Spectral Editor Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show RX Spectral Editor Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show RX Spectral Editor Detached Tab", "PT2Reaper", 0)
