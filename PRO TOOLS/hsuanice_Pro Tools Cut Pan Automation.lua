-- @description hsuanice_Pro Tools Cut Pan Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Cut Pan Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Cut Pan Automation", "PT2Reaper", 0)
