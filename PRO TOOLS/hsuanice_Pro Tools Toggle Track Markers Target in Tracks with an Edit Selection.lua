-- @description hsuanice_Pro Tools Toggle Track Markers Target in Tracks with an Edit Selection
...
--   **Toggle Track Markers Target in Tracks with an Edit Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Toggle Track Markers Target in Tracks with an Edit Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + X
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Toggle Track Markers Target in Tracks with an Edit Selection", "PT2Reaper", 0)
