-- @description hsuanice_Pro Tools Clips List: Sort Descending
...
--   **Clips List: Sort Descending**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort Descending
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort Descending", "PT2Reaper", 0)
