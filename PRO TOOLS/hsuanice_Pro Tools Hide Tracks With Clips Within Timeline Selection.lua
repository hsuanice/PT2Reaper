-- @description hsuanice_Pro Tools Hide Tracks With Clips Within Timeline Selection
...
--   **Hide Tracks With Clips Within Timeline Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Hide Tracks With Clips Within Timeline Selection
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Hide Tracks With Clips Within Timeline Selection", "PT2Reaper", 0)
