-- @description hsuanice_Pro Tools Solo Mode: SIP (Solo In Place)
...
--   **Solo Mode: SIP (Solo In Place)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Solo Mode: SIP (Solo In Place)
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Solo Mode: SIP (Solo In Place)", "PT2Reaper", 0)
