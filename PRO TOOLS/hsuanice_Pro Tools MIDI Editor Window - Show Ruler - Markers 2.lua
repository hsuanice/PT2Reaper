-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Markers 2
...
--   **MIDI Editor Window: Show Ruler: Markers 2**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Markers 2
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Markers 2", "PT2Reaper", 0)
