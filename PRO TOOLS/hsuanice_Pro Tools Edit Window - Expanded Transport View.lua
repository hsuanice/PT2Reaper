-- @description hsuanice_Pro Tools Edit Window: Expanded Transport View
...
--   **Edit Window: Expanded Transport View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Expanded Transport View
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide, Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Expanded Transport View", "PT2Reaper", 0)
