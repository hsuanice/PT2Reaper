-- @description hsuanice_Pro Tools Commit
...
--
--   ## Details
--   - Pro Tools equivalent : Commit
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Option + Shift + C
...
reaper.ShowMessageBox("Not yet implemented: Commit", "PT2Reaper", 0)
