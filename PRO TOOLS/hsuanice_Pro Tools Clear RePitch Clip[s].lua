-- @description hsuanice_Pro Tools Clear RePitch Clip(s)
...
--   **Clear RePitch Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear RePitch Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear RePitch Clip(s)", "PT2Reaper", 0)
