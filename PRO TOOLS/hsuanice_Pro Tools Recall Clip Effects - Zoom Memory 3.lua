-- @description hsuanice_Pro Tools Recall Clip Effects / Zoom Memory 3
...
--   **Recall Clip Effects / Zoom Memory 3**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Clip Effects / Zoom Memory 3
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Commands Focus + 3
...
reaper.ShowMessageBox("Not yet implemented: Recall Clip Effects / Zoom Memory 3", "PT2Reaper", 0)
