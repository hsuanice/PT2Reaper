-- @description hsuanice_Pro Tools Separation Grabber Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Separation Grabber Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Separation Grabber Tool", "PT2Reaper", 0)
