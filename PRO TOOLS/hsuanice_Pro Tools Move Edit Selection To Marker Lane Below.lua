-- @description hsuanice_Pro Tools Move Edit Selection To Marker Lane Below
...
--   **Move Edit Selection To Marker Lane Below**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Selection To Marker Lane Below
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + Semicolon
--   - Tags                 : Edit menu, Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Selection To Marker Lane Below", "PT2Reaper", 0)
