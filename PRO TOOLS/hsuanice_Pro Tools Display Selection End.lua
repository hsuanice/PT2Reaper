-- @description hsuanice_Pro Tools Display Selection End
...
--
--   ## Details
--   - Pro Tools equivalent : Display Selection End
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Display Selection End", "PT2Reaper", 0)
