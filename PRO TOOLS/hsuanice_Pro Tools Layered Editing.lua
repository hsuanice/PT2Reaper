-- @description hsuanice_Pro Tools Layered Editing
...
--
--   ## Details
--   - Pro Tools equivalent : Layered Editing
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Layered Editing", "PT2Reaper", 0)
