-- @description hsuanice_Pro Tools Mute Sends A-E
...
--
--   ## Details
--   - Pro Tools equivalent : Mute Sends A-E
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + 4
...
reaper.ShowMessageBox("Not yet implemented: Mute Sends A-E", "PT2Reaper", 0)
