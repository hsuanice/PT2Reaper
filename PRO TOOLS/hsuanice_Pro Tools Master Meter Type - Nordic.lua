-- @description hsuanice_Pro Tools Master Meter Type: Nordic
...
--   **Master Meter Type: Nordic**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: Nordic
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: Nordic", "PT2Reaper", 0)
