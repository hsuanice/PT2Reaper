-- @description hsuanice_Pro Tools Copy Clip Effects
...
--
--   ## Details
--   - Pro Tools equivalent : Copy Clip Effects
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + C
...
reaper.ShowMessageBox("Not yet implemented: Copy Clip Effects", "PT2Reaper", 0)
