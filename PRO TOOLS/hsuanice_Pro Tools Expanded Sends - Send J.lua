-- @description hsuanice_Pro Tools Expanded Sends: Send J
...
--   **Expanded Sends: Send J**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send J
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send J", "PT2Reaper", 0)
