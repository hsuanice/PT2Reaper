-- @description hsuanice_Pro Tools Designate as Target Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Designate as Target Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + Right Arrow
--   - Tags                 : Editing, Track menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Designate as Target Playlist", "PT2Reaper", 0)
