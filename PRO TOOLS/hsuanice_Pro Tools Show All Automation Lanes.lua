-- @description hsuanice_Pro Tools Show All Automation Lanes
...
--
--   ## Details
--   - Pro Tools equivalent : Show All Automation Lanes
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show All Automation Lanes", "PT2Reaper", 0)
