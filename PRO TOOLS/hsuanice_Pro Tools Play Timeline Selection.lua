...
--
--   ## Details
--   - Pro Tools equivalent : Play Timeline Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Commands Focus + ]
--   - Tags                 : Edit menu, Selection, Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play Timeline Selection", "PT2Reaper", 0)
