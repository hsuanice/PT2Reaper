-- @description hsuanice_Pro Tools Select Selection Start
...
--
--   ## Details
--   - Pro Tools equivalent : Select Selection Start
--   - Module               : Editing
--   - Mac shortcut (PT)    : Down Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Select Selection Start", "PT2Reaper", 0)
