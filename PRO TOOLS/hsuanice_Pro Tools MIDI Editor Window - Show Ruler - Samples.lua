-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Samples
...
--   **MIDI Editor Window: Show Ruler: Samples**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Samples
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Samples", "PT2Reaper", 0)
