-- @description hsuanice_Pro Tools Play Through Edit End
...
--   **Play Through Edit End**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Play Through Edit End
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Option + Right Arrow
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play Through Edit End", "PT2Reaper", 0)
