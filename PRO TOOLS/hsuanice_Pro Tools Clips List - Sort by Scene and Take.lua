-- @description hsuanice_Pro Tools Clips List: Sort by Scene and Take
...
--   **Clips List: Sort by Scene and Take**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Scene and Take
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Scene and Take", "PT2Reaper", 0)
