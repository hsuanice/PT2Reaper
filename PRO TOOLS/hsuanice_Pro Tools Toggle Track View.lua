-- @description hsuanice_Pro Tools Toggle Track View
...
--
--   ## Details
--   - Pro Tools equivalent : Toggle Track View
--   - Module               : Automation
--   - Mac shortcut (PT)    : Commands Focus + Minus
...
reaper.ShowMessageBox("Not yet implemented: Toggle Track View", "PT2Reaper", 0)
