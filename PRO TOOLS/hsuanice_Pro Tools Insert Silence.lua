-- @description hsuanice_Pro Tools Insert Silence
...
--
--   ## Details
--   - Pro Tools equivalent : Insert Silence
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Shift + E
...
reaper.ShowMessageBox("Not yet implemented: Insert Silence", "PT2Reaper", 0)
