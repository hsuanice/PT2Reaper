-- @description hsuanice_Pro Tools Close All Workspaces
...
--
--   ## Details
--   - Pro Tools equivalent : Close All Workspaces
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Close All Workspaces", "PT2Reaper", 0)
