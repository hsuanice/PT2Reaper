-- @description hsuanice_Pro Tools Change Edit to Match Timeline
...
--
--   ## Details
--   - Pro Tools equivalent : Change Edit to Match Timeline
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Shift + 6
...
reaper.ShowMessageBox("Not yet implemented: Change Edit to Match Timeline", "PT2Reaper", 0)
