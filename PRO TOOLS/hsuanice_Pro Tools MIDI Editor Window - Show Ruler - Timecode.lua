-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Timecode
...
--   **MIDI Editor Window: Show Ruler: Timecode**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Timecode
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Timecode", "PT2Reaper", 0)
