-- @description hsuanice_Pro Tools Suspend Groups
...
--
--   ## Details
--   - Pro Tools equivalent : Suspend Groups
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Shift + G
...
reaper.ShowMessageBox("Not yet implemented: Suspend Groups", "PT2Reaper", 0)
