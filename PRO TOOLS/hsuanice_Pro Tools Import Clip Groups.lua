-- @description hsuanice_Pro Tools Import Clip Groups
...
--
--   ## Details
--   - Pro Tools equivalent : Import Clip Groups
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Import Clip Groups", "PT2Reaper", 0)
