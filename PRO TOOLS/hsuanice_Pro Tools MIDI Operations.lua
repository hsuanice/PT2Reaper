-- @description hsuanice_Pro Tools MIDI Operations
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations
--   - Module               : Misc
--   - Mac shortcut (PT)    : Option + Numpad 3
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations", "PT2Reaper", 0)
