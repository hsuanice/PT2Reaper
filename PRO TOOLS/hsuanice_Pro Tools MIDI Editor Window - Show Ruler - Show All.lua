-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Show All
...
--   **MIDI Editor Window: Show Ruler: Show All**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Show All
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Show All", "PT2Reaper", 0)
