-- @description hsuanice_Pro Tools Set Zoom Memory 1
...
--
--   ## Details
--   - Pro Tools equivalent : Set Zoom Memory 1
--   - Module               : Zoom
--   - Mac shortcut (PT)    : —
--   - Tags                 : Zoom
--
...
reaper.ShowMessageBox("Not yet implemented: Set Zoom Memory 1", "PT2Reaper", 0)
