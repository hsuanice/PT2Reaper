-- @description hsuanice_Pro Tools Clear RX Spectral Editor Track(s)
...
--   **Clear RX Spectral Editor Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear RX Spectral Editor Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear RX Spectral Editor Track(s)", "PT2Reaper", 0)
