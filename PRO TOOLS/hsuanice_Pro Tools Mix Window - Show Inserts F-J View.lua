-- @description hsuanice_Pro Tools Mix Window: Show Inserts F-J View
...
--   **Mix Window: Show Inserts F-J View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Inserts F-J View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Inserts F-J View", "PT2Reaper", 0)
