-- @description hsuanice_Pro Tools Edit Clip(s) with SpectraLayers
...
--   **Edit Clip(s) with SpectraLayers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Clip(s) with SpectraLayers
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Clip(s) with SpectraLayers", "PT2Reaper", 0)
