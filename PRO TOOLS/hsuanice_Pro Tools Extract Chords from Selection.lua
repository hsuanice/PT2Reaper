-- @description hsuanice_Pro Tools Extract Chords from Selection
...
--
--   ## Details
--   - Pro Tools equivalent : Extract Chords from Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Extract Chords from Selection", "PT2Reaper", 0)
