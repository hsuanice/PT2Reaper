-- @description hsuanice_Pro Tools Show Docked Auto-Align Post
...
--   **Show Docked Auto-Align Post**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Docked Auto-Align Post
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked Auto-Align Post", "PT2Reaper", 0)
