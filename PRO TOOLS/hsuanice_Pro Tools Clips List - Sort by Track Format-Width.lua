-- @description hsuanice_Pro Tools Clips List: Sort by Track Format/Width
...
--   **Clips List: Sort by Track Format/Width**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Track Format/Width
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Track Format/Width", "PT2Reaper", 0)
