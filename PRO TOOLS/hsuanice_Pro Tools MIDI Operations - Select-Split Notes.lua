-- @description hsuanice_Pro Tools MIDI Operations: Select/Split Notes
...
--   **MIDI Operations: Select/Split Notes**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Select/Split Notes
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Y
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Select/Split Notes", "PT2Reaper", 0)
