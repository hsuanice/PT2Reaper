-- @description hsuanice_Pro Tools Record Arm Tracks with an Edit Selection
...
--   **Record Arm Tracks with an Edit Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Record Arm Tracks with an Edit Selection
--   - Module               : Transport
--   - Mac shortcut (PT)    : Shift + R
--   - Tags                 : Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Record Arm Tracks with an Edit Selection", "PT2Reaper", 0)
