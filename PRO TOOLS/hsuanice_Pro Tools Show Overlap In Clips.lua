-- @description hsuanice_Pro Tools Show Overlap In Clips
...
--   **Show Overlap In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Overlap In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Overlap In Clips", "PT2Reaper", 0)
