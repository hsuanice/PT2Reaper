-- @description hsuanice_Pro Tools Track Bounce
...
--
--   ## Details
--   - Pro Tools equivalent : Track Bounce
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + Shift + B
--   - Tags                 : File, Track menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Track Bounce", "PT2Reaper", 0)
