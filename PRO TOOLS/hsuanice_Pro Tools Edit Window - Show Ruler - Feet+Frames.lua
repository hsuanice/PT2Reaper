-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Feet+Frames
...
--   **Edit Window: Show Ruler: Feet+Frames**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Feet+Frames
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Feet+Frames", "PT2Reaper", 0)
