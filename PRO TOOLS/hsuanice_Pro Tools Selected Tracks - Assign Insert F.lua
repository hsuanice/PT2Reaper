-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert F
...
--   **Selected Tracks: Assign Insert F**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert F
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert F", "PT2Reaper", 0)
