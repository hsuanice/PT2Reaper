-- @description hsuanice_Pro Tools Clips List: Sort by Start in Parent
...
--   **Clips List: Sort by Start in Parent**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Start in Parent
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Start in Parent", "PT2Reaper", 0)
