-- @description hsuanice_Pro Tools Show Keyboard Shortcuts Guide
...
--
--   ## Details
--   - Pro Tools equivalent : Show Keyboard Shortcuts Guide
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Help menu
--
...
reaper.ShowMessageBox("Not yet implemented: Show Keyboard Shortcuts Guide", "PT2Reaper", 0)
