-- @description hsuanice_Pro Tools Edit Window: Show I/O View
...
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show I/O View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show I/O View", "PT2Reaper", 0)
