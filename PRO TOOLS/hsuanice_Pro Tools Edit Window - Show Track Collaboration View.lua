-- @description hsuanice_Pro Tools Edit Window: Show Track Collaboration View
...
--   **Edit Window: Show Track Collaboration View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Track Collaboration View
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Track Collaboration View", "PT2Reaper", 0)
