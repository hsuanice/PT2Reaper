-- @description hsuanice_Pro Tools Show User Time Stamp In Clips
...
--   **Show User Time Stamp In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show User Time Stamp In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show User Time Stamp In Clips", "PT2Reaper", 0)
