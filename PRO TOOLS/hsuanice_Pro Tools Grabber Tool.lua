-- @description hsuanice_Pro Tools Grabber Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Grabber Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + 4
...
reaper.ShowMessageBox("Not yet implemented: Grabber Tool", "PT2Reaper", 0)
