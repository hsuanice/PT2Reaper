-- @description hsuanice_Pro Tools Edit Clip(s) with RePitch
...
--   **Edit Clip(s) with RePitch**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Clip(s) with RePitch
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Clip(s) with RePitch", "PT2Reaper", 0)
