-- @description hsuanice_Pro Tools Display Selection Start
...
--
--   ## Details
--   - Pro Tools equivalent : Display Selection Start
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Display Selection Start", "PT2Reaper", 0)
