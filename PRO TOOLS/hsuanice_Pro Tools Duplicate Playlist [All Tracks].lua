-- @description hsuanice_Pro Tools Duplicate Playlist (All Tracks)
...
--   **Duplicate Playlist (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Duplicate Playlist (All Tracks)
--   - Module               : Tracks
...
reaper.ShowMessageBox("Not yet implemented: Duplicate Playlist (All Tracks)", "PT2Reaper", 0)
