-- @description hsuanice_Pro Tools Previous Matching Field Recorder Channel
...
--   **Previous Matching Field Recorder Channel**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Previous Matching Field Recorder Channel
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Previous Matching Field Recorder Channel", "PT2Reaper", 0)
