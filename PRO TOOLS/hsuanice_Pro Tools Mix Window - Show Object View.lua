-- @description hsuanice_Pro Tools Mix Window: Show Object View
...
--   **Mix Window: Show Object View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Object View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Object View", "PT2Reaper", 0)
