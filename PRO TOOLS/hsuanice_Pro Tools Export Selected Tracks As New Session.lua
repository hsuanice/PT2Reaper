-- @description hsuanice_Pro Tools Export Selected Tracks As New Session
...
--
--   ## Details
--   - Pro Tools equivalent : Export Selected Tracks As New Session
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Export Selected Tracks As New Session", "PT2Reaper", 0)
