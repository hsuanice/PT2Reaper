-- @description hsuanice_Pro Tools Clear Melodyne Clip(s)
...
--   **Clear Melodyne Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Melodyne Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Melodyne Clip(s)", "PT2Reaper", 0)
