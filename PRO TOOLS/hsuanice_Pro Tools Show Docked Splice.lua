-- @description hsuanice_Pro Tools Show Docked Splice
...
--
--   ## Details
--   - Pro Tools equivalent : Show Docked Splice
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked Splice", "PT2Reaper", 0)
