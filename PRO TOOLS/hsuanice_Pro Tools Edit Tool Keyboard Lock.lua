-- @description hsuanice_Pro Tools Edit Tool Keyboard Lock
...
--   **Edit Tool Keyboard Lock**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Tool Keyboard Lock
--   - Module               : Editing
--   - Mac shortcut (PT)    : Control + Shift + T
...
reaper.ShowMessageBox("Not yet implemented: Edit Tool Keyboard Lock", "PT2Reaper", 0)
