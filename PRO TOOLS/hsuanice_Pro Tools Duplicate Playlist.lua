-- @description hsuanice_Pro Tools Duplicate Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Duplicate Playlist
--   - Module               : Tracks
...
reaper.ShowMessageBox("Not yet implemented: Duplicate Playlist", "PT2Reaper", 0)
