-- @description hsuanice_Pro Tools Clips List: Show Audio
...
--   **Clips List: Show Audio**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Audio
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + 1
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Audio", "PT2Reaper", 0)
