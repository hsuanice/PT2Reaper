-- @description hsuanice_Pro Tools Convert Volume to Clip Gain
...
--   **Convert Volume to Clip Gain**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Convert Volume to Clip Gain
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Convert Volume to Clip Gain", "PT2Reaper", 0)
