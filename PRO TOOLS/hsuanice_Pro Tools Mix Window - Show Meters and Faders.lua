-- @description hsuanice_Pro Tools Mix Window: Show Meters and Faders
...
--   **Mix Window: Show Meters and Faders**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Meters and Faders
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Meters and Faders", "PT2Reaper", 0)
