-- @description hsuanice_Pro Tools Revision History
...
--
--   ## Details
--   - Pro Tools equivalent : Revision History
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Control + O
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Revision History", "PT2Reaper", 0)
