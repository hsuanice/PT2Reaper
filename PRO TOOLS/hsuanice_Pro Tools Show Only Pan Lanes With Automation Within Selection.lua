-- @description hsuanice_Pro Tools Show Only Pan Lanes With Automation Within Selection
...
--   **Show Only Pan Lanes With Automation Within Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Only Pan Lanes With Automation Within Selection
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Only Pan Lanes With Automation Within Selection", "PT2Reaper", 0)
