-- @description hsuanice_Pro Tools Zoom To Fit Selection
...
--
--   ## Details
--   - Pro Tools equivalent : Zoom To Fit Selection
--   - Module               : Zoom
--   - Mac shortcut (PT)    : Option + F
--   - Tags                 : Zoom
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Zoom To Fit Selection", "PT2Reaper", 0)
