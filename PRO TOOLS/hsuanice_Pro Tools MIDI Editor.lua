-- @description hsuanice_Pro Tools MIDI Editor
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Control + Equals
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor", "PT2Reaper", 0)
