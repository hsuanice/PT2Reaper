-- @description hsuanice_Pro Tools Edit Track(s) with RePitch
...
--   **Edit Track(s) with RePitch**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with RePitch
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with RePitch", "PT2Reaper", 0)
