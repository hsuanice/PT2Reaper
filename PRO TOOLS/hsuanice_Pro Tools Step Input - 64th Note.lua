-- @description hsuanice_Pro Tools Step Input: 64th Note
...
--   **Step Input: 64th Note**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: 64th Note
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 8
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: 64th Note", "PT2Reaper", 0)
