-- @description hsuanice_Pro Tools Toggle Transport Master
...
--
--   ## Details
--   - Pro Tools equivalent : Toggle Transport Master
--   - Module               : Transport
...
reaper.ShowMessageBox("Not yet implemented: Toggle Transport Master", "PT2Reaper", 0)
