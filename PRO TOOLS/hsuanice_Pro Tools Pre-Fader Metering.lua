-- @description hsuanice_Pro Tools Pre-Fader Metering
...
--
--   ## Details
--   - Pro Tools equivalent : Pre-Fader Metering
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Pre-Fader Metering", "PT2Reaper", 0)
