-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Min:Secs
...
--   **MIDI Editor Window: Show Ruler: Min:Secs**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Min:Secs
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Min:Secs", "PT2Reaper", 0)
