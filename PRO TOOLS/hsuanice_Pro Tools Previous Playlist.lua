-- @description hsuanice_Pro Tools Previous Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Previous Playlist
--   - Module               : Tracks
...
reaper.ShowMessageBox("Not yet implemented: Previous Playlist", "PT2Reaper", 0)
