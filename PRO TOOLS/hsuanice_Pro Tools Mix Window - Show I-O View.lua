-- @description hsuanice_Pro Tools Mix Window: Show I/O View
...
--   **Mix Window: Show I/O View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show I/O View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show I/O View", "PT2Reaper", 0)
