-- @description hsuanice_Pro Tools Tutorial Library
...
--
--   ## Details
--   - Pro Tools equivalent : Tutorial Library
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Help menu, Window
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Tutorial Library", "PT2Reaper", 0)
