-- @description hsuanice_Pro Tools Show Track Numbers
...
--
--   ## Details
--   - Pro Tools equivalent : Show Track Numbers
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Track Numbers", "PT2Reaper", 0)
