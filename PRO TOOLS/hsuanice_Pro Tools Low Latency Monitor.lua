-- @description hsuanice_Pro Tools Low Latency Monitor
...
--
--   ## Details
--   - Pro Tools equivalent : Low Latency Monitor
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Low Latency Monitor", "PT2Reaper", 0)
