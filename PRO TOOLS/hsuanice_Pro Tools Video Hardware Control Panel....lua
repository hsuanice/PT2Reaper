-- @description hsuanice_Pro Tools Video Hardware Control Panel...
...
--   **Video Hardware Control Panel...**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Video Hardware Control Panel...
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Setup menu, Video
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Video Hardware Control Panel...", "PT2Reaper", 0)
