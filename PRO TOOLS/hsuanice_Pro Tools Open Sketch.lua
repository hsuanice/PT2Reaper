-- @description hsuanice_Pro Tools Open Sketch
...
--
--   ## Details
--   - Pro Tools equivalent : Open Sketch
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + Control + O
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Open Sketch", "PT2Reaper", 0)
