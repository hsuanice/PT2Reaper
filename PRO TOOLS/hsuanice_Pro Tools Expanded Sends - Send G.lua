-- @description hsuanice_Pro Tools Expanded Sends: Send G
...
--   **Expanded Sends: Send G**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send G
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send G", "PT2Reaper", 0)
