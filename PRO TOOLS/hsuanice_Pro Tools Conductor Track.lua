-- @description hsuanice_Pro Tools Conductor Track
...
--
--   ## Details
--   - Pro Tools equivalent : Conductor Track
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : Tempo/Meter
--
...
reaper.ShowMessageBox("Not yet implemented: Conductor Track", "PT2Reaper", 0)
