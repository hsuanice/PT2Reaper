-- @description hsuanice_Pro Tools Marker Displays: Track Lane Color
...
--   **Marker Displays: Track Lane Color**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Marker Displays: Track Lane Color
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Marker Displays: Track Lane Color", "PT2Reaper", 0)
