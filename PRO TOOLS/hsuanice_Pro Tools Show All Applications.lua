-- @description hsuanice_Pro Tools Show All Applications
...
--
--   ## Details
--   - Pro Tools equivalent : Show All Applications
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show All Applications", "PT2Reaper", 0)
