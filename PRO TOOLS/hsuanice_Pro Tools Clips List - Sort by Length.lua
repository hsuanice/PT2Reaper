-- @description hsuanice_Pro Tools Clips List: Sort by Length
...
--   **Clips List: Sort by Length**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Length
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Length", "PT2Reaper", 0)
