-- @description hsuanice_Pro Tools Mix Window: All Views
...
--   **Mix Window: All Views**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: All Views
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: All Views", "PT2Reaper", 0)
