-- @description hsuanice_Pro Tools Record Pause
...
--
--   ## Details
--   - Pro Tools equivalent : Record Pause
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Control + Space
...
reaper.ShowMessageBox("Not yet implemented: Record Pause", "PT2Reaper", 0)
