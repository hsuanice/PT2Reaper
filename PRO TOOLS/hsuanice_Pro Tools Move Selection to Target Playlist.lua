-- @description hsuanice_Pro Tools Move Selection to Target Playlist
...
--
--   ## Details
--   - Pro Tools equivalent : Move Selection to Target Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Shift + T
...
reaper.ShowMessageBox("Not yet implemented: Move Selection to Target Playlist", "PT2Reaper", 0)
