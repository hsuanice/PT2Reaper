-- @description hsuanice_Pro Tools Tempo Operations: Stretch
...
--   **Tempo Operations: Stretch**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations: Stretch
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations: Stretch", "PT2Reaper", 0)
