-- @description hsuanice_Pro Tools Clips List: Export Clip Groups
...
--   **Clips List: Export Clip Groups**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Export Clip Groups
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Export Clip Groups", "PT2Reaper", 0)
