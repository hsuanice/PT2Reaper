-- @description hsuanice_Pro Tools Clips List: Select All
...
--   **Clips List: Select All**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Select All
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + A
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Select All", "PT2Reaper", 0)
