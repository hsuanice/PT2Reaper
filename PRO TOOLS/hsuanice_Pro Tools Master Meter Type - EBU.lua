-- @description hsuanice_Pro Tools Master Meter Type: EBU
...
--   **Master Meter Type: EBU**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: EBU
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: EBU", "PT2Reaper", 0)
