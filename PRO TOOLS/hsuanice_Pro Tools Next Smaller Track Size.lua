-- @description hsuanice_Pro Tools Next Smaller Track Size
...
--   **Next Smaller Track Size**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Next Smaller Track Size
--   - Module               : Navigation
--   - Mac shortcut (PT)    : Control + Down Arrow
...
reaper.ShowMessageBox("Not yet implemented: Next Smaller Track Size", "PT2Reaper", 0)
