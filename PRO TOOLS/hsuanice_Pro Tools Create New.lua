-- @description hsuanice_Pro Tools Create New
...
--
--   ## Details
--   - Pro Tools equivalent : Create New
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + N
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Create New", "PT2Reaper", 0)
