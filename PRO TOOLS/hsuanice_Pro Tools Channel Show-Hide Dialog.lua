-- @description hsuanice_Pro Tools Channel Show/Hide Dialog
...
--   **Channel Show/Hide Dialog**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Channel Show/Hide Dialog
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide, Track menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Channel Show/Hide Dialog", "PT2Reaper", 0)
