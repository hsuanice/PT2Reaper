-- @description hsuanice_Pro Tools Change Track Width To 5.1.2
...
--   **Change Track Width To 5.1.2**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To 5.1.2
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To 5.1.2", "PT2Reaper", 0)
