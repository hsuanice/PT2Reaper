-- @description hsuanice_Pro Tools Edit Window: Minimal Views
...
--   **Edit Window: Minimal Views**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Minimal Views
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Minimal Views", "PT2Reaper", 0)
