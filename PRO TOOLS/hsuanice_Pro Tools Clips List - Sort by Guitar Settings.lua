-- @description hsuanice_Pro Tools Clips List: Sort by Guitar Settings
...
--   **Clips List: Sort by Guitar Settings**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Guitar Settings
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Guitar Settings", "PT2Reaper", 0)
