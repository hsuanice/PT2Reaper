-- @description hsuanice_Pro Tools Show Clip Effects
...
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Effects
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + 6
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Effects", "PT2Reaper", 0)
