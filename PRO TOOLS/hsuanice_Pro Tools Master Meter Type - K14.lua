-- @description hsuanice_Pro Tools Master Meter Type: K14
...
--   **Master Meter Type: K14**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: K14
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: K14", "PT2Reaper", 0)
