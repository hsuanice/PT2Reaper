-- @description hsuanice_Pro Tools Tempo Operations
...
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations
--   - Module               : Misc
--   - Mac shortcut (PT)    : Option + Numpad 2
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations", "PT2Reaper", 0)
