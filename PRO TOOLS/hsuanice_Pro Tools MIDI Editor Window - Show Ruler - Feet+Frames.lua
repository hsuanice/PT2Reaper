-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Feet+Frames
...
--   **MIDI Editor Window: Show Ruler: Feet+Frames**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Feet+Frames
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Feet+Frames", "PT2Reaper", 0)
