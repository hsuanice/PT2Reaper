-- @description hsuanice_Pro Tools Clips List: Rename
...
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Rename
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + R
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Rename", "PT2Reaper", 0)
