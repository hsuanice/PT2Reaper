-- @description hsuanice_Pro Tools Show Channel Name In Clips
...
--   **Show Channel Name In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Channel Name In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Channel Name In Clips", "PT2Reaper", 0)
