-- @description hsuanice_Pro Tools Clips List: Select Unused
...
--   **Clips List: Select Unused**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Select Unused
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + U
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Select Unused", "PT2Reaper", 0)
