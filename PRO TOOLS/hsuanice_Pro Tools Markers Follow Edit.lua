-- @description hsuanice_Pro Tools Markers Follow Edit
...
--
--   ## Details
--   - Pro Tools equivalent : Markers Follow Edit
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Y
...
reaper.ShowMessageBox("Not yet implemented: Markers Follow Edit", "PT2Reaper", 0)
