-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert G
...
--   **Selected Tracks: Assign Insert G**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert G
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert G", "PT2Reaper", 0)
