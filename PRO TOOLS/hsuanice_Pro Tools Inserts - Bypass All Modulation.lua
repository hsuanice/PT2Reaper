-- @description hsuanice_Pro Tools Inserts: Bypass All Modulation
...
--   **Inserts: Bypass All Modulation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Inserts: Bypass All Modulation
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + W
...
reaper.ShowMessageBox("Not yet implemented: Inserts: Bypass All Modulation", "PT2Reaper", 0)
