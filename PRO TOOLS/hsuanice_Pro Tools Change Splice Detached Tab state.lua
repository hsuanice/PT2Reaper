-- @description hsuanice_Pro Tools Change Splice Detached Tab state
...
--   **Change Splice Detached Tab state**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Splice Detached Tab state
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Change Splice Detached Tab state", "PT2Reaper", 0)
