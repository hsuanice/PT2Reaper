-- @description hsuanice_Pro Tools Batch Rename Selected Memory Locations
...
--   **Batch Rename Selected Memory Locations**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Batch Rename Selected Memory Locations
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Batch Rename Selected Memory Locations", "PT2Reaper", 0)
