-- @description hsuanice_Pro Tools Clear VocAlign 6 Pro Clip(s)
...
--   **Clear VocAlign 6 Pro Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear VocAlign 6 Pro Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear VocAlign 6 Pro Clip(s)", "PT2Reaper", 0)
