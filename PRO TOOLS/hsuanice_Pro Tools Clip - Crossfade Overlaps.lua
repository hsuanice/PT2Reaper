-- @description hsuanice_Pro Tools Clip: Crossfade Overlaps
...
--   **Clip: Crossfade Overlaps**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clip: Crossfade Overlaps
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clip: Crossfade Overlaps", "PT2Reaper", 0)
