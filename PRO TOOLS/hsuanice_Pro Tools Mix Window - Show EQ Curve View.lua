-- @description hsuanice_Pro Tools Mix Window: Show EQ Curve View
...
--   **Mix Window: Show EQ Curve View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show EQ Curve View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show EQ Curve View", "PT2Reaper", 0)
