-- @description hsuanice_Pro Tools Copy and Transpose Up (Octave)
...
--   **Copy and Transpose Up (Octave)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Transpose Up (Octave)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Shift + Up Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy and Transpose Up (Octave)", "PT2Reaper", 0)
