-- @description hsuanice_Pro Tools Meter Type: Dorrough
...
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Dorrough
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Dorrough", "PT2Reaper", 0)
