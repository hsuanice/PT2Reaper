-- @description hsuanice_Pro Tools Clips List: Show Processing State
...
--   **Clips List: Show Processing State**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Processing State
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Processing State", "PT2Reaper", 0)
