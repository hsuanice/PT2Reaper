-- @description hsuanice_Pro Tools Render Track(s) with VocAlign 6 Pro
...
--   **Render Track(s) with VocAlign 6 Pro**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Render Track(s) with VocAlign 6 Pro
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Render Track(s) with VocAlign 6 Pro", "PT2Reaper", 0)
