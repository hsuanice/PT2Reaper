-- @description hsuanice_Pro Tools Recall Clip Effects / Zoom Memory 4
...
--   **Recall Clip Effects / Zoom Memory 4**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall Clip Effects / Zoom Memory 4
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + 4
...
reaper.ShowMessageBox("Not yet implemented: Recall Clip Effects / Zoom Memory 4", "PT2Reaper", 0)
