...
--
--   ## Details
--   - Pro Tools equivalent : Trim Clip Start To Cursor
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + Shift + 7
...
reaper.ShowMessageBox("Not yet implemented: Trim Clip Start To Cursor", "PT2Reaper", 0)
