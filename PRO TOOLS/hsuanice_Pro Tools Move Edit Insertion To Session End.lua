-- @description hsuanice_Pro Tools Move Edit Insertion To Session End
...
--   **Move Edit Insertion To Session End**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Insertion To Session End
--   - Module               : Selection
--   - Mac shortcut (PT)    : Option + Return
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Insertion To Session End", "PT2Reaper", 0)
