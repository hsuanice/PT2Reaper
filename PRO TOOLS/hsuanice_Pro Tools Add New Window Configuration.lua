-- @description hsuanice_Pro Tools Add New Window Configuration
...
--   **Add New Window Configuration**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Add New Window Configuration
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Add New Window Configuration", "PT2Reaper", 0)
