-- @description hsuanice_Pro Tools Shuttle At Speed 4
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 4
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 4
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 4", "PT2Reaper", 0)
