-- @description hsuanice_Pro Tools Show Docked SpectraLayers
...
--   **Show Docked SpectraLayers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Docked SpectraLayers
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked SpectraLayers", "PT2Reaper", 0)
