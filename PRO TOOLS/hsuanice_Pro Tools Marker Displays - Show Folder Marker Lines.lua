-- @description hsuanice_Pro Tools Marker Displays: Show Folder Marker Lines
...
--   **Marker Displays: Show Folder Marker Lines**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Marker Displays: Show Folder Marker Lines
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Option + Control + F
...
reaper.ShowMessageBox("Not yet implemented: Marker Displays: Show Folder Marker Lines", "PT2Reaper", 0)
