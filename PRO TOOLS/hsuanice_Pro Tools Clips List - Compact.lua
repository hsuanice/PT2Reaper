-- @description hsuanice_Pro Tools Clips List: Compact
...
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Compact
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Compact", "PT2Reaper", 0)
