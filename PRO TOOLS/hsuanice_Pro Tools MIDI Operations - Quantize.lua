-- @description hsuanice_Pro Tools MIDI Operations: Quantize
...
--   **MIDI Operations: Quantize**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Quantize
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Numpad 0
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Quantize", "PT2Reaper", 0)
