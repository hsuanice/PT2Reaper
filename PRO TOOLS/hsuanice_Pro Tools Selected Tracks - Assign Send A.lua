-- @description hsuanice_Pro Tools Selected Tracks: Assign Send A
...
--   **Selected Tracks: Assign Send A**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send A
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send A", "PT2Reaper", 0)
