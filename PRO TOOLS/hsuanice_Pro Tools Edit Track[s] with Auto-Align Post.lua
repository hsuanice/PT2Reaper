-- @description hsuanice_Pro Tools Edit Track(s) with Auto-Align Post
...
--   **Edit Track(s) with Auto-Align Post**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with Auto-Align Post
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with Auto-Align Post", "PT2Reaper", 0)
