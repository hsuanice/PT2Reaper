-- @description hsuanice_Pro Tools Edit Window: Show Track Color
...
--   **Edit Window: Show Track Color**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Track Color
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Track Color", "PT2Reaper", 0)
