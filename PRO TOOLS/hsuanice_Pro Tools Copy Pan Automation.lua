-- @description hsuanice_Pro Tools Copy Pan Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Copy Pan Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Copy Pan Automation", "PT2Reaper", 0)
