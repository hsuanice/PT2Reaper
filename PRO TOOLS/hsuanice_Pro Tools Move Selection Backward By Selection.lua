-- @description hsuanice_Pro Tools Move Selection Backward By Selection
...
--   **Move Selection Backward By Selection**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Selection Backward By Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + L
...
reaper.ShowMessageBox("Not yet implemented: Move Selection Backward By Selection", "PT2Reaper", 0)
