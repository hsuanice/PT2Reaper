-- @description hsuanice_Pro Tools Display Edit Selection End
...
--   **Display Edit Selection End**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Display Edit Selection End
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Display Edit Selection End", "PT2Reaper", 0)
