-- @description hsuanice_Pro Tools Close Task Manager
...
--
--   ## Details
--   - Pro Tools equivalent : Close Task Manager
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Close Task Manager", "PT2Reaper", 0)
