-- @description hsuanice_Pro Tools Edit Track(s) with VocAlign 6 Pro
...
--   **Edit Track(s) with VocAlign 6 Pro**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with VocAlign 6 Pro
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with VocAlign 6 Pro", "PT2Reaper", 0)
