-- @description hsuanice_Pro Tools Copy Plugin Automation
...
--   **Copy Plugin Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy Plugin Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Copy Plugin Automation", "PT2Reaper", 0)
