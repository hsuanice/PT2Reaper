-- @description hsuanice_Pro Tools Selected Tracks as New Media Composer Compatible Session
...
--   **Selected Tracks as New Media Composer Compatible Session**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks as New Media Composer Compatible Session
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : —
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks as New Media Composer Compatible Session", "PT2Reaper", 0)
