-- @description hsuanice_Pro Tools Nudge Selection Earlier By Grid
...
--   **Nudge Selection Earlier By Grid**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Selection Earlier By Grid
--   - Module               : Selection
--   - Mac shortcut (PT)    : Shift + Numpad Minus
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Nudge Selection Earlier By Grid", "PT2Reaper", 0)
