-- @description hsuanice_Pro Tools Expanded Sends: Send A
...
--   **Expanded Sends: Send A**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send A
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send A", "PT2Reaper", 0)
