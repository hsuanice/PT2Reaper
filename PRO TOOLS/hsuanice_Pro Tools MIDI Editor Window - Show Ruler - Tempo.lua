-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Tempo
...
--   **MIDI Editor Window: Show Ruler: Tempo**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Tempo
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Tempo", "PT2Reaper", 0)
