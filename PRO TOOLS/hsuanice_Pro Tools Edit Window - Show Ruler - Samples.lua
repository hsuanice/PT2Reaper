-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Samples
...
--   **Edit Window: Show Ruler: Samples**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Samples
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Samples", "PT2Reaper", 0)
