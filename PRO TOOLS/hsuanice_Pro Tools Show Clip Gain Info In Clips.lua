-- @description hsuanice_Pro Tools Show Clip Gain Info In Clips
...
--   **Show Clip Gain Info In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Clip Gain Info In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + Equals
--   - Tags                 : Clip Gain/Effects, Show/Hide, View menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Clip Gain Info In Clips", "PT2Reaper", 0)
