-- @description hsuanice_Pro Tools Play Through Edit Start
...
--   **Play Through Edit Start**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Play Through Edit Start
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Option + Left Arrow
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play Through Edit Start", "PT2Reaper", 0)
