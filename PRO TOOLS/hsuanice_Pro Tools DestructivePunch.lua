-- @description hsuanice_Pro Tools DestructivePunch
...
--
--   ## Details
--   - Pro Tools equivalent : DestructivePunch
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: DestructivePunch", "PT2Reaper", 0)
