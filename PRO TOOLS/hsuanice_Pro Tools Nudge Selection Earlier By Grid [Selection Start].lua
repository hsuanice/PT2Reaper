-- @description hsuanice_Pro Tools Nudge Selection Earlier By Grid (Selection Start)
...
--   **Nudge Selection Earlier By Grid (Selection Start)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Selection Earlier By Grid (Selection Start)
--   - Module               : Selection
--   - Mac shortcut (PT)    : Option + Shift + Numpad Minus
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Nudge Selection Earlier By Grid (Selection Start)", "PT2Reaper", 0)
