-- @description hsuanice_Pro Tools Extend Selection To Next Memory Location
...
--   **Extend Selection To Next Memory Location**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Extend Selection To Next Memory Location
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation
--
...
reaper.ShowMessageBox("Not yet implemented: Extend Selection To Next Memory Location", "PT2Reaper", 0)
