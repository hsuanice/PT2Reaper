-- @description hsuanice_Pro Tools Clear VocAlign 6 Pro Track(s)
...
--   **Clear VocAlign 6 Pro Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear VocAlign 6 Pro Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear VocAlign 6 Pro Track(s)", "PT2Reaper", 0)
