-- @description hsuanice_Pro Tools Cloud Collaboration: Receive Selected Remotely Owned Tracks
...
--   **Cloud Collaboration: Receive Selected Remotely Owned Tracks**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Cloud Collaboration: Receive Selected Remotely Owned Tracks
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Cloud Collaboration: Receive Selected Remotely Owned Tracks", "PT2Reaper", 0)
