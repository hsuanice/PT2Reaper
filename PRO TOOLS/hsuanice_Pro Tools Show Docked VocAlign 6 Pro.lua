-- @description hsuanice_Pro Tools Show Docked VocAlign 6 Pro
...
--   **Show Docked VocAlign 6 Pro**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Docked VocAlign 6 Pro
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked VocAlign 6 Pro", "PT2Reaper", 0)
