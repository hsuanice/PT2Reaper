-- @description hsuanice_Pro Tools Play From Edit End
...
--
--   ## Details
--   - Pro Tools equivalent : Play From Edit End
--   - Module               : Transport
--   - Mac shortcut (PT)    : Commands Focus + 9
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play From Edit End", "PT2Reaper", 0)
