-- @description hsuanice_Pro Tools Render Track(s) with RX Spectral Editor
...
--   **Render Track(s) with RX Spectral Editor**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Render Track(s) with RX Spectral Editor
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Render Track(s) with RX Spectral Editor", "PT2Reaper", 0)
