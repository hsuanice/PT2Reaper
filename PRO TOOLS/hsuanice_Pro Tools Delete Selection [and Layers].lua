-- @description hsuanice_Pro Tools Delete Selection (and Layers)
...
--   **Delete Selection (and Layers)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Delete Selection (and Layers)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Backspace
--   - Tags                 : Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Delete Selection (and Layers)", "PT2Reaper", 0)
