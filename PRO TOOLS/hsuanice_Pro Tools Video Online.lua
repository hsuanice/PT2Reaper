-- @description hsuanice_Pro Tools Video Online
...
--
--   ## Details
--   - Pro Tools equivalent : Video Online
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + J
...
reaper.ShowMessageBox("Not yet implemented: Video Online", "PT2Reaper", 0)
