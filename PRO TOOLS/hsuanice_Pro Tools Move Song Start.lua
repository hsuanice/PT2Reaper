-- @description hsuanice_Pro Tools Move Song Start
...
--
--   ## Details
--   - Pro Tools equivalent : Move Song Start
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Move Song Start", "PT2Reaper", 0)
