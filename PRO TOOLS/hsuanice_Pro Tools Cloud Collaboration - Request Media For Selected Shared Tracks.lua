-- @description hsuanice_Pro Tools Cloud Collaboration: Request Media For Selected Shared Tracks
...
--   **Cloud Collaboration: Request Media For Selected Shared Tracks**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Cloud Collaboration: Request Media For Selected Shared Tracks
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Cloud Collaboration: Request Media For Selected Shared Tracks", "PT2Reaper", 0)
