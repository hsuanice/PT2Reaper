-- @description hsuanice_Pro Tools Convert Aux to Routing Folder
...
--
--   ## Details
--   - Pro Tools equivalent : Convert Aux to Routing Folder
--   - Module               : Tracks
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Convert Aux to Routing Folder", "PT2Reaper", 0)
