-- @description hsuanice_Pro Tools Group Tracks
...
--
--   ## Details
--   - Pro Tools equivalent : Group Tracks
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Command + G
...
reaper.ShowMessageBox("Not yet implemented: Group Tracks", "PT2Reaper", 0)
