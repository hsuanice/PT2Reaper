-- @description hsuanice_Pro Tools Clips List: "Select Unused" Ignores Parent Clip
...
--   **Clips List: "Select Unused" Ignores Parent Clip**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: "Select Unused" Ignores Parent Clip
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: "Select Unused" Ignores Parent Clip", "PT2Reaper", 0)
