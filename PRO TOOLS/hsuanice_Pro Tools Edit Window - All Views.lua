-- @description hsuanice_Pro Tools Edit Window: All Views
...
--   **Edit Window: All Views**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: All Views
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: All Views", "PT2Reaper", 0)
