-- @description hsuanice_Pro Tools Session Setup
...
--
--   ## Details
--   - Pro Tools equivalent : Session Setup
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Numpad 2
--   - Tags                 : Setup menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Session Setup", "PT2Reaper", 0)
