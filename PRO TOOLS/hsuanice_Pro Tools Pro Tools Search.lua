-- @description hsuanice_Pro Tools Pro Tools Search
...
--
--   ## Details
--   - Pro Tools equivalent : Pro Tools Search
--   - Module               : Misc
--   - Mac shortcut (PT)    : Control + Shift + S
--   - Tags                 : Miscellaneous, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Pro Tools Search", "PT2Reaper", 0)
