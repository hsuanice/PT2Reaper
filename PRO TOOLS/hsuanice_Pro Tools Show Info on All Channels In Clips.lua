-- @description hsuanice_Pro Tools Show Info on All Channels In Clips
...
--   **Show Info on All Channels In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Info on All Channels In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Info on All Channels In Clips", "PT2Reaper", 0)
