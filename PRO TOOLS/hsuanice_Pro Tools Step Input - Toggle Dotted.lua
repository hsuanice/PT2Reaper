-- @description hsuanice_Pro Tools Step Input: Toggle Dotted
...
--   **Step Input: Toggle Dotted**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: Toggle Dotted
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad Period
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: Toggle Dotted", "PT2Reaper", 0)
