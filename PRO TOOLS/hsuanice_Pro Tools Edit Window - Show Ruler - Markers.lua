-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Markers
...
--   **Edit Window: Show Ruler: Markers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Markers
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Markers", "PT2Reaper", 0)
