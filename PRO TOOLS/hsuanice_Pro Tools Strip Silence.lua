-- @description hsuanice_Pro Tools Strip Silence
...
--
--   ## Details
--   - Pro Tools equivalent : Strip Silence
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + U
...
reaper.ShowMessageBox("Not yet implemented: Strip Silence", "PT2Reaper", 0)
