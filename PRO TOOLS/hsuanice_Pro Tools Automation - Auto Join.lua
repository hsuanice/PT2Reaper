-- @description hsuanice_Pro Tools Automation: Auto Join
...
--   **Automation: Auto Join**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Automation: Auto Join
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Automation: Auto Join", "PT2Reaper", 0)
