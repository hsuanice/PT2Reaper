-- @description hsuanice_Pro Tools Clear Trim Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Clear Trim Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Trim Automation", "PT2Reaper", 0)
