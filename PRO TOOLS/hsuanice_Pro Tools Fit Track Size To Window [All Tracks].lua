-- @description hsuanice_Pro Tools Fit Track Size To Window (All Tracks)
...
--   **Fit Track Size To Window (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Fit Track Size To Window (All Tracks)
--   - Module               : Navigation
--   - Mac shortcut (PT)    : Command + Option + Control + Down Arrow
...
reaper.ShowMessageBox("Not yet implemented: Fit Track Size To Window (All Tracks)", "PT2Reaper", 0)
