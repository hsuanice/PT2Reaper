-- @description hsuanice_Pro Tools Clips List: Recalculate Waveform Overviews
...
--   **Clips List: Recalculate Waveform Overviews**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Recalculate Waveform Overviews
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Recalculate Waveform Overviews", "PT2Reaper", 0)
