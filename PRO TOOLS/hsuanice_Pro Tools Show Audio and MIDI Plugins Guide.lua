-- @description hsuanice_Pro Tools Show Audio and MIDI Plugins Guide
...
--   **Show Audio and MIDI Plugins Guide**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Audio and MIDI Plugins Guide
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Help menu
--
...
reaper.ShowMessageBox("Not yet implemented: Show Audio and MIDI Plugins Guide", "PT2Reaper", 0)
