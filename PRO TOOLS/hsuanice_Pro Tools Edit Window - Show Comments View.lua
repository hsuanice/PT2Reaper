-- @description hsuanice_Pro Tools Edit Window: Show Comments View
...
--   **Edit Window: Show Comments View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Comments View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Comments View", "PT2Reaper", 0)
