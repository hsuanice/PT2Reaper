-- @description hsuanice_Pro Tools Next Matching Field Recorder Channel
...
--   **Next Matching Field Recorder Channel**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Next Matching Field Recorder Channel
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Next Matching Field Recorder Channel", "PT2Reaper", 0)
