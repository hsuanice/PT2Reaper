-- @description hsuanice_Pro Tools Step Input: 16th Note
...
--   **Step Input: 16th Note**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: 16th Note
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 6
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: 16th Note", "PT2Reaper", 0)
