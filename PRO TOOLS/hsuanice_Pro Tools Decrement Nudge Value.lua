-- @description hsuanice_Pro Tools Decrement Nudge Value
...
--
--   ## Details
--   - Pro Tools equivalent : Decrement Nudge Value
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Decrement Nudge Value", "PT2Reaper", 0)
