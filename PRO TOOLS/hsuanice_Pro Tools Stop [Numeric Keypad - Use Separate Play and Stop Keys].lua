-- @description hsuanice_Pro Tools Stop (Numeric Keypad: Use Separate Play and Stop Keys)
...
--   **Stop (Numeric Keypad: Use Separate Play and Stop Keys)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Stop (Numeric Keypad: Use Separate Play and Stop Keys)
--   - Module               : Transport
...
reaper.ShowMessageBox("Not yet implemented: Stop (Numeric Keypad: Use Separate Play and Stop Keys)", "PT2Reaper", 0)
