-- @description hsuanice_Pro Tools Shuffle Mode (Lock)
...
--
--   ## Details
--   - Pro Tools equivalent : Shuffle Mode (Lock)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + F1
...
reaper.ShowMessageBox("Not yet implemented: Shuffle Mode (Lock)", "PT2Reaper", 0)
