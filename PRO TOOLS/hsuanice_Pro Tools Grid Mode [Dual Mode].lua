-- @description hsuanice_Pro Tools Grid Mode (Dual Mode)
...
--
--   ## Details
--   - Pro Tools equivalent : Grid Mode (Dual Mode)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + F4
...
reaper.ShowMessageBox("Not yet implemented: Grid Mode (Dual Mode)", "PT2Reaper", 0)
