-- @description hsuanice_Pro Tools Import Audio
...
--
--   ## Details
--   - Pro Tools equivalent : Import Audio
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + I
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Import Audio", "PT2Reaper", 0)
