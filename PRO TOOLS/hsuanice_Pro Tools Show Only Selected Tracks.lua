-- @description hsuanice_Pro Tools Show Only Selected Tracks
...
--
--   ## Details
--   - Pro Tools equivalent : Show Only Selected Tracks
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Only Selected Tracks", "PT2Reaper", 0)
