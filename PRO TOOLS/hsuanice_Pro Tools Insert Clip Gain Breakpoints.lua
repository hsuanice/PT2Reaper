-- @description hsuanice_Pro Tools Insert Clip Gain Breakpoints
...
--   **Insert Clip Gain Breakpoints**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Insert Clip Gain Breakpoints
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + E
--   - Tags                 : Clip Gain/Effects, Clips
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Insert Clip Gain Breakpoints", "PT2Reaper", 0)
