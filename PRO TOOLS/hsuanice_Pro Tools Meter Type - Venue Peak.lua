-- @description hsuanice_Pro Tools Meter Type: Venue Peak
...
--   **Meter Type: Venue Peak**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Venue Peak
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Venue Peak", "PT2Reaper", 0)
