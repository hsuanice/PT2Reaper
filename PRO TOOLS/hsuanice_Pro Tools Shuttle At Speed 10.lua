-- @description hsuanice_Pro Tools Shuttle At Speed 10
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 10
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
--   - Tags                 : Transport
--
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 10", "PT2Reaper", 0)
