-- @description hsuanice_Pro Tools Link Track And Edit Selection
...
--
--   ## Details
--   - Pro Tools equivalent : Link Track And Edit Selection
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + T
--   - Tags                 : Editing, Options menu, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Link Track And Edit Selection", "PT2Reaper", 0)
