-- @description hsuanice_Pro Tools Bypass Clip Gain
...
--
--   ## Details
--   - Pro Tools equivalent : Bypass Clip Gain
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass Clip Gain", "PT2Reaper", 0)
