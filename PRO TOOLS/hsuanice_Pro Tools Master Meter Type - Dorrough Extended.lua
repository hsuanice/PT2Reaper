-- @description hsuanice_Pro Tools Master Meter Type: Dorrough Extended
...
--   **Master Meter Type: Dorrough Extended**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: Dorrough Extended
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: Dorrough Extended", "PT2Reaper", 0)
