-- @description hsuanice_Pro Tools Shuttle At Speed 0
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 0
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 0
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 0", "PT2Reaper", 0)
