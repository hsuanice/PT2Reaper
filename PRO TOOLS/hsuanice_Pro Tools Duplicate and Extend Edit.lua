-- @description hsuanice_Pro Tools Duplicate and Extend Edit
...
--
--   ## Details
--   - Pro Tools equivalent : Duplicate and Extend Edit
--   - Module               : Automation
--   - Mac shortcut (PT)    : Command + Option + Shift + D
...
reaper.ShowMessageBox("Not yet implemented: Duplicate and Extend Edit", "PT2Reaper", 0)
