-- @description hsuanice_Pro Tools Cloud Collaboration: Receive All New Remotely Owned Tracks
...
--   **Cloud Collaboration: Receive All New Remotely Owned Tracks**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Cloud Collaboration: Receive All New Remotely Owned Tracks
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Cloud Collaboration: Receive All New Remotely Owned Tracks", "PT2Reaper", 0)
