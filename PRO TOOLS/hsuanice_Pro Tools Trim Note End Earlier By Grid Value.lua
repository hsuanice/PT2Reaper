-- @description hsuanice_Pro Tools Trim Note End Earlier By Grid Value
...
--   **Trim Note End Earlier By Grid Value**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Trim Note End Earlier By Grid Value
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Left Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Trim Note End Earlier By Grid Value", "PT2Reaper", 0)
