-- @description hsuanice_Pro Tools Redefine External Timecode Offset
...
--   **Redefine External Timecode Offset**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Redefine External Timecode Offset
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Setup menu
--
...
reaper.ShowMessageBox("Not yet implemented: Redefine External Timecode Offset", "PT2Reaper", 0)
