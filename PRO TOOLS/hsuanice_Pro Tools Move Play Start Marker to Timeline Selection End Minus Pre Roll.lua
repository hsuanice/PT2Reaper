-- @description hsuanice_Pro Tools Move Play Start Marker to Timeline Selection End Minus Pre Roll
...
--   **Move Play Start Marker to Timeline Selection End Minus Pre Roll**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Play Start Marker to Timeline Selection End Minus Pre Roll
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
--   - Tags                 : Transport
--
...
reaper.ShowMessageBox("Not yet implemented: Move Play Start Marker to Timeline Selection End Minus Pre Roll", "PT2Reaper", 0)
