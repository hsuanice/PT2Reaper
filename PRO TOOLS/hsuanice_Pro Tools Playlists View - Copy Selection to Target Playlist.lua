-- @description hsuanice_Pro Tools Playlists View: Copy Selection to Target Playlist
...
--   **Playlists View: Copy Selection to Target Playlist**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Playlists View: Copy Selection to Target Playlist
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Control + V
...
reaper.ShowMessageBox("Not yet implemented: Playlists View: Copy Selection to Target Playlist", "PT2Reaper", 0)
