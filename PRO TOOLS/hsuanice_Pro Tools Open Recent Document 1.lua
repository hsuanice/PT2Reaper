-- @description hsuanice_Pro Tools Open Recent Document 1
...
--   **Open Recent Document 1**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Open Recent Document 1
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + O
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Open Recent Document 1", "PT2Reaper", 0)
