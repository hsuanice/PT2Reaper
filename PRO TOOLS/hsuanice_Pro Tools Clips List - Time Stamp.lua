-- @description hsuanice_Pro Tools Clips List: Time Stamp
...
--   **Clips List: Time Stamp**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Time Stamp
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Shift + M
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Time Stamp", "PT2Reaper", 0)
