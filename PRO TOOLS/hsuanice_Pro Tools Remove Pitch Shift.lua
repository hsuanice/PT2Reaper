-- @description hsuanice_Pro Tools Remove Pitch Shift
...
--
--   ## Details
--   - Pro Tools equivalent : Remove Pitch Shift
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Remove Pitch Shift", "PT2Reaper", 0)
