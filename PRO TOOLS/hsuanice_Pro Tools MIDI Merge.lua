-- @description hsuanice_Pro Tools MIDI Merge
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Merge
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 9
--   - Tags                 : MIDI, Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: MIDI Merge", "PT2Reaper", 0)
