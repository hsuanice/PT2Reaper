-- @description hsuanice_Pro Tools Add Meter Event
...
--
--   ## Details
--   - Pro Tools equivalent : Add Meter Event
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : Tempo/Meter
--
...
reaper.ShowMessageBox("Not yet implemented: Add Meter Event", "PT2Reaper", 0)
