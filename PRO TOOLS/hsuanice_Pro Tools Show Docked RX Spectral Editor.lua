-- @description hsuanice_Pro Tools Show Docked RX Spectral Editor
...
--   **Show Docked RX Spectral Editor**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Docked RX Spectral Editor
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Show/Hide
--
...
reaper.ShowMessageBox("Not yet implemented: Show Docked RX Spectral Editor", "PT2Reaper", 0)
