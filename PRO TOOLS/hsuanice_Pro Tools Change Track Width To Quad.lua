-- @description hsuanice_Pro Tools Change Track Width To Quad
...
--   **Change Track Width To Quad**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To Quad
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To Quad", "PT2Reaper", 0)
