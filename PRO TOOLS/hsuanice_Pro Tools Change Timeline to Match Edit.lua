-- @description hsuanice_Pro Tools Change Timeline to Match Edit
...
--
--   ## Details
--   - Pro Tools equivalent : Change Timeline to Match Edit
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Shift + 5
...
reaper.ShowMessageBox("Not yet implemented: Change Timeline to Match Edit", "PT2Reaper", 0)
