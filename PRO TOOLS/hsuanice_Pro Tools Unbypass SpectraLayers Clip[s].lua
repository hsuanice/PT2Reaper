-- @description hsuanice_Pro Tools Unbypass SpectraLayers Clip(s)
...
--   **Unbypass SpectraLayers Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass SpectraLayers Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass SpectraLayers Clip(s)", "PT2Reaper", 0)
