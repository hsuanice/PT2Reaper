-- @description hsuanice_Pro Tools Spot Mode (Dual Mode)
...
--
--   ## Details
--   - Pro Tools equivalent : Spot Mode (Dual Mode)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + F3
...
reaper.ShowMessageBox("Not yet implemented: Spot Mode (Dual Mode)", "PT2Reaper", 0)
