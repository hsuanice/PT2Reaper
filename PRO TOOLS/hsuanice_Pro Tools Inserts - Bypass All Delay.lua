-- @description hsuanice_Pro Tools Inserts: Bypass All Delay
...
--   **Inserts: Bypass All Delay**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Inserts: Bypass All Delay
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + D
...
reaper.ShowMessageBox("Not yet implemented: Inserts: Bypass All Delay", "PT2Reaper", 0)
