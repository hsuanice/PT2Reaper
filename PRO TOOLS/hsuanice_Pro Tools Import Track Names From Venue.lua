-- @description hsuanice_Pro Tools Import Track Names From Venue
...
--   **Import Track Names From Venue**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Import Track Names From Venue
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Import Track Names From Venue", "PT2Reaper", 0)
