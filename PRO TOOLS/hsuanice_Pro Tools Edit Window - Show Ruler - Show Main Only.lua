-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Show Main Only
...
--   **Edit Window: Show Ruler: Show Main Only**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Show Main Only
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Show Main Only", "PT2Reaper", 0)
