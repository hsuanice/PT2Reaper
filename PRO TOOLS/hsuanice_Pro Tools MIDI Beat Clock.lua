-- @description hsuanice_Pro Tools MIDI Beat Clock
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Beat Clock
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Beat Clock", "PT2Reaper", 0)
