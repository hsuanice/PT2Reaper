...
--   **Move Clip Start To Current TC**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Clip Start To Current TC
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Y
--   - Tags                 : Clips, Editing
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Move Clip Start To Current TC", "PT2Reaper", 0)
