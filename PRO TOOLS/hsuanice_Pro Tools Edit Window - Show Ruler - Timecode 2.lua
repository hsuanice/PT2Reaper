-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Timecode 2
...
--   **Edit Window: Show Ruler: Timecode 2**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Timecode 2
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Timecode 2", "PT2Reaper", 0)
