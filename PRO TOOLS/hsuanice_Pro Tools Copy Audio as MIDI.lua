-- @description hsuanice_Pro Tools Copy Audio as MIDI
...
--
--   ## Details
--   - Pro Tools equivalent : Copy Audio as MIDI
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Clips List, Edit menu, Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Copy Audio as MIDI", "PT2Reaper", 0)
