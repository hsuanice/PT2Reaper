-- @description hsuanice_Pro Tools Step Input: 32nd Note
...
--   **Step Input: 32nd Note**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: 32nd Note
--   - Module               : MIDI
...
reaper.ShowMessageBox("Not yet implemented: Step Input: 32nd Note", "PT2Reaper", 0)
