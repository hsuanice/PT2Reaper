-- @description hsuanice_Pro Tools Show VocAlign 6 Pro Detached Tab
...
--   **Show VocAlign 6 Pro Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show VocAlign 6 Pro Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show VocAlign 6 Pro Detached Tab", "PT2Reaper", 0)
