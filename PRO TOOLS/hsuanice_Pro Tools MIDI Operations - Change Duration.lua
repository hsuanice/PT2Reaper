-- @description hsuanice_Pro Tools MIDI Operations: Change Duration
...
--   **MIDI Operations: Change Duration**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Operations: Change Duration
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + P
...
reaper.ShowMessageBox("Not yet implemented: MIDI Operations: Change Duration", "PT2Reaper", 0)
