-- @description hsuanice_Pro Tools Select Selection End
...
--
--   ## Details
--   - Pro Tools equivalent : Select Selection End
--   - Module               : Editing
--   - Mac shortcut (PT)    : Up Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Select Selection End", "PT2Reaper", 0)
