-- @description hsuanice_Pro Tools Show RePitch Detached Tab
...
--   **Show RePitch Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show RePitch Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show RePitch Detached Tab", "PT2Reaper", 0)
