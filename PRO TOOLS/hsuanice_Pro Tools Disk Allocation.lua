-- @description hsuanice_Pro Tools Disk Allocation
...
--
--   ## Details
--   - Pro Tools equivalent : Disk Allocation
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Setup menu
--
...
reaper.ShowMessageBox("Not yet implemented: Disk Allocation", "PT2Reaper", 0)
