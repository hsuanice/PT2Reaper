-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Chord Symbols
...
--   **MIDI Editor Window: Show Ruler: Chord Symbols**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Chord Symbols
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Chord Symbols", "PT2Reaper", 0)
