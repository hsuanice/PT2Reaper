-- @description hsuanice_Pro Tools Render Clip Gain
...
--
--   ## Details
--   - Pro Tools equivalent : Render Clip Gain
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Render Clip Gain", "PT2Reaper", 0)
