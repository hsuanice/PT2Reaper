-- @description hsuanice_Pro Tools Show Clip List Detached Window
...
--   **Show Clip List Detached Window**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Clip List Detached Window
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Clip List Detached Window", "PT2Reaper", 0)
