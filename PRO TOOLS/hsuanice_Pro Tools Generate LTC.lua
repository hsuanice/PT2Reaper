-- @description hsuanice_Pro Tools Generate LTC
...
--
--   ## Details
--   - Pro Tools equivalent : Generate LTC
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Control + J
--   - Tags                 : Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Generate LTC", "PT2Reaper", 0)
