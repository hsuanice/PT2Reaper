-- @description hsuanice_Pro Tools Meter Type: Venue RMS
...
--   **Meter Type: Venue RMS**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Venue RMS
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Venue RMS", "PT2Reaper", 0)
