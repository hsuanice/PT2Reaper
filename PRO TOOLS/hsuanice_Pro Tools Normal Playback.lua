-- @description hsuanice_Pro Tools Normal Playback
...
--
--   ## Details
--   - Pro Tools equivalent : Normal Playback
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
--   - Tags                 : Transport
--
...
reaper.ShowMessageBox("Not yet implemented: Normal Playback", "PT2Reaper", 0)
