-- @description hsuanice_Pro Tools Edit Window Scrolling: Center Playhead
...
--   **Edit Window Scrolling: Center Playhead**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window Scrolling: Center Playhead
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation, Options menu, Window
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window Scrolling: Center Playhead", "PT2Reaper", 0)
