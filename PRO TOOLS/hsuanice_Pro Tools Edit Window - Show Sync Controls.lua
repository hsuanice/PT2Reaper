-- @description hsuanice_Pro Tools Edit Window: Show Sync Controls
...
--   **Edit Window: Show Sync Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Sync Controls
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
--   - Tags                 : Recording, Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Sync Controls", "PT2Reaper", 0)
