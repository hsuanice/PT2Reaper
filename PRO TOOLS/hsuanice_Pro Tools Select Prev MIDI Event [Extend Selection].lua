-- @description hsuanice_Pro Tools Select Prev MIDI Event (Extend Selection)
...
--   **Select Prev MIDI Event (Extend Selection)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Select Prev MIDI Event (Extend Selection)
--   - Module               : Navigation
...
reaper.ShowMessageBox("Not yet implemented: Select Prev MIDI Event (Extend Selection)", "PT2Reaper", 0)
