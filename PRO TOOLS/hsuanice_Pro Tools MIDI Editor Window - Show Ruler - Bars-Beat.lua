-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Bars|Beat
...
--   **MIDI Editor Window: Show Ruler: Bars|Beat**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Bars|Beat
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Bars|Beat", "PT2Reaper", 0)
