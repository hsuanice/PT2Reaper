-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Markers
...
--   **MIDI Editor Window: Show Ruler: Markers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Markers
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Markers", "PT2Reaper", 0)
