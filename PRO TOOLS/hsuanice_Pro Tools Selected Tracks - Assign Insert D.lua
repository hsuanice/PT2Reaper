-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert D
...
--   **Selected Tracks: Assign Insert D**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert D
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert D", "PT2Reaper", 0)
