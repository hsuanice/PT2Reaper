-- @description hsuanice_Pro Tools Move Edit Selection Up Including Folder Siblings
...
--   **Move Edit Selection Up Including Folder Siblings**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Edit Selection Up Including Folder Siblings
--   - Module               : Selection
--   - Mac shortcut (PT)    : —
--   - Tags                 : Selection
--
...
reaper.ShowMessageBox("Not yet implemented: Move Edit Selection Up Including Folder Siblings", "PT2Reaper", 0)
