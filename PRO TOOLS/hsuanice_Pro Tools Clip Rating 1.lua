-- @description hsuanice_Pro Tools Clip Rating 1
...
--
--   ## Details
--   - Pro Tools equivalent : Clip Rating 1
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + Numpad 1
...
reaper.ShowMessageBox("Not yet implemented: Clip Rating 1", "PT2Reaper", 0)
