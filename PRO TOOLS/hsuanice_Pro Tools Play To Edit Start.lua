-- @description hsuanice_Pro Tools Play To Edit Start
...
--
--   ## Details
--   - Pro Tools equivalent : Play To Edit Start
--   - Module               : Transport
--   - Mac shortcut (PT)    : Commands Focus + 6
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Play To Edit Start", "PT2Reaper", 0)
