-- @description hsuanice_Pro Tools Next Larger Track Size
...
--   **Next Larger Track Size**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Next Larger Track Size
--   - Module               : Navigation
--   - Mac shortcut (PT)    : Control + Up Arrow
...
reaper.ShowMessageBox("Not yet implemented: Next Larger Track Size", "PT2Reaper", 0)
