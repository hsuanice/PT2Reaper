-- @description hsuanice_Pro Tools Selected Tracks: Export MIDI
...
--   **Selected Tracks: Export MIDI**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Export MIDI
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Export MIDI", "PT2Reaper", 0)
