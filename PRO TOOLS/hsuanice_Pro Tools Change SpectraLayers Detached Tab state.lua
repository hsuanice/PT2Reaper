-- @description hsuanice_Pro Tools Change SpectraLayers Detached Tab state
...
--   **Change SpectraLayers Detached Tab state**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change SpectraLayers Detached Tab state
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change SpectraLayers Detached Tab state", "PT2Reaper", 0)
