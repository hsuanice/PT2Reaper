-- @description hsuanice_Pro Tools Transport Window: Show Counters
...
--   **Transport Window: Show Counters**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Transport Window: Show Counters
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Transport Window: Show Counters", "PT2Reaper", 0)
