-- @description hsuanice_Pro Tools Clips List: Select Unused Audio Except Whole Files
...
--   **Clips List: Select Unused Audio Except Whole Files**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Select Unused Audio Except Whole Files
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Select Unused Audio Except Whole Files", "PT2Reaper", 0)
