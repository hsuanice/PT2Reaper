-- @description hsuanice_Pro Tools Memory Locations
...
--
--   ## Details
--   - Pro Tools equivalent : Memory Locations
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Memory Locations", "PT2Reaper", 0)
