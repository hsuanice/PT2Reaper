-- @description hsuanice_Pro Tools Metadata Inspector Window
...
--
--   ## Details
--   - Pro Tools equivalent : Metadata Inspector Window
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Metadata Inspector Window", "PT2Reaper", 0)
