-- @description hsuanice_Pro Tools Selected Tracks: Assign Send G
...
--   **Selected Tracks: Assign Send G**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send G
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send G", "PT2Reaper", 0)
