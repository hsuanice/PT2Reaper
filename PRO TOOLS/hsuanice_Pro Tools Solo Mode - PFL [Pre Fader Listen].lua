-- @description hsuanice_Pro Tools Solo Mode: PFL (Pre Fader Listen)
...
--   **Solo Mode: PFL (Pre Fader Listen)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Solo Mode: PFL (Pre Fader Listen)
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Options menu
--
...
reaper.ShowMessageBox("Not yet implemented: Solo Mode: PFL (Pre Fader Listen)", "PT2Reaper", 0)
