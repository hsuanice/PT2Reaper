-- @description hsuanice_Pro Tools MIDI Input Display
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Input Display
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Input Display", "PT2Reaper", 0)
