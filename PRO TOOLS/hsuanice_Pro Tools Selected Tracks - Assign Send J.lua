-- @description hsuanice_Pro Tools Selected Tracks: Assign Send J
...
--   **Selected Tracks: Assign Send J**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send J
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send J", "PT2Reaper", 0)
