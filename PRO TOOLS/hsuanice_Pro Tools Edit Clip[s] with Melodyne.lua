-- @description hsuanice_Pro Tools Edit Clip(s) with Melodyne
...
--   **Edit Clip(s) with Melodyne**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Clip(s) with Melodyne
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + A
...
reaper.ShowMessageBox("Not yet implemented: Edit Clip(s) with Melodyne", "PT2Reaper", 0)
