-- @description hsuanice_Pro Tools Clear Special: Clip Gain
...
--   **Clear Special: Clip Gain**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Special: Clip Gain
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + B
...
reaper.ShowMessageBox("Not yet implemented: Clear Special: Clip Gain", "PT2Reaper", 0)
