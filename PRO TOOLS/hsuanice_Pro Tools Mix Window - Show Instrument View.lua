-- @description hsuanice_Pro Tools Mix Window: Show Instrument View
...
--   **Mix Window: Show Instrument View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mix Window: Show Instrument View
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Mix Window: Show Instrument View", "PT2Reaper", 0)
