-- @description hsuanice_Pro Tools Render Track(s) with RePitch
...
--   **Render Track(s) with RePitch**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Render Track(s) with RePitch
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Render Track(s) with RePitch", "PT2Reaper", 0)
