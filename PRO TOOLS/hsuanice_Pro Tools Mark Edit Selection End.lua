-- @description hsuanice_Pro Tools Mark Edit Selection End
...
--   **Mark Edit Selection End**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Mark Edit Selection End
--   - Module               : Selection
--   - Mac shortcut (PT)    : —
--   - Tags                 : Selection
--
...
reaper.ShowMessageBox("Not yet implemented: Mark Edit Selection End", "PT2Reaper", 0)
