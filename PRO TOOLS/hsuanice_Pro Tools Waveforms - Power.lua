-- @description hsuanice_Pro Tools Waveforms: Power
...
--
--   ## Details
--   - Pro Tools equivalent : Waveforms: Power
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Waveforms: Power", "PT2Reaper", 0)
