-- @description hsuanice_Pro Tools Edit Window: Show Inserts F-J View
...
--   **Edit Window: Show Inserts F-J View**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Inserts F-J View
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Inserts F-J View", "PT2Reaper", 0)
