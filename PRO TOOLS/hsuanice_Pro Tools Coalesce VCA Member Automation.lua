-- @description hsuanice_Pro Tools Coalesce VCA Member Automation
...
--   **Coalesce VCA Member Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Coalesce VCA Member Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Coalesce VCA Member Automation", "PT2Reaper", 0)
