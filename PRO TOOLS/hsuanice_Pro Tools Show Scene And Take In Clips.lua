-- @description hsuanice_Pro Tools Show Scene And Take In Clips
...
--   **Show Scene And Take In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Scene And Take In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Scene And Take In Clips", "PT2Reaper", 0)
