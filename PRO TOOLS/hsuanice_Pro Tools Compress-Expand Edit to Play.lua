-- @description hsuanice_Pro Tools Compress/Expand Edit to Play
...
--
--   ## Details
--   - Pro Tools equivalent : Compress/Expand Edit to Play
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Shift + U
...
reaper.ShowMessageBox("Not yet implemented: Compress/Expand Edit to Play", "PT2Reaper", 0)
