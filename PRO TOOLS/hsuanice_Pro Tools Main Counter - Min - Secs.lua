-- @description hsuanice_Pro Tools Main Counter: Min:Secs
...
--   **Main Counter: Min:Secs**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Main Counter: Min:Secs
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Main Counter: Min:Secs", "PT2Reaper", 0)
