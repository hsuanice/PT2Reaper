-- @description hsuanice_Pro Tools Set Zoom Memory 5
...
--
--   ## Details
--   - Pro Tools equivalent : Set Zoom Memory 5
--   - Module               : Zoom
--   - Mac shortcut (PT)    : —
--   - Tags                 : Zoom
--
...
reaper.ShowMessageBox("Not yet implemented: Set Zoom Memory 5", "PT2Reaper", 0)
