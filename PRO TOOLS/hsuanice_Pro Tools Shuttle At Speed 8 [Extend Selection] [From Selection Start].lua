-- @description hsuanice_Pro Tools Shuttle At Speed 8 (Extend Selection) (From Selection Start)
...
--   **Shuttle At Speed 8 (Extend Selection) (From Selection Start)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 8 (Extend Selection) (From Selection Start)
--   - Module               : Transport
--   - Mac shortcut (PT)    : Control + Shift + Numpad 8
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 8 (Extend Selection) (From Selection Start)", "PT2Reaper", 0)
