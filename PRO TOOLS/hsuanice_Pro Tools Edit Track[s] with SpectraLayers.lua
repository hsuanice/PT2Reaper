-- @description hsuanice_Pro Tools Edit Track(s) with SpectraLayers
...
--   **Edit Track(s) with SpectraLayers**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Track(s) with SpectraLayers
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Track(s) with SpectraLayers", "PT2Reaper", 0)
