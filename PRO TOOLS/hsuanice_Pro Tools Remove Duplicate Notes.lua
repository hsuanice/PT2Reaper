-- @description hsuanice_Pro Tools Remove Duplicate Notes
...
--
--   ## Details
--   - Pro Tools equivalent : Remove Duplicate Notes
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Remove Duplicate Notes", "PT2Reaper", 0)
