-- @description hsuanice_Pro Tools Copy and Transpose Down
...
--   **Copy and Transpose Down**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Transpose Down
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Copy and Transpose Down", "PT2Reaper", 0)
