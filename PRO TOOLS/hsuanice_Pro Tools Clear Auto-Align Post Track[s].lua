-- @description hsuanice_Pro Tools Clear Auto-Align Post Track(s)
...
--   **Clear Auto-Align Post Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Auto-Align Post Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Auto-Align Post Track(s)", "PT2Reaper", 0)
