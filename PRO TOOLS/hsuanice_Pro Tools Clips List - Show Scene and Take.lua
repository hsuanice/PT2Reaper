-- @description hsuanice_Pro Tools Clips List: Show Scene and Take
...
--   **Clips List: Show Scene and Take**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Scene and Take
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Scene and Take", "PT2Reaper", 0)
