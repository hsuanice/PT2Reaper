-- @description hsuanice_Pro Tools Clips List: Show Timebase
...
--   **Clips List: Show Timebase**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show Timebase
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show Timebase", "PT2Reaper", 0)
