-- @description hsuanice_Pro Tools Move Record Enable to Previous MIDI Track
...
--   **Move Record Enable to Previous MIDI Track**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Move Record Enable to Previous MIDI Track
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : MIDI, Recording
--
...
reaper.ShowMessageBox("Not yet implemented: Move Record Enable to Previous MIDI Track", "PT2Reaper", 0)
