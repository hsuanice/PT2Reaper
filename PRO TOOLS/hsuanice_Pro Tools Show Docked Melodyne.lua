-- @description hsuanice_Pro Tools Show Docked Melodyne
...
--   **Show Docked Melodyne**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Docked Melodyne
--   - Module               : View
--   - Mac shortcut (PT)    : Option + Numpad 8
--   - Tags                 : Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Show Docked Melodyne", "PT2Reaper", 0)
