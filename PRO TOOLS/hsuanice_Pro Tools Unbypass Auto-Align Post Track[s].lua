-- @description hsuanice_Pro Tools Unbypass Auto-Align Post Track(s)
...
--   **Unbypass Auto-Align Post Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Unbypass Auto-Align Post Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Unbypass Auto-Align Post Track(s)", "PT2Reaper", 0)
