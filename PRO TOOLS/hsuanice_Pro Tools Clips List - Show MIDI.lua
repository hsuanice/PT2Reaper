-- @description hsuanice_Pro Tools Clips List: Show MIDI
...
--   **Clips List: Show MIDI**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Show MIDI
--   - Module               : Clips
--   - Mac shortcut (PT)    : Control + Shift + 2
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Show MIDI", "PT2Reaper", 0)
