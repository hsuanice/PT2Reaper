-- @description hsuanice_Pro Tools Clips List: Sort by File Name
...
--   **Clips List: Sort by File Name**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by File Name
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by File Name", "PT2Reaper", 0)
