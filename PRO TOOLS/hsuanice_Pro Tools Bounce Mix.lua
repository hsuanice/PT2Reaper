-- @description hsuanice_Pro Tools Bounce Mix
...
--
--   ## Details
--   - Pro Tools equivalent : Bounce Mix
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + B
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Bounce Mix", "PT2Reaper", 0)
