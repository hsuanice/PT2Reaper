-- @description hsuanice_Pro Tools Coalesce Clip Gain to Volume
...
--
--   ## Details
--   - Pro Tools equivalent : Coalesce Clip Gain to Volume
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Coalesce Clip Gain to Volume", "PT2Reaper", 0)
