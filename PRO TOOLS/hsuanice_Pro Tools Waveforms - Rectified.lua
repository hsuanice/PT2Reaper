-- @description hsuanice_Pro Tools Waveforms: Rectified
...
--
--   ## Details
--   - Pro Tools equivalent : Waveforms: Rectified
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Waveforms: Rectified", "PT2Reaper", 0)
