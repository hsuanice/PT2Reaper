-- @description hsuanice_Pro Tools Write Automation to Next Breakpoint
...
--
--   ## Details
--   - Pro Tools equivalent : Write Automation to Next Breakpoint
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Write Automation to Next Breakpoint", "PT2Reaper", 0)
