-- @description hsuanice_Pro Tools Copy and Transpose Down (Octave)
...
--   **Copy and Transpose Down (Octave)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Copy and Transpose Down (Octave)
--   - Module               : Editing
...
reaper.ShowMessageBox("Not yet implemented: Copy and Transpose Down (Octave)", "PT2Reaper", 0)
