...
--
--   ## Details
--   - Pro Tools equivalent : Trim Clip End To Cursor
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + Shift + 8
...
reaper.ShowMessageBox("Not yet implemented: Trim Clip End To Cursor", "PT2Reaper", 0)
