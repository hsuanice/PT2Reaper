-- @description hsuanice_Pro Tools Pencil Tool: Square
...
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: Square
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: Square", "PT2Reaper", 0)
