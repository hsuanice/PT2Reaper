-- @description hsuanice_Pro Tools Import MIDI
...
--
--   ## Details
--   - Pro Tools equivalent : Import MIDI
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Option + I
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Import MIDI", "PT2Reaper", 0)
