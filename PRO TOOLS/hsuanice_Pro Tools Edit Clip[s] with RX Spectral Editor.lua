-- @description hsuanice_Pro Tools Edit Clip(s) with RX Spectral Editor
...
--   **Edit Clip(s) with RX Spectral Editor**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Clip(s) with RX Spectral Editor
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Clip(s) with RX Spectral Editor", "PT2Reaper", 0)
