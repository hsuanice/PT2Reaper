-- @description hsuanice_Pro Tools Extract MIDI to New Track
...
--
--   ## Details
--   - Pro Tools equivalent : Extract MIDI to New Track
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Extract MIDI to New Track", "PT2Reaper", 0)
