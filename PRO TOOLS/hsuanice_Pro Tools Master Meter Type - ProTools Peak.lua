-- @description hsuanice_Pro Tools Master Meter Type: ProTools Peak
...
--   **Master Meter Type: ProTools Peak**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: ProTools Peak
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: ProTools Peak", "PT2Reaper", 0)
