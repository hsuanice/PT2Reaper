-- @description hsuanice_Pro Tools Master Meter Type: ProTools Classic
...
--   **Master Meter Type: ProTools Classic**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: ProTools Classic
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: ProTools Classic", "PT2Reaper", 0)
