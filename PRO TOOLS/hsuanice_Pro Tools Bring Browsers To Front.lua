-- @description hsuanice_Pro Tools Bring Browsers To Front
...
--   **Bring Browsers To Front**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bring Browsers To Front
--   - Module               : View
--   - Mac shortcut (PT)    : Option + J
--   - Tags                 : Window, Window menu, Workspace
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Bring Browsers To Front", "PT2Reaper", 0)
