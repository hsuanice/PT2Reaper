-- @description hsuanice_Pro Tools Transport Window
...
--
--   ## Details
--   - Pro Tools equivalent : Transport Window
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Numpad 1
--   - Tags                 : Transport, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Transport Window", "PT2Reaper", 0)
