-- @description hsuanice_Pro Tools Show Splice Detached Tab
...
--   **Show Splice Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Splice Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Splice Detached Tab", "PT2Reaper", 0)
