-- @description hsuanice_Pro Tools Selected Tracks: Assign Send I
...
--   **Selected Tracks: Assign Send I**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send I
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send I", "PT2Reaper", 0)
