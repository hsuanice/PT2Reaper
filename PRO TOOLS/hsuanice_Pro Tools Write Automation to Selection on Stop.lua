-- @description hsuanice_Pro Tools Write Automation to Selection on Stop
...
--
--   ## Details
--   - Pro Tools equivalent : Write Automation to Selection on Stop
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Write Automation to Selection on Stop", "PT2Reaper", 0)
