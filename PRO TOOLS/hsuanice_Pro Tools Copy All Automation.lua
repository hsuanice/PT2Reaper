-- @description hsuanice_Pro Tools Copy All Automation
...
--
--   ## Details
--   - Pro Tools equivalent : Copy All Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Copy All Automation", "PT2Reaper", 0)
