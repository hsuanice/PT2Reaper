-- @description hsuanice_Pro Tools Record Enable Previous MIDI Track
...
--   **Record Enable Previous MIDI Track**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Record Enable Previous MIDI Track
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
--   - Tags                 : MIDI, Recording
--
...
reaper.ShowMessageBox("Not yet implemented: Record Enable Previous MIDI Track", "PT2Reaper", 0)
