-- @description hsuanice_Pro Tools Transport Window: Show Synchronization
...
--   **Transport Window: Show Synchronization**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Transport Window: Show Synchronization
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Transport Window: Show Synchronization", "PT2Reaper", 0)
