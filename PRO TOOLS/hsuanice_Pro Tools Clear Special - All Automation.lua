-- @description hsuanice_Pro Tools Clear Special: All Automation
...
--   **Clear Special: All Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear Special: All Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear Special: All Automation", "PT2Reaper", 0)
