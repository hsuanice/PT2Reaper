-- @description hsuanice_Pro Tools Change Track Width To LCR
...
--   **Change Track Width To LCR**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Change Track Width To LCR
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Change Track Width To LCR", "PT2Reaper", 0)
