-- @description hsuanice_Pro Tools Hide Time in Clips
...
--
--   ## Details
--   - Pro Tools equivalent : Hide Time in Clips
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Hide Time in Clips", "PT2Reaper", 0)
