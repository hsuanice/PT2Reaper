-- @description hsuanice_Pro Tools Dropped Video Frame Indicator
...
--   **Dropped Video Frame Indicator**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Dropped Video Frame Indicator
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Dropped Video Frame Indicator", "PT2Reaper", 0)
