-- @description hsuanice_Pro Tools Dolby Atmos Renderer
...
--
--   ## Details
--   - Pro Tools equivalent : Dolby Atmos Renderer
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Control + Equals
...
reaper.ShowMessageBox("Not yet implemented: Dolby Atmos Renderer", "PT2Reaper", 0)
