-- @description hsuanice_Pro Tools Shuttle At Speed 2
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 2
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 2
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 2", "PT2Reaper", 0)
