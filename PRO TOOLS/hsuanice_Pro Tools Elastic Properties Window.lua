-- @description hsuanice_Pro Tools Elastic Properties Window
...
--
--   ## Details
--   - Pro Tools equivalent : Elastic Properties Window
--   - Module               : Clips
--   - Mac shortcut (PT)    : Option + Numpad 5
...
reaper.ShowMessageBox("Not yet implemented: Elastic Properties Window", "PT2Reaper", 0)
