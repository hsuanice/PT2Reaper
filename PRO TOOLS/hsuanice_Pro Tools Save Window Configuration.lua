-- @description hsuanice_Pro Tools Save Window Configuration
...
--
--   ## Details
--   - Pro Tools equivalent : Save Window Configuration
--   - Module               : View
...
reaper.ShowMessageBox("Not yet implemented: Save Window Configuration", "PT2Reaper", 0)
