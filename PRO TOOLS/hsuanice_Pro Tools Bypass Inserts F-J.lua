-- @description hsuanice_Pro Tools Bypass Inserts F-J
...
--
--   ## Details
--   - Pro Tools equivalent : Bypass Inserts F-J
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + 3
...
reaper.ShowMessageBox("Not yet implemented: Bypass Inserts F-J", "PT2Reaper", 0)
