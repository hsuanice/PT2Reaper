-- @description hsuanice_Pro Tools Selected Tracks: Assign Send H
...
--   **Selected Tracks: Assign Send H**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send H
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send H", "PT2Reaper", 0)
