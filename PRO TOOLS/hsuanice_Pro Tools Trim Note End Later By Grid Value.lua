-- @description hsuanice_Pro Tools Trim Note End Later By Grid Value
...
--   **Trim Note End Later By Grid Value**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Trim Note End Later By Grid Value
--   - Module               : Editing
--   - Mac shortcut (PT)    : Option + Right Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Trim Note End Later By Grid Value", "PT2Reaper", 0)
