-- @description hsuanice_Pro Tools Transport Window: Show MIDI Controls
...
--   **Transport Window: Show MIDI Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Transport Window: Show MIDI Controls
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Transport Window: Show MIDI Controls", "PT2Reaper", 0)
