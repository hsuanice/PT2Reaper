-- @description hsuanice_Pro Tools Transpose Down (Octave)
...
--
--   ## Details
--   - Pro Tools equivalent : Transpose Down (Octave)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Down Arrow
--   - Tags                 : Editing, MIDI
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Transpose Down (Octave)", "PT2Reaper", 0)
