-- @description hsuanice_Pro Tools Window Configuration List
...
--
--   ## Details
--   - Pro Tools equivalent : Window Configuration List
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Option + J
...
reaper.ShowMessageBox("Not yet implemented: Window Configuration List", "PT2Reaper", 0)
