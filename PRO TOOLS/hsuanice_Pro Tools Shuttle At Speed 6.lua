-- @description hsuanice_Pro Tools Shuttle At Speed 6
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 6
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 6
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 6", "PT2Reaper", 0)
