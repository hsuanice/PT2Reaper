-- @description hsuanice_Pro Tools Close Front Document
...
--
--   ## Details
--   - Pro Tools equivalent : Close Front Document
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + W
--   - Tags                 : File menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Close Front Document", "PT2Reaper", 0)
