-- @description hsuanice_Pro Tools Pencil Tool: S-Curve
...
--
--   ## Details
--   - Pro Tools equivalent : Pencil Tool: S-Curve
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Pencil Tool: S-Curve", "PT2Reaper", 0)
