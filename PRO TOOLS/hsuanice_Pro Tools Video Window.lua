-- @description hsuanice_Pro Tools Video Window
...
--
--   ## Details
--   - Pro Tools equivalent : Video Window
--   - Module               : View
--   - Mac shortcut (PT)    : Command + Numpad 9
...
reaper.ShowMessageBox("Not yet implemented: Video Window", "PT2Reaper", 0)
