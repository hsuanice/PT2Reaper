-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Meter
...
--   **Edit Window: Show Ruler: Meter**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Meter
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Meter", "PT2Reaper", 0)
