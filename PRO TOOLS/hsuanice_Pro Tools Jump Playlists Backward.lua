-- @description hsuanice_Pro Tools Jump Playlists Backward
...
--   **Jump Playlists Backward**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Jump Playlists Backward
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + Page Up
...
reaper.ShowMessageBox("Not yet implemented: Jump Playlists Backward", "PT2Reaper", 0)
