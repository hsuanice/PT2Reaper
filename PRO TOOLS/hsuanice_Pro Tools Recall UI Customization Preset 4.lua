-- @description hsuanice_Pro Tools Recall UI Customization Preset 4
...
--   **Recall UI Customization Preset 4**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Recall UI Customization Preset 4
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Miscellaneous
--
...
reaper.ShowMessageBox("Not yet implemented: Recall UI Customization Preset 4", "PT2Reaper", 0)
