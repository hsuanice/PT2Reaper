-- @description hsuanice_Pro Tools Expanded Sends: Send H
...
--   **Expanded Sends: Send H**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send H
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send H", "PT2Reaper", 0)
