-- @description hsuanice_Pro Tools Show Insert Assignment Gain Reduction Meter
...
--   **Show Insert Assignment Gain Reduction Meter**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Insert Assignment Gain Reduction Meter
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Show Insert Assignment Gain Reduction Meter", "PT2Reaper", 0)
