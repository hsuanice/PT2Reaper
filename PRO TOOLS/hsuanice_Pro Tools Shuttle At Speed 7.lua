-- @description hsuanice_Pro Tools Shuttle At Speed 7
...
--
--   ## Details
--   - Pro Tools equivalent : Shuttle At Speed 7
--   - Module               : Transport
--   - Mac shortcut (PT)    : Option + Control + Numpad 7
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Shuttle At Speed 7", "PT2Reaper", 0)
