-- @description hsuanice_Pro Tools Previous Track View
...
--
--   ## Details
--   - Pro Tools equivalent : Previous Track View
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Control + Left Arrow
...
reaper.ShowMessageBox("Not yet implemented: Previous Track View", "PT2Reaper", 0)
