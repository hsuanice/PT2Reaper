-- @description hsuanice_Pro Tools Transport Window: Show Output Meters
...
--   **Transport Window: Show Output Meters**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Transport Window: Show Output Meters
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Transport Window: Show Output Meters", "PT2Reaper", 0)
