-- @description hsuanice_Pro Tools Meter Type: Digital VU
...
--   **Meter Type: Digital VU**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Meter Type: Digital VU
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Meter Type: Digital VU", "PT2Reaper", 0)
