-- @description hsuanice_Pro Tools Bypass Auto-Align Post Clip(s)
...
--   **Bypass Auto-Align Post Clip(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass Auto-Align Post Clip(s)
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass Auto-Align Post Clip(s)", "PT2Reaper", 0)
