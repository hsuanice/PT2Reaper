-- @description hsuanice_Pro Tools Edit Window: Show Ruler: Min:Secs
...
--   **Edit Window: Show Ruler: Min:Secs**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Ruler: Min:Secs
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Ruler: Min:Secs", "PT2Reaper", 0)
