-- @description hsuanice_Pro Tools Show Track Gain Reduction Meter
...
--
--   ## Details
--   - Pro Tools equivalent : Show Track Gain Reduction Meter
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Show Track Gain Reduction Meter", "PT2Reaper", 0)
