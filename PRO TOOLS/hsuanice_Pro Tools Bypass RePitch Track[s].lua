-- @description hsuanice_Pro Tools Bypass RePitch Track(s)
...
--   **Bypass RePitch Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Bypass RePitch Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Bypass RePitch Track(s)", "PT2Reaper", 0)
