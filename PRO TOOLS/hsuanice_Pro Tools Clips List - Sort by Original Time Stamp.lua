-- @description hsuanice_Pro Tools Clips List: Sort by Original Time Stamp
...
--   **Clips List: Sort by Original Time Stamp**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Original Time Stamp
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Original Time Stamp", "PT2Reaper", 0)
