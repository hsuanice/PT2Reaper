-- @description hsuanice_Pro Tools Selected Tracks: Assign Insert A
...
--   **Selected Tracks: Assign Insert A**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Insert A
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Insert A", "PT2Reaper", 0)
