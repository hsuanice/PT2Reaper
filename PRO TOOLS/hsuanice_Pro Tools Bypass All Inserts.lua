-- @description hsuanice_Pro Tools Bypass All Inserts
...
--
--   ## Details
--   - Pro Tools equivalent : Bypass All Inserts
--   - Module               : IO
--   - Mac shortcut (PT)    : Shift + A
...
reaper.ShowMessageBox("Not yet implemented: Bypass All Inserts", "PT2Reaper", 0)
