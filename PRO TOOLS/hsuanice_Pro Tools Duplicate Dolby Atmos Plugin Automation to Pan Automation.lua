-- @description hsuanice_Pro Tools Duplicate Dolby Atmos Plugin Automation to Pan Automation
...
--   **Duplicate Dolby Atmos Plugin Automation to Pan Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Duplicate Dolby Atmos Plugin Automation to Pan Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Duplicate Dolby Atmos Plugin Automation to Pan Automation", "PT2Reaper", 0)
