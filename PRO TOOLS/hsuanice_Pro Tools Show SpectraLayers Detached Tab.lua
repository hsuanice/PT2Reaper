-- @description hsuanice_Pro Tools Show SpectraLayers Detached Tab
...
--   **Show SpectraLayers Detached Tab**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show SpectraLayers Detached Tab
--   - Module               : View
--   - Mac shortcut (PT)    : —
--   - Tags                 : Window
--
...
reaper.ShowMessageBox("Not yet implemented: Show SpectraLayers Detached Tab", "PT2Reaper", 0)
