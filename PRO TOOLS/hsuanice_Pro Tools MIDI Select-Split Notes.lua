-- @description hsuanice_Pro Tools MIDI Select/Split Notes
...
--   **MIDI Select/Split Notes**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Select/Split Notes
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing, MIDI
--
...
reaper.ShowMessageBox("Not yet implemented: MIDI Select/Split Notes", "PT2Reaper", 0)
