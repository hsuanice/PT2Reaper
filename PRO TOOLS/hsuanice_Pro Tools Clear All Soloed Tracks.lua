-- @description hsuanice_Pro Tools Clear All Soloed Tracks
...
--   **Clear All Soloed Tracks**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear All Soloed Tracks
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Clear All Soloed Tracks", "PT2Reaper", 0)
