-- @description hsuanice_Pro Tools Nudge Selection Later By Grid
...
--   **Nudge Selection Later By Grid**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Nudge Selection Later By Grid
--   - Module               : Selection
--   - Mac shortcut (PT)    : Shift + Numpad Plus
--   - Tags                 : Selection
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Nudge Selection Later By Grid", "PT2Reaper", 0)
