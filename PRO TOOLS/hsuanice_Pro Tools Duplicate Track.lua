-- @description hsuanice_Pro Tools Duplicate Track
...
--
--   ## Details
--   - Pro Tools equivalent : Duplicate Track
--   - Module               : Tracks
--   - Mac shortcut (PT)    : Option + Shift + D
...
reaper.ShowMessageBox("Not yet implemented: Duplicate Track", "PT2Reaper", 0)
