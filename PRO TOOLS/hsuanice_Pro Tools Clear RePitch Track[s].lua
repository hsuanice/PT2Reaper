-- @description hsuanice_Pro Tools Clear RePitch Track(s)
...
--   **Clear RePitch Track(s)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clear RePitch Track(s)
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clear RePitch Track(s)", "PT2Reaper", 0)
