-- @description hsuanice_Pro Tools Expanded Sends: Send I
...
--   **Expanded Sends: Send I**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send I
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send I", "PT2Reaper", 0)
