-- @description hsuanice_Pro Tools Expanded Sends: Send F
...
--   **Expanded Sends: Send F**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Expanded Sends: Send F
--   - Module               : IO
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Expanded Sends: Send F", "PT2Reaper", 0)
