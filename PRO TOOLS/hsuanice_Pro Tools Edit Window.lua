-- @description hsuanice_Pro Tools Edit Window
...
--
--   ## Details
--   - Pro Tools equivalent : Edit Window
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Equals
--   - Tags                 : Editing, Window, Window menu
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window", "PT2Reaper", 0)
