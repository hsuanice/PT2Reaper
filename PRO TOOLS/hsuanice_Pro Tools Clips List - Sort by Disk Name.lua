-- @description hsuanice_Pro Tools Clips List: Sort by Disk Name
...
--   **Clips List: Sort by Disk Name**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Sort by Disk Name
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Sort by Disk Name", "PT2Reaper", 0)
