-- @description hsuanice_Pro Tools Main Counter: Bars|Beats
...
--   **Main Counter: Bars|Beats**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Main Counter: Bars|Beats
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Main Counter: Bars|Beats", "PT2Reaper", 0)
