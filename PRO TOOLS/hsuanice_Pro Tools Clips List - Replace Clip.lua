-- @description hsuanice_Pro Tools Clips List: Replace Clip
...
--   **Clips List: Replace Clip**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Replace Clip
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Replace Clip", "PT2Reaper", 0)
