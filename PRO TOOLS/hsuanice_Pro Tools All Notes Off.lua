-- @description hsuanice_Pro Tools All Notes Off
...
--
--   ## Details
--   - Pro Tools equivalent : All Notes Off
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + Shift + Numpad Period
...
reaper.ShowMessageBox("Not yet implemented: All Notes Off", "PT2Reaper", 0)
