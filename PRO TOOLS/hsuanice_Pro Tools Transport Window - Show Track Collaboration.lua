-- @description hsuanice_Pro Tools Transport Window: Show Track Collaboration
...
--   **Transport Window: Show Track Collaboration**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Transport Window: Show Track Collaboration
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Transport Window: Show Track Collaboration", "PT2Reaper", 0)
