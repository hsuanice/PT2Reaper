-- @description hsuanice_Pro Tools Tempo Operations: Scale
...
--   **Tempo Operations: Scale**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Tempo Operations: Scale
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Tempo Operations: Scale", "PT2Reaper", 0)
