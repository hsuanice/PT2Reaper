-- @description hsuanice_Pro Tools Selected Tracks: Assign Send E
...
--   **Selected Tracks: Assign Send E**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Selected Tracks: Assign Send E
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Inserts/Sends
--
...
reaper.ShowMessageBox("Not yet implemented: Selected Tracks: Assign Send E", "PT2Reaper", 0)
