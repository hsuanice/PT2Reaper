-- @description hsuanice_Pro Tools Automation: Punch Preview
...
--   **Automation: Punch Preview**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Automation: Punch Preview
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Automation
--
...
reaper.ShowMessageBox("Not yet implemented: Automation: Punch Preview", "PT2Reaper", 0)
