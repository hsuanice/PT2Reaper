-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Markers 4
...
--   **MIDI Editor Window: Show Ruler: Markers 4**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Markers 4
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Markers 4", "PT2Reaper", 0)
