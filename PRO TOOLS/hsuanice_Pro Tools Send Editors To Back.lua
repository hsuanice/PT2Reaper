-- @description hsuanice_Pro Tools Send Editors To Back
...
--   **Send Editors To Back**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Send Editors To Back
--   - Module               : View
...
reaper.ShowMessageBox("Not yet implemented: Send Editors To Back", "PT2Reaper", 0)
