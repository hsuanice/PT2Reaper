-- @description hsuanice_Pro Tools Video Sync Offset
...
--
--   ## Details
--   - Pro Tools equivalent : Video Sync Offset
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Video Sync Offset", "PT2Reaper", 0)
