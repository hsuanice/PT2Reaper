-- @description hsuanice_Pro Tools MIDI Keyboard
...
--
--   ## Details
--   - Pro Tools equivalent : MIDI Keyboard
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Shift + K
...
reaper.ShowMessageBox("Not yet implemented: MIDI Keyboard", "PT2Reaper", 0)
