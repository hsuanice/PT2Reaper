-- @description hsuanice_Pro Tools Show Only Pan Lanes With Automation
...
--   **Show Only Pan Lanes With Automation**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Only Pan Lanes With Automation
--   - Module               : Automation
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Only Pan Lanes With Automation", "PT2Reaper", 0)
