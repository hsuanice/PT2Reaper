-- @description hsuanice_Pro Tools Bump Frame Later
...
--
--   ## Details
--   - Pro Tools equivalent : Bump Frame Later
--   - Module               : Transport
--   - Mac shortcut (PT)    : Command + Option + Period
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Bump Frame Later", "PT2Reaper", 0)
