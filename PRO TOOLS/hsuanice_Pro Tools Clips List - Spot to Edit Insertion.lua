-- @description hsuanice_Pro Tools Clips List: Spot to Edit Insertion
...
--   **Clips List: Spot to Edit Insertion**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Clips List: Spot to Edit Insertion
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
--   - Tags                 : Clips, Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Clips List: Spot to Edit Insertion", "PT2Reaper", 0)
