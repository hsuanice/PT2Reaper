-- @description hsuanice_Pro Tools Save Session As Template
...
--
--   ## Details
--   - Pro Tools equivalent : Save Session As Template
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File menu
--
...
reaper.ShowMessageBox("Not yet implemented: Save Session As Template", "PT2Reaper", 0)
