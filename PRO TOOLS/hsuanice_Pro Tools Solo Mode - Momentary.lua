-- @description hsuanice_Pro Tools Solo Mode: Momentary
...
--
--   ## Details
--   - Pro Tools equivalent : Solo Mode: Momentary
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : —
--
...
reaper.ShowMessageBox("Not yet implemented: Solo Mode: Momentary", "PT2Reaper", 0)
