-- @description hsuanice_Pro Tools Edit Window: Show Marker Controls
...
--   **Edit Window: Show Marker Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show Marker Controls
--   - Module               : View
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show Marker Controls", "PT2Reaper", 0)
