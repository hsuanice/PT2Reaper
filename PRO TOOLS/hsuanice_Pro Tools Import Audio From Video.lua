-- @description hsuanice_Pro Tools Import Audio From Video
...
--
--   ## Details
--   - Pro Tools equivalent : Import Audio From Video
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : File, Video
--
...
reaper.ShowMessageBox("Not yet implemented: Import Audio From Video", "PT2Reaper", 0)
