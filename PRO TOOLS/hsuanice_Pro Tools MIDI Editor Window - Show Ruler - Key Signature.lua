-- @description hsuanice_Pro Tools MIDI Editor Window: Show Ruler: Key Signature
...
--   **MIDI Editor Window: Show Ruler: Key Signature**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : MIDI Editor Window: Show Ruler: Key Signature
--   - Module               : MIDI
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: MIDI Editor Window: Show Ruler: Key Signature", "PT2Reaper", 0)
