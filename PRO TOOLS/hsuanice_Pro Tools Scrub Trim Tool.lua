-- @description hsuanice_Pro Tools Scrub Trim Tool
...
--
--   ## Details
--   - Pro Tools equivalent : Scrub Trim Tool
--   - Module               : Editing
--   - Mac shortcut (PT)    : —
--   - Tags                 : Editing
--
...
reaper.ShowMessageBox("Not yet implemented: Scrub Trim Tool", "PT2Reaper", 0)
