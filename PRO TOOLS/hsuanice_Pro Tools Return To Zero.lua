-- @description hsuanice_Pro Tools Return To Zero
...
--
--   ## Details
--   - Pro Tools equivalent : Return To Zero
--   - Module               : Transport
--   - Mac shortcut (PT)    : Return
--   - Tags                 : Transport
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Return To Zero", "PT2Reaper", 0)
