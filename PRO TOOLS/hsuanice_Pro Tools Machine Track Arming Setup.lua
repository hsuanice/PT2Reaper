-- @description hsuanice_Pro Tools Machine Track Arming Setup
...
--   **Machine Track Arming Setup**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Machine Track Arming Setup
--   - Module               : Transport
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Machine Track Arming Setup", "PT2Reaper", 0)
