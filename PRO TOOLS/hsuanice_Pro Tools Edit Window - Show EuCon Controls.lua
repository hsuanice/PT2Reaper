-- @description hsuanice_Pro Tools Edit Window: Show EuCon Controls
...
--   **Edit Window: Show EuCon Controls**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Edit Window: Show EuCon Controls
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Miscellaneous, Show/Hide
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Edit Window: Show EuCon Controls", "PT2Reaper", 0)
