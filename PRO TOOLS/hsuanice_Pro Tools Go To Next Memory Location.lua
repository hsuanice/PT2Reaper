-- @description hsuanice_Pro Tools Go To Next Memory Location
...
--
--   ## Details
--   - Pro Tools equivalent : Go To Next Memory Location
--   - Module               : Navigation
--   - Mac shortcut (PT)    : —
--   - Tags                 : Navigation
--
...
reaper.ShowMessageBox("Not yet implemented: Go To Next Memory Location", "PT2Reaper", 0)
