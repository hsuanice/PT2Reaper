-- @description hsuanice_Pro Tools Master Meter Type: Venue Peak
...
--   **Master Meter Type: Venue Peak**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Master Meter Type: Venue Peak
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Master Meter Type: Venue Peak", "PT2Reaper", 0)
