-- @description hsuanice_Pro Tools Playback Engine
...
--
--   ## Details
--   - Pro Tools equivalent : Playback Engine
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Setup menu
--
...
reaper.ShowMessageBox("Not yet implemented: Playback Engine", "PT2Reaper", 0)
