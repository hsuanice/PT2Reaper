-- @description hsuanice_Pro Tools Cut Clip Effects
...
--
--   ## Details
--   - Pro Tools equivalent : Cut Clip Effects
--   - Module               : Clips
--   - Mac shortcut (PT)    : Command + Option + Control + X
...
reaper.ShowMessageBox("Not yet implemented: Cut Clip Effects", "PT2Reaper", 0)
