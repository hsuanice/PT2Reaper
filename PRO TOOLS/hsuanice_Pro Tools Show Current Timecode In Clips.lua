-- @description hsuanice_Pro Tools Show Current Timecode In Clips
...
--   **Show Current Timecode In Clips**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Show Current Timecode In Clips
--   - Module               : Clips
--   - Mac shortcut (PT)    : —
...
reaper.ShowMessageBox("Not yet implemented: Show Current Timecode In Clips", "PT2Reaper", 0)
