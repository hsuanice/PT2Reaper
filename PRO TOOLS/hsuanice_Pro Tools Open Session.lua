-- @description hsuanice_Pro Tools Open Session
...
--
--   ## Mapping
--   - Pro Tools equivalent : Open Session
--   - Reaper action        : File: Open project
--   - Command ID           : 40025
--   - Module               : Misc
--   - Mac shortcut (PT)    : Command + O
--   - Tags                 : File menu
--
--   ## About This Project
...
--   0.1.0 [260413.1324]
--     - Initial release
--     - Maps Pro Tools "Open Session" to Reaper command ID 40025
