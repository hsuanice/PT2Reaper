-- @description hsuanice_Pro Tools New Workspace Window
...
--
--   ## Details
--   - Pro Tools equivalent : New Workspace Window
--   - Module               : View
--   - Mac shortcut (PT)    : Option + I
...
reaper.ShowMessageBox("Not yet implemented: New Workspace Window", "PT2Reaper", 0)
