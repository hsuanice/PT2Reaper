-- @description hsuanice_Pro Tools Slip Mode (Dual Mode)
...
--
--   ## Details
--   - Pro Tools equivalent : Slip Mode (Dual Mode)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Shift + F2
...
reaper.ShowMessageBox("Not yet implemented: Slip Mode (Dual Mode)", "PT2Reaper", 0)
