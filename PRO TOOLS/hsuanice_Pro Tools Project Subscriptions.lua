-- @description hsuanice_Pro Tools Project Subscriptions
...
--
--   ## Details
--   - Pro Tools equivalent : Project Subscriptions
--   - Module               : Misc
--   - Mac shortcut (PT)    : —
--   - Tags                 : Cloud Collab
--
...
reaper.ShowMessageBox("Not yet implemented: Project Subscriptions", "PT2Reaper", 0)
