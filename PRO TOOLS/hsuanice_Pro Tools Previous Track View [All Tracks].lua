-- @description hsuanice_Pro Tools Previous Track View (All Tracks)
...
--   **Previous Track View (All Tracks)**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Previous Track View (All Tracks)
--   - Module               : Editing
--   - Mac shortcut (PT)    : Command + Option + Control + Left Arrow
--   - Tags                 : Editing, Navigation, Track/Playlist
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Previous Track View (All Tracks)", "PT2Reaper", 0)
