-- @description hsuanice_Pro Tools Show Send Assignment Level Meter
...
--
--   ## Details
--   - Pro Tools equivalent : Show Send Assignment Level Meter
--   - Module               : IO
--   - Mac shortcut (PT)    : —
--   - Tags                 : Meters
--
...
reaper.ShowMessageBox("Not yet implemented: Show Send Assignment Level Meter", "PT2Reaper", 0)
