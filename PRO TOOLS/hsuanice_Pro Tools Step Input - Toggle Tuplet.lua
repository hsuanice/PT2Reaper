-- @description hsuanice_Pro Tools Step Input: Toggle Tuplet
...
--   **Step Input: Toggle Tuplet**
--
--   ## Status
--   NOT YET IMPLEMENTED — placeholder only.
--
--   ## Details
--   - Pro Tools equivalent : Step Input: Toggle Tuplet
--   - Module               : MIDI
--   - Mac shortcut (PT)    : Numpad 3
--   - Tags                 : MIDI, Recording
--
--   ## About This Project
...
reaper.ShowMessageBox("Not yet implemented: Step Input: Toggle Tuplet", "PT2Reaper", 0)
